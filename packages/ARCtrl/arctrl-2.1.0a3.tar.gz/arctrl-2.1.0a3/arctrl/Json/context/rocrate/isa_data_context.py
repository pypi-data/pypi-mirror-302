...
IContext_reflection = _expr1325

def _arrow1334(__unit: None=None) -> IEncodable:
    class ObjectExpr1326(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1326()), ("Data", ObjectExpr1327()), ("type", ObjectExpr1328()), ("encodingFormat", ObjectExpr1329()), ("usageInfo", ObjectExpr1330()), ("name", ObjectExpr1331()), ("comments", ObjectExpr1332())])
    ...
    return ObjectExpr1333()


context_jsonvalue: IEncodable = _arrow1334()
