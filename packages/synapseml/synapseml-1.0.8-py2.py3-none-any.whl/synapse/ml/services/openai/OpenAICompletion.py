...
class OpenAICompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAICompletion_1ba4ebacca04_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAICompletion_1ba4ebacca04_output",
        ...
        self._setDefault(errorCol="OpenAICompletion_1ba4ebacca04_error")
        self._setDefault(outputCol="OpenAICompletion_1ba4ebacca04_output")
