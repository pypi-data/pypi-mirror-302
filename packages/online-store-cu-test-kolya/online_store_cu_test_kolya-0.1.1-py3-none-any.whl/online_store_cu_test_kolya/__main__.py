from online_store_cu_test_kolya.user_management import UserManager
from online_store_cu_test_kolya.order_management import OrderManager
...
def user_menu():
    ...
    if choice == '1':
        ...
        user_id = input('Введите email клиента: ')
        print(manager.find_user(user_id))
    elif choice == '3':
        user_id = input('Введите email клиента: ')
