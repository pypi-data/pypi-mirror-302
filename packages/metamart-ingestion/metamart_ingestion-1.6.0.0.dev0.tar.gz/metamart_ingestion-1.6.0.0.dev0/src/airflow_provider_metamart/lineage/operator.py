...
"""
MetaMart Airflow Lineage Operator
"""
import traceback
...
class MetaMartLineageOperator(BaseOperator):
    """
    This Operator will check the inlets and outlets of its DAG
    and push the lineage to MetaMart.

    It requires the MetaMartConnection to be passed as
    ...
    def execute(self, context: Context) -> None:
        ...
        and push it to MetaMart using the Python Client.
        """
        try:
            ...
            metadata = MetaMart(self.server_config)
