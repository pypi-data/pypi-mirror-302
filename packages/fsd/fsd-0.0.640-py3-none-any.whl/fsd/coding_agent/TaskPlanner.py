        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "7. Generate a commit message for the changes. The commit message must use the imperative tense and be structured as follows: <type>: <description>. Use these for <type>: fix, feat, build, chore, ci, docs, style, refactor, perf, test. The commit message should be a single line.\n"
                    "Response Format:\n"
                    "{\n"
                    '    "steps": [\n'
                    '        {\n'
