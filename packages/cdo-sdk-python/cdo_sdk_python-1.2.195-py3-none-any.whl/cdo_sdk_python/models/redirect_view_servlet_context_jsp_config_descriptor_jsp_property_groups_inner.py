...
class RedirectViewServletContextJspConfigDescriptorJspPropertyGroupsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["scriptingInvalid", "deferredSyntaxAllowedAsLiteral", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "isXml", "includePreludes", "includeCodas", "elIgnored", "pageEncoding", "buffer", "defaultContentType", "urlPatterns"]
