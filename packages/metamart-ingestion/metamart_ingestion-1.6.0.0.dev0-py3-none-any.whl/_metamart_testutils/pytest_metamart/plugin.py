...
from _metamart_testutils.ometa import int_admin_ometa
...
def workflow_config(metadata):
    return {
        ...
        "metaMartServerConfig": metadata.config.model_dump(),
    }
...
def ingestion_bot_wokflow_config(metadata, workflow_config):
    ...
    workflow_config["metaMartServerConfig"]["securityConfig"][
        "jwtToken"
...
@pytest.fixture(scope="session")
def ingestion_bot_workflow_config(metadata: MetaMart):
