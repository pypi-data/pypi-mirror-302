import { g as fe, w as x } from "./Index-B6qwLC9l.js";
const b = window.ms_globals.React, J = window.ms_globals.React.useMemo, ae = window.ms_globals.React.forwardRef, de = window.ms_globals.React.useRef, ue = window.ms_globals.React.useState, pe = window.ms_globals.React.useEffect, T = window.ms_globals.ReactDOM.createPortal, we = window.ms_globals.antd.Upload;
var Y = {
  exports: {}
}, S = {};
/**
...
function D(e) {
  ...
  if (e._reactElement)
    return o.push(T(b.cloneElement(e._reactElement, {
