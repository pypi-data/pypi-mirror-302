# -*- coding: utf-8 -*-
"""
torchgdm Green's function and LDOS tools
"""
# %%
import warnings
...
def G(
    ...
    **kwargs,
    ...
    nf_results = tg.postproc.fields.nf(
        ...
        pgr_bar_title="Green's tensor batch evaluation",
        **kwargs,
    )
...
def ldos(
    ...
    **kwargs,
    ...
    @batched(
        batch_kwarg="r_src", arg_position=2, out_dim_batch=0, default_batch_size=128
    )
    ...
    G_ii = _eval_Gii(
        ...
        K=K,
        progress_bar=progress_bar,
        pgr_bar_title="LDOS batch evaluation",
        **kwargs,
    )
...
def _G_direct(
    ...
    **kwargs,
    ...
    @batched(
        batch_kwarg="r_src", arg_position=2, out_dim_batch=0, default_batch_size=1024
    )
...
if __name__ == "__main__":
    ...
    r_probe = tg.tools.geometry.coordinate_map_square_2d(500, 100, r3=100)
    # r_source = r_probe
