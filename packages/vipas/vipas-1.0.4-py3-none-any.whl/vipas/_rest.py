...
class RESTClientObject:
    ...
    def _stage_model_and_build_transformer(self, model_id, model_total_folder_size, model_framework_type, processor_image, url, headers):
        """Stages the model and builds the transformer for the model."""
        try:
            body = {
                "model_id": model_id,
                "folder_size": model_total_folder_size,
                "framework_type": model_framework_type,
