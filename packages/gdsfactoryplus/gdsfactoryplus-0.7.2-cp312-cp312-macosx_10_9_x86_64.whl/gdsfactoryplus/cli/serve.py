...
from ..core.cli.watch import watch as _watch
from ..core.netlist import ensure_netlist_order, patch_netlist
from ..core.pdk import PDK_CELL_NAMES
from ..core.shared import import_pdk, maybe_find_docode_project_dir, register_cells
...
@app.get("/yaml/delete")
def delete(request: Request, path: str = "", what=""):
    if what == "" or path == "":
    ...
    if what[0] == "instances" and len(what) == 2:
        ...
        return templates.TemplateResponse(
            ...
            "edit_setting.html",
            {
                ...
                "what": "component",
                "value": str(value),
                "allowed": {"component": natsorted(pdk.cells)},
                "list": list,
                "isinstance": isinstance,
                "added": added,
            },
    ...
    if what == "instances":
        ...
        if key in netlist["instances"]:
            ...
            if name != "_":
                ...
                instance = b""
            return HTMLResponse(error + instance)
        ...
        if key in netlist["routes"]:
            ...
            if name != "_":
                ...
                route = b""
            return HTMLResponse(error + route)
    ...
    if what == "placements":
        ...
        if error:
            if name != "_":
                ...
                placement = b""
            return HTMLResponse(error + placement)
