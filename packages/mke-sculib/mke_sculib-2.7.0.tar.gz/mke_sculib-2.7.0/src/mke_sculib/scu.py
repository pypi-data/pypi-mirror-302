...
from mke_sculib.helpers import make_zulustr, match_zulutime, get_utcnow, parse_zulutime, colors, colors_dc, print_color, is_notebook
...
class scu():
    ...
    def __init__(self, address='', ip='', port='8080', antenna_id='', debug=False, lims_az=(-270.0, 270, 3.0), lims_el=(15, 90, 1.35), dish_type='mke', post_put_delay=0.2, use_socket=True, influx_token='', kwargs_requests = None, wait_done_by_uuid=True, start_streams_on_construct=False, **kwargs):
