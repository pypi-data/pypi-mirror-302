...
def main():
    ...
    parser.add_argument('--out_models', type=str, nargs='+',
                        ...
                        help='Models to use for audios of output files.  You can choose the speaker by appending a colon and the speaker ID.  For example, you can have three output models as follows.  `learnbyhear en.txt --out_models de_DE-thorsten-high de_DE-thorsten_emotional-medium:4 de_DE-thorsten_emotional-medium:5`')
