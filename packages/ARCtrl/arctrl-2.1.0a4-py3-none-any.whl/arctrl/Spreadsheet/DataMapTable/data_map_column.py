...
def to_fs_columns(dc: Array[DataContext]) -> FSharpList[FSharpList[FsCell]]:
    ...
    def _arrow1207(__unit: None=None, dc: Any=dc) -> IEnumerable_1[FSharpList[FsCell]]:
        def _arrow1206(__unit: None=None) -> IEnumerable_1[FSharpList[FsCell]]:
            def _arrow1205(dc_4: DataContext) -> FSharpList[FsCell]:
                dc_3: DataContext = dc_4
                def _arrow1204(__unit: None=None) -> IEnumerable_1[FsCell]:
                    def _arrow1195(__unit: None=None) -> FSharpList[FsCell]:
                    ...
                    def _arrow1203(__unit: None=None) -> IEnumerable_1[FsCell]:
                        def _arrow1202(__unit: None=None) -> IEnumerable_1[FsCell]:
                            def _arrow1201(__unit: None=None) -> IEnumerable_1[FsCell]:
                                def _arrow1200(__unit: None=None) -> IEnumerable_1[FsCell]:
                                    def _arrow1199(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        def _arrow1198(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        ...
                                        return append(create_text(DataContext__get_GeneratedBy(dc_3)), delay(_arrow1198))

                                    return append(create_text(DataContext__get_Description(dc_3)), delay(_arrow1199))

                                return append(create_term(DataContext__get_ObjectType(dc_3)), delay(_arrow1200))

                            return append(create_term(DataContext__get_Unit(dc_3)), delay(_arrow1201))

                        return append(create_term(DataContext__get_Explication(dc_3)), delay(_arrow1202))

                    return append(_arrow1195(), delay(_arrow1203))

                return to_list(delay(_arrow1204))

            return map_1(_arrow1205, dc)

        return append(singleton_1(headers), delay(_arrow1206))

    return transpose(to_list(delay(_arrow1207)))
