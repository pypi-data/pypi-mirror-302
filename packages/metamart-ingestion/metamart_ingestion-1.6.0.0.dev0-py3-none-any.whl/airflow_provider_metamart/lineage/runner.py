...
"""
MetaMart Airflow Provider Lineage Runner
"""
...
from airflow_provider_metamart.lineage.status import STATUS_MAP
...
class AirflowLineageRunner:
    """
    Given the MetaMart connection, a service name and a DAG:
