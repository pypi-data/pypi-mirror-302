...
class alm(quantim):
    ...
    def assets(self, client_id, port_type, params=None, views=None):
        '''
        Assets summary.
        '''
        data = {'client_id':client_id , 'port_type': port_type, 'params':params , 'views': views}
    ...
    def saa_alm(self, client_id, port_type, params=None, views=None, ref_date=None):
        '''
        Saa
        '''
        data = {**{'client_id':client_id, 'port_type':port_type, 'port_form':params, 'views':views}, **({'ref_date':ref_date} if ref_date is not None else {})}
