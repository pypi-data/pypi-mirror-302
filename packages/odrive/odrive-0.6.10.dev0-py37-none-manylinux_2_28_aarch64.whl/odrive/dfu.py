...
async def run_dfu(device_manager: DeviceManager, serial_number: Optional[str], path: Optional[str], channel: Optional[str], version: Optional[str], erase_all: bool, logger, interactive: bool = True):
    """
    ...
    logger.info(f"found ODrive {device.info.serial_number}")
...
async def dfu_ui(serial_number: Optional[str], path: Optional[str], channel: Optional[str], version: Optional[str], erase_all: bool, logger, interactive: bool = True):
    ...
    """
    await run_dfu(get_device_manager(), serial_number, path, channel, version, erase_all, logger, interactive)
