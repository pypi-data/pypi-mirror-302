...
class GfxCanvas(Canvas):                       # pylint: disable=abstract-method
    ...
    def add_line(self, p1, p2, *,   # pylint: disable=too-many-arguments, too-many-locals
    ...
    def add_rectangle(self, p1, p2, *,  # pylint: disable=too-many-arguments, too-many-locals
                      color: str = 'black', dasharray: str = 'SOLID',
    ...
    def add_text(self, location, text, *,   # pylint: disable=too-many-arguments
...
class Port(GfxComponent):  # pylint: disable=abstract-method, too-many-ancestors
    """
...
class GfxBase(GfxComponent): # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Line(GfxBase):       # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Rect(GfxBase, SizeableMixin): # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Oval(GfxBase):       # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Arc(GfxBase):        # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Shape(GfxBase):      # pylint: disable=abstract-method, too-many-ancestors
    """
...
class Text(GfxComponent):  # pylint: disable=abstract-method, too-many-ancestors
    """
