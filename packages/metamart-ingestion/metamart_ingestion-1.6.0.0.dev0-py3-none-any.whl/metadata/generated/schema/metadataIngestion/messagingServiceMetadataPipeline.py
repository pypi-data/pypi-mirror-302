...
class MessagingServiceMetadataPipeline(BaseModel):
    ...
    markDeletedTopics: Annotated[
        ...
        Field(
            True,
            description='Optional configuration to soft delete topics in MetaMart if the source topics are deleted. Also, if the topic is deleted, all the associated entities like sample data, lineage, etc., with that topic will be deleted',
