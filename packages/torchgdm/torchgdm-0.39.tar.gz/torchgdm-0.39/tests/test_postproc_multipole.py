...
class TestSimCrossSections(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.struct1 = tg.struct.StructDiscretizedCubic3D(
            tg.struct.volume.cuboid(3, 3, 2),
            step,
            mat_struct,
    ...
    def test_effective_polarizability(self):
        for device in self.devices:
            ...
            a_tgdm = tg.struct.volume.pola.extract_effective_polarizability(
                self.struct1,
                self.env,
                self.wavelengths,
                verbose=False,
            ...
            struct_eff = tg.struct.StructEffPola3D(
