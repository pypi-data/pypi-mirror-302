...
class MotionMagicVoltage:
    ...
    def __init__(self, position: rotation, enable_foc: bool = True, feed_forward: volt = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, use_timesync: bool = False):
