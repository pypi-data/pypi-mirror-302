...
class EntityName(RootModel[str]):
    root: Annotated[
        str,
        Field(
            description='Name of the property or entity types. Note a property name must be unique for an entity. Property name must follow camelCase naming adopted by metaMart - must start with lower case with no space, underscore, or dots.',
            pattern='(?u)^[\\w]+$',
        ),
    ]
