...
class TeamStatsService:
    ...
    def get_team_stats(self, fixture) -> Dict[str, TeamStats]:
        ...
        ht_stats = next((team_stats for team_stats in teams_stats if team_stats.team_id == fixture.home_team.team_id), None)
        at_stats = next((team_stats for team_stats in teams_stats if team_stats.team_id == fixture.away_team.team_id), None)
