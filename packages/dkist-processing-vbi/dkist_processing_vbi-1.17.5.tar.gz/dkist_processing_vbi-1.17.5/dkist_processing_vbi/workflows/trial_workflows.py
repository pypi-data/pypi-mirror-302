...
from dkist_processing_vbi.tasks.trial_output_data import TransferVbiTrialData
...
full_trial_summit_pipeline.add_node(
    task=CreateTrialQualityReport, upstreams=AssembleQualityData, pip_extras=["quality"]
)
full_trial_summit_pipeline.add_node(
    task=TransferVbiTrialData,
    upstreams=[
        AssembleVbiMovie,
...
# goodbye
full_trial_summit_pipeline.add_node(task=TrialTeardown, upstreams=TransferVbiTrialData)
...
# goodbye
full_trial_no_speckle_pipeline.add_node(task=TrialTeardown, upstreams=TransferVbiTrialData)
