...
ENCRYPTION_HEADER = "FILE_SECURE;AES-256-CBC;0.7.0;"
...
def filesecure():
    ...
    encrypt_parser.add_argument('--output-file', help='Name of the output file (optional)')
    ...
    decrypt_parser.add_argument('--output-file', help='Name of the output file (optional)')

    # Parse the arguments
    args = parser.parse_args()

    if args.command == 'encrypt':
        encrypt_file(args.password, args.file, args.output_file)
    elif args.command == 'decrypt':
        decrypt_file(args.password, args.file, args.output_file)
    else:
        parser.print_help()
