...
class TableComment:             
    ...
    def __load_and_verify_params(self):
        ...
        #validate
        #if(len(self.comment_complete) != len(self.table_comment_atlan_pattern)):
            #log(__name__).error(f"The parameter comment or comment_squad is not valid.") 
            #raise ValueError(f"The parameter comment or comment_squad is not valid.")
