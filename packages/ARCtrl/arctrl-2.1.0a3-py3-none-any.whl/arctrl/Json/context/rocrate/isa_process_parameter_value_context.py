...
IContext_reflection = _expr1464

def _arrow1475(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1465()), ("additionalType", ObjectExpr1466()), ("ProcessParameterValue", ObjectExpr1467()), ("category", ObjectExpr1468()), ("categoryCode", ObjectExpr1469()), ("value", ObjectExpr1470()), ("valueCode", ObjectExpr1471()), ("unit", ObjectExpr1472()), ("unitCode", ObjectExpr1473())])
...
context_jsonvalue: IEncodable = _arrow1475()
