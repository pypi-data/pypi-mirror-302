...
tables = '''
ACCT_FACADE.HB_ISTMNT_REPAY_DETAIL_BAK
I9_LAB.T_OFF_BALANCE_DRAW_RECORD
I9_LAB.AS_ACCOUNT_DRAW_RECORD
AML.DD_OBLIST
IMOP_COUPON.CPN_COUPON_FUND
SETTLE.CCF_TRADE_DATA_DCYJ
YCMGR.CS_RISK_CUSTOMER_HIT_DETAIL
FFKFQZ.FACADE_BLACK_LIST_RECORD
ROBOT.ROBOT_DIALOGUE_INFO
limit_center.M_INTERFACE_REQ_LOG_HIS
limit_center.T_SILENCE_SHARE_LAST_SLICE
limit_center.T_LIMIT_SHARE_LAST_SLICE
'''
