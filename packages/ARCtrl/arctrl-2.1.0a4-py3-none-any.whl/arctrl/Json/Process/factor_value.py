...
def ISAJson_encoder(id_map: Any | None, fv: FactorValue) -> IEncodable:
    def f(fv_1: FactorValue, id_map: Any=id_map, fv: Any=fv) -> IEncodable:
        ...
        def _arrow1968(value: str, fv_1: Any=fv_1) -> IEncodable:
        ...
        def _arrow1969(value_2: Factor, fv_1: Any=fv_1) -> IEncodable:
            return encoder_1(id_map, value_2)

        def _arrow1972(value_3: Value_1, fv_1: Any=fv_1) -> IEncodable:
            return encoder_2(id_map, value_3)

        def _arrow1973(oa: OntologyAnnotation, fv_1: Any=fv_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1968, ISAJson_genID(fv_1)), try_include("category", _arrow1969, fv_1.Category), try_include("value", _arrow1972, fv_1.Value), try_include("unit", _arrow1973, fv_1.Unit)]))
    ...
    if id_map is not None:
        def _arrow1979(fv_3: FactorValue, id_map: Any=id_map, fv: Any=fv) -> str:
            return ISAJson_genID(fv_3)

        return encode(_arrow1979, f, fv, id_map)
...
def _arrow1988(get: IGetters) -> FactorValue:
    def _arrow1982(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow1983(__unit: None=None) -> Factor | None:
    ...
    def _arrow1987(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("unit", OntologyAnnotation_ISAJson_decoder)

    return FactorValue(_arrow1982(), _arrow1983(), _arrow1984(), _arrow1987())


ISAJson_decoder: Decoder_1[FactorValue] = object(_arrow1988)
