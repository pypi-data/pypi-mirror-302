...
#############################
	...
	def example(self):
		if self.type=='vec_float':
			...
			self.obj2_example=Vector.vec_float_2
		if self.type=='vec_proba':
			self.obj1_example=Vector.vec_prob_1
			self.obj2_example=Vector.vec_prob_2
		if self.type=='vec_nn':
			self.obj1_example=Vector.vec_nn_1
			self.obj2_example=Vector.vec_nn_2
		if self.type=='str':
			self.obj1_example = "martha"
			self.obj2_example = "mbarht"
		if self.type=='vec_str':
			self.obj1_example = ["a", "b", "c", "d"]
			self.obj2_example = ["b", "c", "e", "f"]
		if self.type=='text':
		...
		if self.type=='vec_int':
			self.obj1_example=Vector.vec_int_1
			self.obj2_example=Vector.vec_int_2
		if self.type=='vec_bin':
			self.obj1_example=Vector.vec_bin_1
			self.obj2_example=Vector.vec_bin_2
		if self.type=='vec_bool':
			self.obj1_example=Vector.vec_bool_1
			self.obj2_example=Vector.vec_bool_2
