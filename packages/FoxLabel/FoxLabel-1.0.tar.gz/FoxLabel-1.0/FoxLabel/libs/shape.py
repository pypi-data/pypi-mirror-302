...
# from Funcs import taConfigs as taConf
# taConf.SetDefault_ifnot_exists_cfg(0,'ImageLabel_corner_point_size', 1.0)
class Shape(object):
    ...
    def draw_vertex(self, path, i):
        # mS=taConf.cfg_lv0['ImageLabel_corner_point_size']
        mS=1
        ...
        if shape == self.P_SQUARE:
            path.addRect(point.x() - d / 4, point.y() - mS*d / 4, mS*d/2, mS*d/2)
        elif shape == self.P_ROUND:
            path.addEllipse(point, mS*d / 4.0, mS*d / 4.0)
        else:
