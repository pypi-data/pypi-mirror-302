...
class BaseGraph():
    ...
    """
    def __init__(self, base_bl: BusinessLogic, settings: str, grid: str, labels: dict, other: dict,
    ...
    def _check_division_value(self, value: str):
        ...
        """
        possible_values = ("no", "hundreds", "thousands", "millions", "billions", "trillions")
        if value not in possible_values:
            raise ValueError('Param "division_value" must have one of values: {}, found: "{}"'.format(
                str(possible_values)[1:-1], value))
    ...
    def _get_labels_settings_two_axis_type(self, **kwargs) -> dict:
        ...
        :return:
            Для версии Полиматики 5.6:
                {
                    'axisNotesPeriodX': <value>,
                    'axisNotesPeriodY': <value>,
                    'axisXShortFormat': <value>
                }
            Для версии Полиматики 5.7:
                {
        ...
        if self.base_bl.polymatica_version == '5.6':
            ...
            if kwargs.get("add_short_format", True):
                ...
                result_labels.update({"axisXShortFormat": short_format})
        elif self.base_bl.polymatica_version == '5.7':
    ...
    def get_labels_settings(self, _type: str, **kwargs) -> dict:
        ...
        raise NotImplementedError('Type "{}" is not implemented!'.format(_type))
