...
def RegisterHardwareResource_post_register_post(
...
def HardwareResource_get__string_id__get(
...
def HardwareResource_post__string_id__post(
...
def HardwareResource_put__string_id__put(
