...
class m:
    ...
    def validate_email(self, invoking_function_name, request, sqlite_db_path, gmail_bot_preset_name, telegram_bot_preset_name):
        ...
        def send_email(sender_email_id, service_account_credentials_path, recipient_email, subject, message_text):
            ...
            # self.send_telegram_message(invoking_function_name, f"REACHED 230: {sender_email_id}, {service_account_credentials_path}, {recipient_email}, {subject}, {message_text}", telegram_bot_preset_name)
        ...
        # self.send_telegram_message(invoking_function_name, "REACHED 239", telegram_bot_preset_name)
        # Load configuration
        config = load_config()
        service_account_credentials_path = get_gmail_bot_details(config, gmail_bot_preset_name)
        sender_email_id = gmail_bot_preset_name

        # self.send_telegram_message(invoking_function_name, f"REACHED 245", telegram_bot_preset_name)
        ...
        # self.send_telegram_message(invoking_function_name, f"REACHED 250 {email}", telegram_bot_preset_name)
        ...
        # self.send_telegram_message(invoking_function_name, f"REACHED 262 {email}", telegram_bot_preset_name)
        ...
        try:
            ...
            # self.send_telegram_message(invoking_function_name, f"REACHED 271 {email}", telegram_bot_preset_name)
            ...
            # self.send_telegram_message(invoking_function_name, f"REACHED 285 {email}", telegram_bot_preset_name)
            ...
            # self.send_telegram_message(invoking_function_name, f"REACHED 296 {email}", telegram_bot_preset_name)
            ...
            # self.send_telegram_message(invoking_function_name, f"REACHED 312 {email}", telegram_bot_preset_name)
            ...
            # self.send_telegram_message(invoking_function_name, f"REACHED 323 {email}", telegram_bot_preset_name)
    ...
    def validate_user_password(self, invoking_function_name, request, sqlite_db_path, post_authentication_redirect_url, gmail_bot_preset_name, telegram_bot_preset_name):
        ...
        operation_data_raw = request.form.get('operation_data')
        self.send_telegram_message(invoking_function_name, f"REACHED 497: {operation_data_raw}", telegram_bot_preset_name)
    ...
    def set_first_password(self, invoking_function_name, request, sqlite_db_path, post_authentication_redirect_url, gmail_bot_preset_name, telegram_bot_preset_name):
        ...
        self.send_telegram_message(invoking_function_name, "663 REACHED", telegram_bot_preset_name)
        try:
            conn = sqlite3.connect(sqlite_db_path)
            cursor = conn.cursor()
            ...
            self.send_telegram_message(invoking_function_name, "673 REACHED", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "687 REACHED", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "696 REACHED", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "707 REACHED", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "718 REACHED", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "736 REACHED", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "743 REACHED", telegram_bot_preset_name)
            return jsonify(
                success=True,
    ...
    def reset_password_and_login(self, invoking_function_name, request, sqlite_db_path, post_authentication_redirect_url, gmail_bot_preset_name, telegram_bot_preset_name):
        ...
        self.send_telegram_message(invoking_function_name, "REACHED 1095", telegram_bot_preset_name)
        operation_data = json.loads(request.form.get('operation_data'))
        token = operation_data.get('token')
        new_password = operation_data.get('new_password')
        user_latitude = operation_data.get('userLatitude')
        ...
        try:
            ...
            self.send_telegram_message(invoking_function_name, "REACHED 1119", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "REACHED 1132", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "REACHED 1150", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "REACHED 1164", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "REACHED 1179", telegram_bot_preset_name)
            ...
            self.send_telegram_message(invoking_function_name, "REACHED 1186", telegram_bot_preset_name)
            return jsonify(
                success=True,
