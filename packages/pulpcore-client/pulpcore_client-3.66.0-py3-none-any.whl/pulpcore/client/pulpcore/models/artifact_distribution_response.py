...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_last_updated=None, pulp_created=None, pulp_href=None, hidden=False, no_content_change_since=None, base_path=None, pulp_labels=None, name=None, prn=None, content_guard=None, base_url=None, local_vars_configuration=None):  # noqa: E501
