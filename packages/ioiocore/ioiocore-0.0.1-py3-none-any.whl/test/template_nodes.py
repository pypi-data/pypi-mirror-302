...
class Source(ioc.Node):
    def __init__(self):
        super().__init__(outputPorts = ['out1', 'out2'])
...
class Filter(ioc.Node):
    def __init__(self):
        super().__init__(inputPorts = ['in1', 'in2'], outputPorts = ['out1', 'out2'])
...
class Sink(ioc.Node):
    def __init__(self, event_handler):
        super().__init__(inputPorts = ['in1', 'in2'])
