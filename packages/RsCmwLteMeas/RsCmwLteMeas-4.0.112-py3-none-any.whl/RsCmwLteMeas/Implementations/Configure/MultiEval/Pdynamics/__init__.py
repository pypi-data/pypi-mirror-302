...
class PdynamicsCls:
	...
	def get_tmask(self) -> enums.TimeMask:
		...
		Selects the time mask for power dynamics measurements. \n
			:return: time_mask: GOO | PPSRs | SBLanking GOO: General ON/OFF time mask PPSRs: PUCCH/PUSCH transmission before and after an SRS SBLanking: SRS blanking time mask
		"""
