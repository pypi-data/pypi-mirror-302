...
class MainExplainerAgent:
    ...
    async def get_answer_plan(self, conversation_history, user_prompt, language, all_file_content, role, file_attachments, focused_files, assets_link, crawl_logs):
        ...
        prompt += (
            ...
            "FOR ALL CODING-RELATED RESPONSES: FOCUS ON KEY CODE EXAMPLES INSTEAD OF PROVIDING FULL CODE. YOU ARE A CODE ANALYST, NOT A CODER. JUST MAKE A COMPREHENSIVE ANALYSIS AND PROVIDE SPECIFIC ACTION ITEMS OR FEEDBACK."
