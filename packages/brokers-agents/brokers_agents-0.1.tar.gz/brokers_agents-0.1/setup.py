...
setup(
    name='brokers_agents',  # El nombre de tu paquete
    version='0.1',
    ...
    description='Paquete de brokers para manejo de colas de RabbitMQ',
    ...
    author='Ossuan',
    author_email='ossuan.lugo@gmail.com',
    url='https://github.com/arielespinosa/BrokerMessageAgent',
    classifiers=[
