...
def base_te_config():
    return train_config(batch_size=8, steps=600, steps_per_loop=100) # TODO: change this to be standalone

def train_config(batch_size, steps, steps_per_loop): # TODO: refactor this with original main.py (left here for compatibility)
...
def inference_config(batch_size, steps): # TODO: refactor this with original main.py (left here for compatibility)
