...
from sais.autotrain.dataservice import EnvVarCredentialsProvider, TrainInferHandler, TrainResultRequest, \
    InferResultRequest, QueryNWPHandler, ENDPOINT, QueryNWPRequest, QueryStationRelatedHandler, QueryStationRequest, \
...
#     end_hour=51,
#     forecast_interval=1,
#     coords=[{"req_lat": 38.44889, "req_lon": 111.4655}, {"req_lat": 18, "req_lon": 74}],
#     vars=[
#         "u100"
#     ]))
