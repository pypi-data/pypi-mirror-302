import { g as $, w as x } from "./Index-QTeD3Jm0.js";
const w = window.ms_globals.React, J = window.ms_globals.React.forwardRef, Y = window.ms_globals.React.useRef, Q = window.ms_globals.React.useState, X = window.ms_globals.React.useEffect, Z = window.ms_globals.React.useMemo, R = window.ms_globals.ReactDOM.createPortal, ee = window.ms_globals.antd.Input;
var B = {
  exports: {}
}, I = {};
/**
 ...
 */
var te = w, re = Symbol.for("react.element"), ne = Symbol.for("react.fragment"), oe = Object.prototype.hasOwnProperty, le = te.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, se = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
...
function j(e) {
  ...
  if (e._reactElement)
    return r.push(R(w.cloneElement(e._reactElement, {
...
const Le = Se(({
  ...
  const h = E(n == null ? void 0 : n.strategy), f = E(n == null ? void 0 : n.exceedFormatter), m = E(n == null ? void 0 : n.show), c = E(typeof l == "object" ? l.formatter : void 0);
  return /* @__PURE__ */ _.jsxs(_.Fragment, {
    children: [/* @__PURE__ */ _.jsx("div", {
      ...
      addonAfter: e.addonAfter ? /* @__PURE__ */ _.jsx(g, {
        slot: e.addonAfter
      }) : i.addonAfter,
      addonBefore: e.addonBefore ? /* @__PURE__ */ _.jsx(g, {
        slot: e.addonBefore
      }) : i.addonBefore,
      allowClear: e["allowClear.clearIcon"] ? {
        clearIcon: /* @__PURE__ */ _.jsx(g, {
          slot: e["allowClear.clearIcon"]
        })
      } : i.allowClear,
      prefix: e.prefix ? /* @__PURE__ */ _.jsx(g, {
        slot: e.prefix
      }) : i.prefix,
      suffix: e.suffix ? /* @__PURE__ */ _.jsx(g, {
        slot: e.suffix
      }) : i.suffix
    })]
  });
