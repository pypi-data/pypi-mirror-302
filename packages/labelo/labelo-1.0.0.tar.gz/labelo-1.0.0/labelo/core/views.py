...
def main(request):
    ...
    if user.is_authenticated:
        ...
        if not org_members or user.active_organization is None:
...
def version_page(request):
    ...
    # from labelo.core.utils.common import check_for_the_latest_version
...
def localfiles_data(request):
    ...
    if settings.LOCAL_FILES_SERVING_ENABLED is False:
        return HttpResponseForbidden(
            ...
            'please check docs: https://docs.labelo.ai/'
        )
...
#     "A new class is created for creating user groups and adding necessary permissions."

#     def groups(self):
#         manager, created = Group.objects.get_or_create(name='manager')
#         adminstrater, created = Group.objects.get_or_create(name='administrator')
#         reviewer, created = Group.objects.get_or_create(name='reviewer')
#         annotater, created = Group.objects.get_or_create(name='annotater')
#         pending, created = Group.objects.get_or_create(name='pending')
#         owner, created = Group.objects.get_or_create(name='owner')
#         no_org, created = Group.objects.get_or_create(name='no_org')

#     def permissions(self):
#         project_view = Permission.objects.get(name="Can view project")
#         project_create = Permission.objects.get(name="Can add project")
#         project_change = Permission.objects.get(name="Can change project")
#         project_delete = Permission.objects.get(name="Can delete project")

#         organization_view = Permission.objects.get(name="Can view organization")
#         organization_create = Permission.objects.get(name="Can add organization")
#         organization_change = Permission.objects.get(name="Can change organization")
#         organization_delete = Permission.objects.get(name="Can delete organization")

#         organization_member_view = Permission.objects.get(name="Can view organization member")
#         organization_member_create = Permission.objects.get(name="Can add organization member")
#         organization_member_change = Permission.objects.get(name="Can change organization member")
#         organization_member_delete = Permission.objects.get(name="Can delete organization member")

#         manager = Group.objects.get(name='manager')
#         administrator = Group.objects.get(name='administrator')
#         reviewer = Group.objects.get(name='reviewer')
#         annotater = Group.objects.get(name='annotater')
#         pending = Group.objects.get(name='pending')
#         no_org = Group.objects.get(name=no_org)


#         administrator.permissions.add(project_view, project_create, project_change, project_delete,organization_member_view,organization_member_create,organization_member_change,
#                                       organization_member_delete,organization_view,organization_create)
#         manager.permissions.add(project_view, project_create, project_change, project_delete,organization_view,organization_create)
#         reviewer.permissions.add(project_view,organization_view,organization_create)
#         annotater.permissions.add(project_view,organization_view,organization_create)
#         pending.permissions.add(project_view,organization_view)
#         no_org.permissions.add(organization_view,organization_create)
...
#     groups_and_permissions.groups()
#     groups_and_permissions.permissions()
...
#         Organization.objects.create(id=1, title='Default Organization', created_by=user)
