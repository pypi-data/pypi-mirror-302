...
class InverseTransform:
    ...
    def _parse_ttype(self) -> tuple[torch.Tensor, Overlap]:
        from .transform_types import Window, window
    ...
    def execute_all(self, xf: torch.Tensor) -> tuple[torch.Tensor, torch.Tensor]:  # noqa: C901
    ...
    def execute(self, xf: torch.Tensor) -> tuple[torch.Tensor, float]:  # noqa: C901
