...
class ColorConfig:
    ...
    TRANSITION_ACTION_COLOR = PyCuiColors.RED_ON_BLACK
...
class UIConfig:
    ...
    LEVEL_SELECT_SUMMARY_X = 4
    LEVEL_SELECT_SUMMARY_Y = 1
    LEVEL_SELECT_SUMMARY_SEED_WIDTH = 2
    LEVEL_SELECT_MAIN_X = 1
    LEVEL_SELECT_MAIN_Y = 2
