...
import { B as Block, S as StatusTracker, e as BlockLabel, C as Chat, h as IconButtonWrapper$1, i as IconButton$1, z as Community, A as Trash, G as MarkdownCode, H as Copy, J as ScrollDownArrow, R as Retry, v as Undo } from './2-BdI8oWhp.js';
...
const ButtonPanel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${show ? `<div class="${"message-buttons-" + escape(position, true) + " " + escape(layout, true) + " message-buttons " + escape(avatar !== null && "with-avatar", true) + " svelte-1ibfe7l"}">${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, { top_panel: false }, {}, {
    default: () => {
      return `${show_copy ? `${validate_component(Copy_1, "Copy").$$render($$result, { value: message_text }, {}, {})}` : ``} ${show_download && !Array.isArray(message) && is_component_message(message) ? `${validate_component(DownloadLink, "DownloadLink").$$render(
      ...
      )}` : ``} ${show_retry ? `${validate_component(IconButton$1, "IconButton").$$render(
        $$result,
        {
          Icon: Retry,
          label: "Retry",
        ...
        {},
        {}
      )}` : ``} ${show_undo ? `${validate_component(IconButton$1, "IconButton").$$render(
        $$result,
        {
          label: "Undo",
          Icon: Undo,
...
const ChatBot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${value !== null && value.length > 0 ? `${validate_component(IconButtonWrapper$1, "IconButtonWrapper").$$render($$result, {}, {}, {
    default: () => {
      ...
      })}` : ``} ${validate_component(IconButton$1, "IconButton").$$render($$result, { Icon: Trash, label: "Clear" }, {}, {})} ${show_copy_all_button ? `${validate_component(CopyAll, "CopyAll").$$render($$result, { value }, {}, {})}` : ``}`;
    }
  ...
  })}</div>` : ``}</div>`}</div> ${show_scroll_button ? `<div class="scroll-down-button-container svelte-vxn3uw">${validate_component(IconButton$1, "IconButton").$$render(
    $$result,
    {
      Icon: ScrollDownArrow,
      label: "Scroll down",
...
//# sourceMappingURL=Index55-BZUnWrxp.js.map
