...
class MsPowerBiCredentialEntraId(Diffable):
    ...
    def _api_create_input(self) -> MsPowerBiCredentialAuthCreateInput:
        return MsPowerBiCredentialAuthCreateInput(
            entra_id=MsPowerBiCredentialEntraIdCreateInput(
    ...
    def _api_update_input(self) -> MsPowerBiCredentialAuthUpdateInput:
        return MsPowerBiCredentialAuthUpdateInput(
            entra_id=MsPowerBiCredentialEntraIdUpdateInput(
                client_id=self.client_id,
                client_secret=self.client_secret,
                tenant_id=self.tenant_id,
            )
    ...
    def _api_secret_change_input(self) -> MsPowerBiCredentialAuthSecretChangedInput:
        return MsPowerBiCredentialAuthSecretChangedInput(
            entra_id=MsPowerBiCredentialAuthEntraIdSecretChangedInput(
                client_secret=self.client_secret,
            )
        )
...
class MsPowerBiCredential(Credential):
    ...
    def _api_credential_secret_change_input(
        ...
        return MsPowerBiCredentialSecretChangedInput(
            id=self._must_id(),
