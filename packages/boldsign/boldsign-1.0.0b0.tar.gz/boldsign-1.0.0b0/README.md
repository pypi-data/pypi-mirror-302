...
*DocumentApi* | [**v1_document_change_recipient_patch**](docs/DocumentApi.md#v1_document_change_recipient_patch) | **PATCH** /v1/document/changeRecipient | Change recipient details of a document.
*PlanApi* | [**v1_plan_api_credits_count_get**](docs/PlanApi.md#v1_plan_api_credits_count_get) | **GET** /v1/plan/apiCreditsCount | Gets the Api credits details.
