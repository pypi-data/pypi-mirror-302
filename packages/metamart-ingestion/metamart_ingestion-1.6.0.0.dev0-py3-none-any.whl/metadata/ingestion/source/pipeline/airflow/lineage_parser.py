...
class OMEntity:
    """
    Identifies one entity in MetaMart.
...
def _parse_xlets(xlet: Any) -> None:
    ...
    representations, e.g., https://github.com/meta-mart/MetaMart/issues/11626
    """
...
@deprecated(
    ...
    https://docs.meta-mart.org/connectors/pipeline/airflow/configuring-lineage
    """
    ),
    release="1.4.0",
)
