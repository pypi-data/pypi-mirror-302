...
IContext_reflection = _expr1518

def _arrow1525(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1519()), ("bio", ObjectExpr1520()), ("Source", ObjectExpr1521()), ("name", ObjectExpr1522()), ("characteristics", ObjectExpr1523())])
...
context_jsonvalue: IEncodable = _arrow1525()
