...
from .schemas import SessionRequest, SessionActionKind, SessionActionRequest
...
class Client:
    ...
    def init(
        ...
        *,
        ...
        if self._initialized:
            raise LayerAlreadyInitializedError("Layer SDK already initialized")
    ...
    def create_session(self, **kwargs) -> str:
        ...
        try:
            ...
            raise LayerMissingRequiredConfigurationError(str(e))
