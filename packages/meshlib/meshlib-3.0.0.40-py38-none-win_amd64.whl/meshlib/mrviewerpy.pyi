...
def clearScene() -> None:
    ...
    """
def getSelectedDistanceMaps() -> ...:
    """
    Get copies of all selected voxel grids in the scene.
    """
def getSelectedMeshEdges() -> meshlib.mrmeshpy.std_vector_TaggedBitSet_class_UndirectedEdgeTag:
    """
    Get selected edge bitsets of the selected mesh objects.
    """
def getSelectedMeshFaces() -> meshlib.mrmeshpy.std_vector_TaggedBitSet_class_FaceTag:
    """
...
def getSelectedObjects() -> ...:
    ...
def getSelectedPointCloudPoints() -> meshlib.mrmeshpy.std_vector_TaggedBitSet_class_VertTag:
    """
    Get selected point bitsets of the selected point cloud objects.
    """
def getSelectedPointClouds() -> ...:
    """
    Get copies of all selected point clouds in the scene.
    """
def getSelectedPolylines() -> ...:
    """
    Get copies of all selected polylines in the scene.
    """
def getSelectedVoxels() -> meshlib.mrmeshpy.std_vector_VoxelsVolumeMinMax_class_std_shared_ptr_struct_OpenVdbFloatGrid:
    """
    Get copies of all selected voxel grids in the scene.
    """
...
def selectByType(typeName: str) -> None:
    ...
    """
def setSelectedMeshEdges(arg0: meshlib.mrmeshpy.std_vector_TaggedBitSet_class_UndirectedEdgeTag) -> None:
    """
    Set selected edge bitsets of the selected mesh objects.
    """
def setSelectedMeshFaces(arg0: meshlib.mrmeshpy.std_vector_TaggedBitSet_class_FaceTag) -> None:
    """
    Set selected face bitsets of the selected mesh objects.
    """
def setSelectedPointCloudPoints(arg0: meshlib.mrmeshpy.std_vector_TaggedBitSet_class_VertTag) -> None:
    """
