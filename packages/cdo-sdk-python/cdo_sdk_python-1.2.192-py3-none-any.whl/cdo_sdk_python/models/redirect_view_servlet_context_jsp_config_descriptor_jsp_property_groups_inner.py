...
class RedirectViewServletContextJspConfigDescriptorJspPropertyGroupsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deferredSyntaxAllowedAsLiteral", "trimDirectiveWhitespaces", "scriptingInvalid", "elIgnored", "pageEncoding", "isXml", "includePreludes", "includeCodas", "errorOnUndeclaredNamespace", "buffer", "defaultContentType", "urlPatterns"]
