...
class CustomProperty(BaseModel):
    ...
    name: Annotated[
        basic.EntityName,
        Field(
            description='Name of the entity property. Note a property name must be unique for an entity. Property name must follow camelCase naming adopted by metaMart - must start with lower case with no space, underscore, or dots.'
        ),
    ]
