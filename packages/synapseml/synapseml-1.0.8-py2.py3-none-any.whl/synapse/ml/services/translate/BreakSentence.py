...
class BreakSentence(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="BreakSentence_ec6843388c89_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="BreakSentence_ec6843388c89_output",
        script=None,
        scriptCol=None,
        ...
        self._setDefault(errorCol="BreakSentence_ec6843388c89_error")
        self._setDefault(outputCol="BreakSentence_ec6843388c89_output")
