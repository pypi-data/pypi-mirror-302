...
class Translate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Translate_be9d3306cbc2_error",
        fromLanguage=None,
        ...
        outputCol="Translate_be9d3306cbc2_output",
        ...
        self._setDefault(errorCol="Translate_be9d3306cbc2_error")
        self._setDefault(outputCol="Translate_be9d3306cbc2_output")
