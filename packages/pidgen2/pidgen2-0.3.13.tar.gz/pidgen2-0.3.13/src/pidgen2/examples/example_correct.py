...
config = {
  ...
  'lk' :   {
            ...
            "ProbNNp"    : ("ProbNNp",  "K_Dstar2Dpi", "MC15TuneV1_ProbNNp", kernels),
           },
  'lp' :   {
            "ProbNNK"    : ("ProbNNK",  "p_Lambda2ppi", "MC15TuneV1_ProbNNK", kernels),
            "ProbNNpi"   : ("ProbNNpi", "p_Lambda2ppi", "MC15TuneV1_ProbNNpi", kernels),
            "ProbNNp"    : ("ProbNNp",  "p_Lambda2ppi", "MC15TuneV1_ProbNNp", kernels),
            "prProbNNK"  : ("ProbNNK",  "p_Lambda2ppi_Prompt", "MC15TuneV1_ProbNNK", kernels),
            "prProbNNpi" : ("ProbNNpi", "p_Lambda2ppi_Prompt", "MC15TuneV1_ProbNNpi", kernels),
            "prProbNNp"  : ("ProbNNp",  "p_Lambda2ppi_Prompt", "MC15TuneV1_ProbNNp", kernels),
           },
}
