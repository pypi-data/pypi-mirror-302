...
IContext_reflection = _expr1423

def _arrow1428(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1424()), ("Organization", ObjectExpr1425()), ("name", ObjectExpr1426())])
    ...
    return ObjectExpr1427()


context_jsonvalue: IEncodable = _arrow1428()
