"""A web3.py Contract class for the EETHTarget3Deployer contract.
...
class EETHTarget3DeployerDeployTargetContractFunction0(
    PypechainContractFunction
):
    ...
    def call(
        ...
        try:
            ...
            raise handle_contract_logic_error(
                ...
                errors_class=EETHTarget3DeployerContractErrors,
                err=err,
...
class EETHTarget3DeployerDeployTargetContractFunction(
    PypechainContractFunction
):
    ...
    @overload
    def __call__(self, _config: IHyperdrive.PoolConfig, _adminController: str, arg3: bytes, _salt: bytes) -> EETHTarget3DeployerDeployTargetContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> EETHTarget3DeployerDeployTargetContractFunction:  # type: ignore
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        out._functions = {
            EETHTarget3DeployerDeployTargetContractFunction0._type_signature: EETHTarget3DeployerDeployTargetContractFunction0.factory(
                "EETHTarget3DeployerDeployTargetContractFunction0", **kwargs
            ),
        }
        return out


class EETHTarget3DeployerLiquidityPoolContractFunction0(
    PypechainContractFunction
):
...
class EETHTarget3DeployerLiquidityPoolContractFunction(
    PypechainContractFunction
):
    """ContractFunction for the liquidityPool method."""
    ...
    @overload
    def __call__(self) -> EETHTarget3DeployerLiquidityPoolContractFunction0:  # type: ignore
        ...

    def __call__(self, *args, **kwargs) -> EETHTarget3DeployerLiquidityPoolContractFunction:  # type: ignore
        clone = super().__call__(
            *(dataclass_to_tuple(arg) for arg in args),
            **{key: dataclass_to_tuple(arg) for key, arg in kwargs.items()},
        )
    ...
    def factory(cls, class_name: str, **kwargs: Any) -> Self:
        ...
        # (attached to a specific web3 and contract address)
        out._functions = {
            EETHTarget3DeployerLiquidityPoolContractFunction0._type_signature: EETHTarget3DeployerLiquidityPoolContractFunction0.factory(
                "EETHTarget3DeployerLiquidityPoolContractFunction0", **kwargs
            ),
        }
        return out


class EETHTarget3DeployerContractFunctions(ContractFunctions):
    """ContractFunctions for the EETHTarget3Deployer contract."""

    deployTarget: EETHTarget3DeployerDeployTargetContractFunction

    liquidityPool: EETHTarget3DeployerLiquidityPoolContractFunction
    ...
    def __init__(
        ...
        self.deployTarget = (
            EETHTarget3DeployerDeployTargetContractFunction.factory(
                "deployTarget",
                w3=w3,
                contract_abi=abi,
                address=address,
        ...
        self.liquidityPool = (
            EETHTarget3DeployerLiquidityPoolContractFunction.factory(
                "liquidityPool",
                w3=w3,
                contract_abi=abi,
                address=address,
...
eethtarget3deployer_abi: ABI = cast(
    ABI,
    [
        {
            "type": "constructor",
...
class EETHTarget3DeployerContractErrors(PypechainBaseContractErrors):
    """ContractErrors for the EETHTarget3Deployer contract."""
...
class EETHTarget3DeployerContract(Contract):
    ...
    def factory(
        ...
        contract.functions = EETHTarget3DeployerContractFunctions(
            eethtarget3deployer_abi, w3, None
        )
