...
def test_basic_hook() -> None:
    ...
    assert t.hook_response() == {
        "automation_blockers": [
            {"content": "str blocker", "id": 5880323636},
            {"content": "global blocker"},
        ],
        "messages": [
            {"type": "info", "content": "str2 info", "id": 5880323637},
            {"type": "warning", "content": "global warning"},
        ],
        "operations": [
            {"op": "replace", "id": 5880324090, "value": {"content": {"value": "2"}}},
            {
                "op": "replace",
                "id": 5880323639,
                "value": {
            ...
            {"op": "replace", "id": 5880323637, "value": {"content": {"value": "rewyewing"}, "hidden": True}},
        ],
    }
...
def test_validation_sources_insert_remove() -> None:
    ...
    response = t.hook_response()
    assert response["operations"] == [
        {"op": "replace", "id": 5880323638, "value": {"validation_sources": ["data_matching", "human"]}}
    ]
...
def test_simple_multivalue_assignment() -> None:
    ...
    response = t.hook_response()
    assert response["operations"] == [
        {"op": "replace", "id": 5880362731, "value": {"content": {"value": "new"}}},
        {"op": "replace", "id": 5880362800, "value": {"content": {"value": "assigned"}}},
        {"op": "add", "id": 5880323643, "value": {"content": {"value": "values"}}},
    ]
    ...
    assert response["operations"] == [
        {"op": "replace", "id": 5880362731, "value": {"content": {"value": "new"}}},
        {"op": "replace", "id": 5880362800, "value": {"content": {"value": "assigned"}}},
        {"op": "add", "id": 5880323643, "value": {"content": {"value": "changed"}}},
    ]
...
def test_simple_multivalue_assignment_to_empty() -> None:
    ...
    response = t.hook_response()
    assert response["operations"] == [
        {"op": "add", "id": 5881323643, "value": {"content": {"value": "new"}}},
        {"op": "add", "id": 5881323643, "value": {"content": {"value": "assigned"}}},
        {"op": "add", "id": 5881323643, "value": {"content": {"value": "values"}}},
    ]
...
def test_simple_multivalue_incremental() -> None:
    ...
    assert response["operations"] == [
        ...
        {"op": "add", "id": 5880323643, "value": {"content": {"value": "g"}}},
    ]
    ...
    assert response["operations"] == [
        ...
        {"op": "replace", "id": 5880362731, "value": {"content": {"value": "f"}}},
    ]
...
def test_simple_multivalue_incremental_greedy() -> None:
    ...
    response = t.hook_response()
    assert response["operations"] == [
        {"op": "remove", "id": 5880362731},
        {"op": "remove", "id": 5880362800},
        {"op": "remove", "id": "multistr_inner_2"},
        {"op": "remove", "id": "multistr_inner_3"},
        {"op": "remove", "id": "multistr_inner_4"},
        {"op": "add", "id": 5880323643, "value": {"content": {"value": "b"}}},
        {"op": "add", "id": 5880323643, "value": {"content": {"value": "c"}}},
        {"op": "add", "id": 5880323643, "value": {"content": {"value": "d"}}},
        {"op": "add", "id": 5880323643, "value": {"content": {"value": "e"}}},
    ]
...
def test_simple_multivalue_appenditicis() -> None:
    ...
    assert response["operations"] == [
        ...
        {"op": "replace", "id": 5880323636, "value": {"hidden": True}},
    ]
    ...
    assert response["operations"] == [
        ...
        {"op": "replace", "id": 5880323636, "value": {"content": {"value": "abc"}, "hidden": True}},
    ]
...
def test_tuple_column_assignment() -> None:
    ...
    response = t.hook_response()
    assert response["operations"] == [
        {"op": "replace", "id": 5880324088, "value": {"content": {"value": "a"}}},
        {"op": "replace", "id": 5880324093, "value": {"content": {"value": "b"}}},
        {"op": "replace", "id": 5880324098, "value": {"content": {"value": "c"}}},
...
def test_multivalue_tuple_assignment() -> None:
    ...
    response = t.hook_response()
    assert response["operations"] == [
        {"op": "replace", "id": 5881324088, "value": {"content": {"value": "Ab-c-d"}}},
        {"op": "replace", "id": 5881324090, "value": {"content": {"value": "1.0"}}},
        {
            "op": "add",
            "id": 5881323645,
            "value": [
    ...
    assert response["operations"] == [
        ...
        {"op": "replace", "id": 5881324088, "value": {"content": {"value": "Ef-g-h"}}},
        {"op": "replace", "id": 5881324090, "value": {"content": {"value": "2.0"}}},
    ]
    assert [row._index == i for i, row in enumerate(t.field.line_items2)]
...
def test_multivalue_tuple_listops() -> None:
    ...
    response = t.hook_response()
    assert response["operations"] == [{"op": "remove", "id": 5880324092}]
    assert [row._index == i for i, row in enumerate(t.field.line_items)]
    ...
    assert response["operations"] == [
        ...
        {"op": "replace", "id": 5880324088, "value": {"content": {"value": "Abc"}}},
    ]
    assert [row._index == i for i, row in enumerate(t.field.line_items)]
    ...
    assert response["operations"] == [
        ...
        {"op": "replace", "id": 5880324098, "value": {"content": {"value": "Xyz"}}},
        {"op": "replace", "id": 5880324100, "value": {"content": {"value": "42"}}},
    ]
    assert [row._index == i for i, row in enumerate(t.field.line_items)]
