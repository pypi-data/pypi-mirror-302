        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "| Description | [Detailed description for this image, style and purpose of using] |\n"
                    ...
                    "- Use ONLY the EXACT full paths for images as specified in the development plan, appended to the root path\n"
                    ...
                    "- Provide full and detailed descriptions for each image as mentioned in the development plan\n"
                    "- Include the dimensions (width x height) for each image if specified in the development plan\n"
                    "- If the user request contains any image formats other than PNG, JPG, JPEG, or .ico, completely ignore and do not mention them in the response"
                )
            },
            {
                "role": "user",
                "content": f"Find images in this development plan: {user_prompt}"
            }
        ]
