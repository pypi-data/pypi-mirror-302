...
class DictionaryLookup(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryLookup_526fa4d67473_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryLookup_526fa4d67473_output",
        ...
        self._setDefault(errorCol="DictionaryLookup_526fa4d67473_error")
        self._setDefault(outputCol="DictionaryLookup_526fa4d67473_output")
