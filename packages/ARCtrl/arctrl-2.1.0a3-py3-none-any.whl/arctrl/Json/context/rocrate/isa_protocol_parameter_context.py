...
IContext_reflection = _expr1491

def _arrow1498(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1492()), ("arc", ObjectExpr1493()), ("ProtocolParameter", ObjectExpr1494()), ("ArcProtocolParameter", ObjectExpr1495()), ("parameterName", ObjectExpr1496())])
    ...
    return ObjectExpr1497()


context_jsonvalue: IEncodable = _arrow1498()
