...
class Flow:
    ...
    @classmethod
    def parse(cls, data: Dict, with_adapters: bool = False) -> "Flow":
        global nx
        import networkx as nx
            ...
            for n in data["nodes"]:
                ...
                if kls.PLURALLY_VERSION != version_from and kls.PLURALLY_VERSION != 0:
                    ...
                    for child in n["subflow_nodes"]:
                        ...
                        if (
                            kls.PLURALLY_VERSION != version_from
                            and kls.PLURALLY_VERSION != 0
                        ):
                    ...
                    if ungroup:
                        ...
                        connected_to_run_handle = flow_utils.ungroup_subflow_data(
                            data, n["_node_id"]
                        )
