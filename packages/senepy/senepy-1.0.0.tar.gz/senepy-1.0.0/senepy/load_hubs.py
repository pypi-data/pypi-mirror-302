...
class load_hubs(object):
    ...
    def __init__(self, species = None, sig_type = 'hubs', sig_version = 'v2'):
        ...
        if sig_version not in ['v1', 'v2']:
            raise ValueError("Please pick version v1 or v2")
        ...
        #load Senpy Data
        if species == 'Mouse' and sig_type == 'hubs' and sig_version == 'v1':
        ...
        if species == 'Mouse' and sig_type == 'cell_type' and sig_version == 'v1':
            ...
            self.metadata = read_pickle(stream)
        if species == 'Human' and sig_type == 'hubs' and sig_version == 'v1':
            ...
            self.metadata = read_pickle(stream)
        if species == 'Human' and sig_type == 'cell_type' and sig_version == 'v1':
        ...
        if species == 'Mouse' and sig_type == 'hubs' and sig_version == 'v2':
            stream = resource_filename(__name__, 'data/R1_TMS_HUBS_DICTIONARY_FILTERED.pickle')
            with open(stream, 'rb') as handle:
                self.hubs = pickle.load(handle)
            stream = resource_filename(__name__, 'data/R1_TMS_HUBS_METADATA_FILTERED.pickle')
            self.metadata = read_pickle(stream)
        if species == 'Mouse' and sig_type == 'cell_type' and sig_version == 'v2':
            stream = resource_filename(__name__, 'data/R1_TMS_SIGS_DICTIONARY_FILTERED.pickle')
            with open(stream, 'rb') as handle:
                self.hubs = pickle.load(handle)
            stream = resource_filename(__name__, 'data/R1_TMS_SIGS_METADATA_FILTERED.pickle')
            self.metadata = read_pickle(stream)
        if species == 'Human' and sig_type == 'hubs' and sig_version == 'v2':
            stream = resource_filename(__name__, 'data/R1_6_HUMAN_HUBS_DICTIONARY_FILTERED.pickle')
            with open(stream, 'rb') as handle:
                self.hubs = pickle.load(handle)
            stream = resource_filename(__name__, 'data/R1_6_HUMAN_HUBS_METADATA_FILTERED.pickle')
            self.metadata = read_pickle(stream)
        if species == 'Human' and sig_type == 'cell_type' and sig_version == 'v2':
            stream = resource_filename(__name__, 'data/R1_6_HUMAN_SIGS_DICTIONARY_FILTERED.pickle')
            with open(stream, 'rb') as handle:
                self.hubs = pickle.load(handle)
            stream = resource_filename(__name__, 'data/R1_6_HUMAN_SIGS_METADATA_FILTERED.pickle')
            self.metadata = read_pickle(stream)
