...
class BaseLLM(object):
    ...
    def stream_to_redis(self, text_chunk, taskid):
        if taskid:
            meta_data = {"type": "stream_text_chunk", "model_name": self.__class__.__name__}
            Redis.stream_to_redis(type="multillmStream", 
                                    taskid=taskid, 
