...
class GetRPPrices(GetData):
    ...
    def get_price_withdraw(self) -> dict[str, Any]:
        ...
        """
        return self._process_rp_price(MAX_PNL_FACTOR_FOR_WITHDRAWALS)
    ...
    def get_price_deposit(self) -> dict[str, Any]:
        ...
        :return: Dictionary of RP prices.
        """
        return self._process_rp_price(MAX_PNL_FACTOR_FOR_DEPOSITS)
    ...
    def get_price_traders(self) -> dict[str, str | float]:
        ...
        :return: Dictionary of RP prices.
        """
        return self._process_rp_price(MAX_PNL_FACTOR_FOR_TRADERS)
