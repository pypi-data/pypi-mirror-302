...
class MacroClient:
    ...
    def get_segmentations(self, *, request_options: typing.Optional[RequestOptions] = None) -> typing.List[str]:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "api/v1/data/weather/segmentations", method="GET", request_options=request_options
        )
    ...
    def get_metadata(
        ...
        if 200 <= _response.status_code < 300:
            return pydantic_v1.parse_obj_as(typing.List[WeatherMetadata], _response.json())  # type: ignore
    ...
    def get_gauge(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic_v1.parse_obj_as(typing.List[WeatherGauge], _response.json())  # type: ignore
        if _response.status_code == 422:
            raise UnprocessableEntityError(
                pydantic_v1.parse_obj_as(HttpValidationError, _response.json())  # type: ignore
            )
    ...
    def get_components(
        ...
        if 200 <= _response.status_code < 300:
            return pydantic_v1.parse_obj_as(typing.List[WeatherComponents], _response.json())  # type: ignore
        if _response.status_code == 422:
            raise UnprocessableEntityError(
                pydantic_v1.parse_obj_as(HttpValidationError, _response.json())  # type: ignore
            )
    ...
    def get_market_context(
        ...
        if 200 <= _response.status_code < 300:
            return pydantic_v1.parse_obj_as(typing.List[WeatherMarketContext], _response.json())  # type: ignore
        if _response.status_code == 422:
            raise UnprocessableEntityError(
                pydantic_v1.parse_obj_as(HttpValidationError, _response.json())  # type: ignore
            )
