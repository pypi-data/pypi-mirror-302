...
class WorkflowConfig(BaseModel):
    ...
    metaMartServerConfig: metaMartConnection.MetaMartConnection
    config: Optional[basic.ComponentConfig] = None
...
class MetaMartWorkflowConfig(BaseModel):
    model_config = ConfigDict(
        extra='forbid',
    )
    source: Source
...
class MetadataWorkflow1(BaseModel):
    ...
    metaMartWorkflowConfig: Annotated[
        MetaMartWorkflowConfig, Field(description='MetaMart Ingestion Workflow Config.')
    ]
...
class MetadataWorkflow(RootModel[Union[MetadataWorkflow1, MetadataWorkflow2]]):
    root: Annotated[
        ...
        Field(
            description='MetaMart Ingestion Framework definition.',
