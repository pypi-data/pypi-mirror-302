...
def assign_annotators(project, queryset, **kwargs):
    print("assign_annotators")
    return True

def assign_reviewer(project, queryset, **kwargs):
    print("assign_reviewer")
    return True
...
actions = [
    {
        ...
        'dialog': {
            ...
            'The recommended way to get predictions is to update tasks using the Labelo API.'
