...
class ApplianceVlansSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[bool] vlans_enabled: Boolean indicating whether VLANs are enabled (true) or disabled (false) for the network
        """
...
class ApplianceVlansSettings(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            network_id: Optional[pulumi.Input[str]] = None,
            vlans_enabled: Optional[pulumi.Input[bool]] = None) -> 'ApplianceVlansSettings':
        """
