...
class ImageCheckAgent:
    ...
    async def get_image_check_plan(self, user_prompt):
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": f"Check if ANY NEW PNG, png, JPG, jpg, JPEG, jpeg, or .ico images need to be generated. No other types of images are allowed. User request: {user_prompt}"
            }
        ]
