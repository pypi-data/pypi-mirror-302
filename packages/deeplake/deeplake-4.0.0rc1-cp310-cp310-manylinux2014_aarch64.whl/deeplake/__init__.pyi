...
class Future:
    """
    A future that will resolve to a result. The future will resolve even if you don't wait for it.
    """

    def result(self) -> typing.Any:
        """
        Blocks until the future is resolved, then returns the dataset
        """
        ...
    ...
    def is_completed(self) -> bool:
        """
        Returns True if the future is resolved, False otherwise
        """
        ...

class FutureVoid:
    """
    A future that will resolve to `None`. The future will resolve even if you don't wait for it.
    """

    def wait(self) -> None:
        """
        Blocks until the future is resolved, then returns None
        """
        ...
...
class Row:
    ...
    def get_async(self, column: str) -> Future:
        """
        Asynchronously get the value for the given column
        """
    ...
    def set_async(self, column: str, value: typing.Any) -> FutureVoid:
        """
        Asynchronously change the value for the given column
        """
...
class Dataset(DatasetView):
    ...
    def tags(self) -> Tags:
        """
        The collection of [deeplake.Branches][] within the dataset
        """
...
def create(url: str, creds: dict[str, str] | None = None, token: str | None = None,
           schema: dict[str, types.DataType | str | types.Type] | None = None) -> Dataset:
    """
...
def create_async(url: str, creds: dict[str, str] | None = None, token: str | None = None,
                 schema: dict[str, types.DataType | str | types.Type] | None = None) -> Future:    """
...
def open_async(
    ...
    See [deeplake.open][] for opening the dataset in synchronously.
    """
