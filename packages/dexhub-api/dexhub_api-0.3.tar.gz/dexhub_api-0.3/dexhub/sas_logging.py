...
def log(obs: Observation, act: Action, data: mujoco.MjData = None) -> None:
    """
    Logs a transition to local memory using :class:`dexhub.types.TransitionStorage` class.

    :param obs: The observation data.
    :type obs: :class:`dexhub.types.Observation`
    :param act: The action data.
    :type act: :class:`dexhub.types.Action`
    :return: None
    :rtype: None
...
def load(path: str) -> TransitionStorage:
    ...
    :rtype: :class:`dexhub.types.TransitionStorage`
