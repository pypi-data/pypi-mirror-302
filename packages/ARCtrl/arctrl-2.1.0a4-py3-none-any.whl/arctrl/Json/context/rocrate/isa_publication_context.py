...
IContext_reflection = _expr1499

def _arrow1509(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1500()), ("Publication", ObjectExpr1501()), ("pubMedID", ObjectExpr1502()), ("doi", ObjectExpr1503()), ("title", ObjectExpr1504()), ("status", ObjectExpr1505()), ("authorList", ObjectExpr1506()), ("comments", ObjectExpr1507())])
    ...
    return ObjectExpr1508()


context_jsonvalue: IEncodable = _arrow1509()
