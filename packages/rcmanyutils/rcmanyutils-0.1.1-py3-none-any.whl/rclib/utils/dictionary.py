...
@enforce_type_hints_contracts
def deep_merge(
    a: Dict[str, Any], b: Dict[str, Any], strategies: Optional[Dict[str, str]] = None
) -> Dict[str, Any]:
    ...
    for bk, bv in b.items():
        ...
        # Print the types of av and bv for debugging
        print(f"Merging: av={av} (type: {type(av)}), bv={bv} (type: {type(bv)})")
