...
T = TypeVar("T", bound="MetadataLabelDto")


@_attrs_define
class MetadataLabelDto:
    """
    Attributes:
    ...
    cbor_metadata: Union[Unset, str] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        cbor_metadata = self.cbor_metadata
        ...
        if cbor_metadata is not UNSET:
            field_dict["cbor_metadata"] = cbor_metadata
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        cbor_metadata = d.pop("cbor_metadata", UNSET)

        slot = d.pop("slot", UNSET)

        metadata_label_dto = cls(
        ...
        metadata_label_dto.additional_properties = d
        return metadata_label_dto
