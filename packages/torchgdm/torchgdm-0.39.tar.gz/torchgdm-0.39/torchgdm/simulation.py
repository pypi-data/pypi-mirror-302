...
class SimulationBase:
    ...
    def __init__(
        ...
        if len(torch.as_tensor(self.wavelengths).shape) == 0:
            self.wavelengths = self.wavelengths.unsqueeze(0)
...
class Simulation(SimulationBase):
    ...
    def get_crosssections(self, **kwargs):
        ...
        *Note:* this is an alias for :func:`Simulation.get_scs_spectra`.
        ...
        """
        return self.get_scs_spectra(**kwargs)

    def get_scs_spectra(self, **kwargs):
        """total scattering, absorption and extinction cross section spectra
    ...
    def get_ecs_spectra(self, **kwargs):
    ...
    def get_acs_spectra(self, **kwargs):
    ...
    def get_nf_spectra(self, r_probe=None, **kwargs):
    ...
    def get_nf_intensity_spectra_e(self, r_probe=None, **kwargs):
        """Get spectrum of integrated electric nearfield intensities
        ...
        """
        nf_spec = self.get_nf_spectra(r_probe=r_probe, **kwargs)
    ...
    def get_nf_intensity_spectra_h(self, r_probe=None, **kwargs):
        """Get spectrum of integrated magnetic nearfield intensities
    ...
    def get_nf_intensity_spectra_e_inside(self):
        """Get spectrum of integrated electric nearfield intensities inside structure"""
        import torchgdm as tg
    ...
    def get_nf_intensity_spectra_h_inside(self):
        """Get spectrum of integrated magnetic nearfield intensities inside structure"""
        import torchgdm as tg
    ...
    def get_ff_spectra(self, r_probe=None, **kwargs):
    ...
    def get_ff_intensity_spectra(self, r_probe=None, **kwargs):
        ...
        """
        ff_spec = self.get_ff_spectra(r_probe, **kwargs)
    ...
    def get_multipole_spec(self, **kwargs):
    ...
    def get_multipole_scs_spec(self, **kwargs):
    ...
    def get_multipole_ecs_spec(self, **kwargs):
