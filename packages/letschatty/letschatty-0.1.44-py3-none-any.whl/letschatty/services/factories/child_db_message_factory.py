...
from ...models.messages.chatty_messages.schema import ChattyContentImage, ChattyContentVideo, ChattyContentDocument, ChattyContentAudio, ChattyContentSticker, ChattyContentLocation, ChattyContentContacts, ChattyContentReaction, ChattyContentText, ChattyContentCentral, ChattyContent
from ...models.messages import ChattyMessage, AudioMessage, DocumentMessage, ImageMessage, LocationMessage, StickerMessage, TextMessage, VideoMessage, ReactionMessage, CentralNotification, ContactMessage
...
class JsonMessageFactory:
    ...
    @staticmethod
    def from_db(message_json : ChattyMessageJson) -> Optional[ChattyMessage]:
    ...
    def match_and_instantiate(message_json : ChattyMessageJson) -> ChattyMessage:
        ...
        match message_json.type:
            ...
            case _:
                raise ValueError(f"Message type {message_json.type} not supported")
