...
from igx_api.l2.tags import CollectionTags
from igx_api.l2.types.tag import Tag, TagId, TagKey, TagValue
...
class CollectionMetadata(FromRawModel[openapi_client.models.GetCollectionsSuccessResponseCollectionsInner]):
    ...
    @classmethod
    def _build(cls, raw: openapi_client.models.GetCollectionsSuccessResponseCollectionsInner) -> "CollectionMetadata":
        return cls(
