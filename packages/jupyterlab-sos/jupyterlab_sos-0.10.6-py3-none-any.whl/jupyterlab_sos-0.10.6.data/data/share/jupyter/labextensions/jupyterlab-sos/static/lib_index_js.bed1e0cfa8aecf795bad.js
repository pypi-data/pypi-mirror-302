...
class SoSWidgets {
    ...
    createNew(panel, context) {
        ...
        context.sessionContext.ready.then(() => {
            var _a, _b;
            void ((_b = (_a = context.sessionContext.session) === null || _a === void 0 ? void 0 : _a.kernel) === null || _b === void 0 ? void 0 : _b.info.then(kernel_info => {
                ...
                if (lang.name === 'sos') {
                    ...
                    (0,_selectors__WEBPACK_IMPORTED_MODULE_9__.showSoSWidgets)(panel.node);
                }
            }));
        });
...
/* harmony export */   showSoSWidgets: () => (/* binding */ showSoSWidgets),
...
function showSoSWidgets(element) {
    let sos_elements = element.getElementsByClassName(CELL_LANGUAGE_DROPDOWN_CLASS);
...
class KernelSwitcher extends _jupyterlab_apputils__WEBPACK_IMPORTED_MODULE_2__.ReactWidget {
    ...
    render() {
        ...
        let kernel = cell.model.getMetadata('kernel');
        return (react__WEBPACK_IMPORTED_MODULE_3___default().createElement(_jupyterlab_ui_components__WEBPACK_IMPORTED_MODULE_1__.HTMLSelect, { className: CELL_LANGUAGE_DROPDOWN_CLASS + " " + CELL_HIDDEN_LANGUAGE_DROPDOWN_CLASS, onChange: this.handleChange, onKeyDown: this.handleKeyDown, value: kernel ? kernel : 'SoS', "aria-label": "Kernel", title: 'Select the cell kernel' }, optionChildren));
    }
}
...
//# sourceMappingURL=lib_index_js.bed1e0cfa8aecf795bad.js.map