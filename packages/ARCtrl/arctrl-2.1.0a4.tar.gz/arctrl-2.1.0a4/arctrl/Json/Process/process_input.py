...
def _arrow2219(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2220(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2221(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2222(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2219, ROCrate_decoder_1), map(_arrow2220, ROCrate_decoder_2), map(_arrow2221, ROCrate_decoder_3), map(_arrow2222, ROCrate_decoder_4)]))
...
def _arrow2224(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2225(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2228(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2229(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2224, ISAJson_decoder_1), map(_arrow2225, ISAJson_decoder_2), map(_arrow2228, ISAJson_decoder_3), map(_arrow2229, ISAJson_decoder_4)]))
