...
class FormatCodes:
  ...
  **Special formatting when param `default_color` is set to a color:**
  ...
  @staticmethod
  def input(prompt:str, default_color:hexa|rgb = None, brightness_steps:int = 20) -> str:
    FormatCodes.__config_console()
    ansi_prompt = FormatCodes.to_ansi(prompt, default_color, brightness_steps)
    return input(ansi_prompt)

  @staticmethod
  def to_ansi(string:str, default_color:hexa|rgb = None, brightness_steps:int = 20, _default_start:bool = True) -> str:
...
if __name__ == '__main__':
  ...
  [b|#75A2FF]Includes:[*]
    *  CUSTOM TYPES:
      *  [#AA90FF]rgb[#555]/([i|#60AAFF]int[_|#555],[i|#60AAFF]int[_|#555],[i|#60AAFF]int[_|#555],[i|#60AAFF]float[_|#555])[*]
      *  [#AA90FF]hsl[#555]/([i|#60AAFF]int[_|#555],[i|#60AAFF]int[_|#555],[i|#60AAFF]int[_|#555],[i|#60AAFF]float[_|#555])[*]
      *  [#AA90FF]hexa[#555]/([i|#60AAFF]str[_|#555])[*]
    *  DIRECTORY OPERATIONS     [#77EFEF]xx[#555].[#AA90FF]Dir[*]
    *  FILE OPERATIONS          [#77EFEF]xx[#555].[#AA90FF]File[*]
    *  JSON FILE OPERATIONS     [#77EFEF]xx[#555].[#AA90FF]Json[*]
    *  SYSTEM ACTIONS           [#77EFEF]xx[#555].[#AA90FF]System[*]
    *  MANAGE ENVIRONMENT VARS  [#77EFEF]xx[#555].[#AA90FF]Env_vars[*]
    *  CMD LOG AND ACTIONS      [#77EFEF]xx[#555].[#AA90FF]Cmd[*]
    *  PRETTY PRINTING          [#77EFEF]xx[#555].[#AA90FF]FormatCodes[*]
    *  COLOR OPERATIONS         [#77EFEF]xx[#555].[#AA90FF]Color[*]
    *  DATA OPERATIONS          [#77EFEF]xx[#555].[#AA90FF]Data[*]
    *  STR OPERATIONS           [#77EFEF]xx[#555].[#AA90FF]String[*]
    *  CODE STRING OPERATIONS   [#77EFEF]xx[#555].[#AA90FF]Code[*]
    *  REGEX PATTERN TEMPLATES  [#77EFEF]xx[#555].[#AA90FF]Regex[*]
  [_]''', '#9AB8F7')
