...
class LabJack(SingleCommDevice):
    ...
    def set_ain_range(self, channel: int, vrange: Union[Number, AInRange]) -> None:
        """
    ...
    def set_ain_thermocouple(
        ...
        cjc_type: Union[str, CjcType] = (CjcType.internal),  # type: ignore[assignment]
        vrange: Union[Number, AInRange] = (AInRange.ONE_HUNDREDTH),  # type: ignore[assignment]
        resolution: int = 10,
        unit: Union[str, TemperatureUnit] = (TemperatureUnit.K),  # type: ignore[assignment]
    ) -> None:
        """
    ...
    def set_ain_resistance(
        self, channel: int, vrange: Union[Number, AInRange], resolution: int
    ) -> None:
        """
