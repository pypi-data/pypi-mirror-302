...
from mtmai.context import get_user
    ...
    async def get_config(self):
        ...
        assisantConfig = AssisantConfig(
            ...
            workbench=AssisantWorkbenchConfig(
                workbench_default="site",
                workbenchs=[
                    AssisantWorkBrench(id="site", label="站点", description="站点设置"),
                    AssisantWorkBrench(
                        id="article", label="文章", description="文章管理"
                    ),
            ...
            siderView=SiderViewConfig(
                ...
                label="Site",
                viewName="site",
                viewProps=ListViewProps(enableSearch=True).model_dump(),
            ),
            menus=[
                {
                    "id": "site",
        ...
        if user.is_superuser:
            assisantConfig.menus.extend(
                [
                    AssisantMenus(id="user", label="用户", viewName="用户管理"),
                    AssisantMenus(
                        id="dev",
                        label="开发工具",
                        viewName="开发工具",
                        children=[
                            AssisantMenus(
                                id="devtools", label="devtools", viewName="devtools"
                            )
                        ],
                    ),
                ]
