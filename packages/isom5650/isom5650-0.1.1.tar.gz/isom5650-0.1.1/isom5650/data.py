...
def university():
    url = "https://drive.google.com/uc?export=download&id=1BHW_lr7kDHja1suZnexWwWTtfOaofLGM"
    profitpath = 'https://drive.google.com/uc?export=download&id=' + url.split('/')[-2]
...
def us_stockmarket():
    ...
    df =pd.read_csv(urld, index_col=0, parse_dates=True) # Store the data to a variable called 'df'
    return df
