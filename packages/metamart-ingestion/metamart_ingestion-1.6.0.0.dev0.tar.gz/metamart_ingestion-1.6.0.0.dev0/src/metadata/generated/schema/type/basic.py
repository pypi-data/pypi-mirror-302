...
class EnumWithDescription(BaseModel):
    key: Optional[str] = None
    description: Optional[str] = None


class EnumWithDescriptions(RootModel[List[EnumWithDescription]]):
    root: Annotated[
        List[EnumWithDescription],
        Field(description='List of values in Enum with description for each key.'),
    ]
