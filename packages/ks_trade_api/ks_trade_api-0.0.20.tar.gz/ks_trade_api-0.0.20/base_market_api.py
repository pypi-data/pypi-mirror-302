...
class BaseMarketApi(LoggerBase):
    ...
    def query_history(self, vt_symbol: str, start: datetime, end: datetime, interval: KsInterval, adjustment: KsAdjustment) -> DataFrame:
        """
        Query bar history data.
        """
        pass

    def query_history_n(self, vt_symbol: str, n: int, interval: KsInterval, adjustment: KsAdjustment) -> DataFrame:
        """
        Query bar history data.
        """
        pass
