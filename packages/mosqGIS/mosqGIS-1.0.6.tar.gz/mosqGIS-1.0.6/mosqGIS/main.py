...
import os
from mosqGIS.modulos.clasificador.clasificador_urbanizacion import ClasificadorUrbanizacion
from mosqGIS.modulos.manejador.manejador_argumentos import ManejadorArgumentos
from mosqGIS.modulos.procesador.procesador_imagenes import RecortadorImagenes
from mosqGIS.modulos.calculador.calculador_indices import CalculadorIndices
from mosqGIS.modulos.clasificador.clasificador_suelos import ClasificadorSuelos
from mosqGIS.modulos.calculador.calculador_campo_atraccion import CalculadorCampoAtraccion
from mosqGIS.modulos.calculador.calculador_mapa_densidad import CalculadorMapaDensidad
...
def main():
    ...
    carpeta_recortadas = args.carpeta_recortadas or \
        input("Por favor, ingrese la carpeta para imágenes recortadas: ")

    carpeta_no_recortadas = args.carpeta_no_recortadas or \
        input("Por favor, ingrese la carpeta para imágenes no recortadas: ")

    ruta_poligono = os.path.abspath(
        args.ruta_poligono or input("Por favor, ingrese la ruta del archivo de polígono: "))

    ruta_datos_ovitrampas = os.path.abspath(
        args.ruta_datos_ovitrampas or \
            input("Por favor, ingrese la ruta del archivo de datos de ovitrampas: "))
    ...
    recortador_imagenes = RecortadorImagenes(carpeta_recortadas,
                                             carpeta_no_recortadas,
                                             ruta_poligono)
