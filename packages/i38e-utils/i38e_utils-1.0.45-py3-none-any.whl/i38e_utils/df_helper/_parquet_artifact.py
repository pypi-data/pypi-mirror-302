...
from ..data_utils import DataWrapper
...
class ParquetArtifact(DfHelper):
    ...
    def __init__(self,data_wrapper_class,**kwargs,):
        ...
        ensure_directory_exists(self.parquet_storage_path)
    ...
    def generate_daily_parquet(self, **kwargs) -> None:
        """
        Generate a daily Parquet file using the configured DataWrapper class.
        """
    ...
    def update_parquet(self, period: str = 'today', **kwargs) -> None:
        ...
        self.generate_daily_parquet(**kwargs)
    ...
    def _prepare_params(self, kwargs: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'max_age_minutes': kwargs.pop('max_age_minutes', 60),
