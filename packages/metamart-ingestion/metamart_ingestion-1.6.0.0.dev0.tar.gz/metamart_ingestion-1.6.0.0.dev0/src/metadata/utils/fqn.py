...
def build(
    metadata: Optional[MetaMart], entity_type: Type[T], **kwargs
) -> Optional[str]:
    """
    ...
    :param metadata: MetaMart Client
...
def _(
    metadata: Optional[MetaMart],  # ES Search not enabled for Schemas
    *,
    service_name: str,
    database_name: Optional[str],
    schema_name: str,
...
def _(
    _: Optional[MetaMart],  # ES Search not enabled for Databases
    *,
    service_name: str,
    database_name: str,
) -> str:
...
def _(
    _: Optional[MetaMart],  # ES Index not necessary for dashboard FQN building
    *,
    service_name: str,
    dashboard_name: str,
) -> str:
...
def _(
    _: Optional[MetaMart],  # ES Index not necessary for MlModel FQN building
    *,
    service_name: str,
    mlmodel_name: str,
) -> str:
...
def _(_: Optional[MetaMart], *, table_fqn: str) -> str:
    """
...
def _(
    _: Optional[MetaMart],  # ES Index not necessary for Container FQN building
    *,
    service_name: str,
...
def _(
    _: Optional[MetaMart],  # ES Index not necessary for Search Index FQN building
    *,
    service_name: str,
...
def _(
    _: Optional[MetaMart],  # ES Index not necessary for Tag FQN building
    *,
...
def _(
    _: Optional[MetaMart],  # ES Search not enabled for Columns
    *,
    service_name: str,
    database_name: str,
    schema_name: str,
...
def _(
    _: Optional[MetaMart],  # ES Search not enabled for TestCase
    *,
    service_name: str,
    database_name: str,
    schema_name: str,
...
def split_table_name(table_name: str) -> Dict[str, Optional[str]]:
    ...
    # Issue Link: https://github.com/meta-mart/MetaMart/issues/8874
