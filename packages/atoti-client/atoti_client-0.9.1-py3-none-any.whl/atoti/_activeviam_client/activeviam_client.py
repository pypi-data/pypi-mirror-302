...
class ActiveViamClient:
    ...
    def create(
        ...
        *,
        ...
        cert: tuple[str, str | None, str | None] | None = None
        ...
        match authentication:
            ...
            case ClientCertificate():
                cert = (
                    str(authentication.certificate),
                    str(authentication.keyfile) if authentication.keyfile else None,
        ...
        if certificate_authority:
            verify = str(certificate_authority)
