...
class CheckPointInPolygon(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="CheckPointInPolygon_d22aae14cd15_error",
        handler=None,
        latitude=None,
        latitudeCol=None,
        longitude=None,
        longitudeCol=None,
        outputCol="CheckPointInPolygon_d22aae14cd15_output",
        ...
        self._setDefault(errorCol="CheckPointInPolygon_d22aae14cd15_error")
        self._setDefault(outputCol="CheckPointInPolygon_d22aae14cd15_output")
