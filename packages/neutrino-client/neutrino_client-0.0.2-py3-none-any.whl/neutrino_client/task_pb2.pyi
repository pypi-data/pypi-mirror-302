...
class TaskInput(_message.Message):
    __slots__ = ("task_id", "task_name", "timestamp", "type", "status", "threshold", "threshold_unit", "additional_data")
    ...
    def __init__(self, task_id: _Optional[str] = ..., task_name: _Optional[str] = ..., timestamp: _Optional[str] = ..., type: _Optional[str] = ..., status: _Optional[str] = ..., threshold: _Optional[int] = ..., threshold_unit: _Optional[str] = ..., additional_data: _Optional[_Mapping[str, str]] = ...) -> None: ...
