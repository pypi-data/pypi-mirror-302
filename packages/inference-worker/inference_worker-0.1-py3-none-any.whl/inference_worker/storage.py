...
class Storage:
    def __init__(self):
        ...
        self.tmp_dir = '/tmp/inference'
        os.makedirs(self.tmp_dir, exist_ok=True)

    def get_temp_file_name_candidate(self, file_extension=''):
        return f'{self.tmp_dir}/inference_{uuid4()}{file_extension}'

    def get_temporary_file(self, extension=''):
        temp_file = NamedTemporaryFile(prefix=f'inference_', suffix=extension, dir=self.tmp_dir, delete=False)
