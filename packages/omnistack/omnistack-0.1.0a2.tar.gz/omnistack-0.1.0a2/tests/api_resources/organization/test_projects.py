...
class TestProjects:
    ...
    def test_path_params_create(self, client: Omnistack) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            client.organization.projects.with_raw_response.create(
                project_id="",
                name="name",
            )
    ...
    @parametrize
    def test_method_archive(self, client: Omnistack) -> None:
    ...
    @parametrize
    def test_raw_response_archive(self, client: Omnistack) -> None:
    ...
    @parametrize
    def test_streaming_response_archive(self, client: Omnistack) -> None:
    ...
    @parametrize
    def test_path_params_archive(self, client: Omnistack) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
...
class TestAsyncProjects:
    ...
    async def test_path_params_create(self, async_client: AsyncOmnistack) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
            await async_client.organization.projects.with_raw_response.create(
                project_id="",
                name="name",
            )
    ...
    @parametrize
    async def test_method_archive(self, async_client: AsyncOmnistack) -> None:
    ...
    @parametrize
    async def test_raw_response_archive(self, async_client: AsyncOmnistack) -> None:
    ...
    @parametrize
    async def test_streaming_response_archive(self, async_client: AsyncOmnistack) -> None:
    ...
    @parametrize
    async def test_path_params_archive(self, async_client: AsyncOmnistack) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `project_id` but received ''"):
