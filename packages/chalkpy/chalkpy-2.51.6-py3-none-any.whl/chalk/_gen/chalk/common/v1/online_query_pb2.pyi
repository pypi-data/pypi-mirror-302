...
class OnlineQueryMetadata(_message.Message):
    ...
    metadata: _containers.ScalarMap[str, str]
    internal_metadata: OnlineQueryMetadataInternal
    def __init__(
        self,
        ...
        metadata: _Optional[_Mapping[str, str]] = ...,
        internal_metadata: _Optional[_Union[OnlineQueryMetadataInternal, _Mapping]] = ...,
    ) -> None: ...

class OnlineQueryMetadataInternal(_message.Message):
    __slots__ = (
        "json_plan",
        "serialized_plan",
        "serialized_static_plan",
        "serialized_static_physical_plan",
        "planner_options",
        "plan_stages_stored",
        "performance_summary",
        "bus_message_ids",
    ...
    JSON_PLAN_FIELD_NUMBER: _ClassVar[int]
    SERIALIZED_PLAN_FIELD_NUMBER: _ClassVar[int]
    SERIALIZED_STATIC_PLAN_FIELD_NUMBER: _ClassVar[int]
    SERIALIZED_STATIC_PHYSICAL_PLAN_FIELD_NUMBER: _ClassVar[int]
    PLANNER_OPTIONS_FIELD_NUMBER: _ClassVar[int]
    PLAN_STAGES_STORED_FIELD_NUMBER: _ClassVar[int]
    PERFORMANCE_SUMMARY_FIELD_NUMBER: _ClassVar[int]
    BUS_MESSAGE_IDS_FIELD_NUMBER: _ClassVar[int]
    VALUE_TABLES_FIELD_NUMBER: _ClassVar[int]
    json_plan: str
    serialized_plan: str
    serialized_static_plan: str
    serialized_static_physical_plan: str
    planner_options: _containers.MessageMap[str, _struct_pb2.Value]
    plan_stages_stored: bool
    performance_summary: str
    bus_message_ids: BusMessageIDs
    value_tables: _containers.RepeatedScalarFieldContainer[str]
    def __init__(
        self,
        json_plan: _Optional[str] = ...,
        serialized_plan: _Optional[str] = ...,
        serialized_static_plan: _Optional[str] = ...,
        serialized_static_physical_plan: _Optional[str] = ...,
        planner_options: _Optional[_Mapping[str, _struct_pb2.Value]] = ...,
        plan_stages_stored: bool = ...,
        performance_summary: _Optional[str] = ...,
        bus_message_ids: _Optional[_Union[BusMessageIDs, _Mapping]] = ...,
        value_tables: _Optional[_Iterable[str]] = ...,
    ) -> None: ...

class BusMessageIDs(_message.Message):
    __slots__ = (
        "metrics_bus_message_ids",
        "result_bus_message_ids",
        "gcs_parquet_message_ids",
        "pubsub_body_parquet_message_ids",
    )
    METRICS_BUS_MESSAGE_IDS_FIELD_NUMBER: _ClassVar[int]
    RESULT_BUS_MESSAGE_IDS_FIELD_NUMBER: _ClassVar[int]
    GCS_PARQUET_MESSAGE_IDS_FIELD_NUMBER: _ClassVar[int]
    PUBSUB_BODY_PARQUET_MESSAGE_IDS_FIELD_NUMBER: _ClassVar[int]
    metrics_bus_message_ids: _containers.RepeatedScalarFieldContainer[str]
    result_bus_message_ids: _containers.RepeatedScalarFieldContainer[str]
    gcs_parquet_message_ids: _containers.RepeatedScalarFieldContainer[str]
    pubsub_body_parquet_message_ids: _containers.RepeatedScalarFieldContainer[str]
    def __init__(
        self,
        metrics_bus_message_ids: _Optional[_Iterable[str]] = ...,
        result_bus_message_ids: _Optional[_Iterable[str]] = ...,
        gcs_parquet_message_ids: _Optional[_Iterable[str]] = ...,
        pubsub_body_parquet_message_ids: _Optional[_Iterable[str]] = ...,
    ) -> None: ...
