...
from al360_tai_vision_insights_validator import run_and_validate_serialization

from al360_trustworthyai_vision import ModelTask, RAIVisionInsights
from al360_trustworthyai_vision.common.constants import ImageColumns
...
class TestRAIVisionInsightsSaveAndLoadScenarios(object):
    ...
    def test_al360_tai_insights_pytorch_empty_save_load_save(self):
    ...
    def test_al360_tai_insights_large_images_save_load_save(self):
    ...
    def test_loading_al360_tai_insights_without_model_file(self):
        ...
        al360_tai_insights = RAIVisionInsights(
            pred, test, label,
            task_type=task_type,
            classes=class_names,
        ...
        with TemporaryDirectory() as tmpdir:
            ...
            with pytest.raises(OSError, match=match_msg):
                without_model_al360_tai_insights = RAIVisionInsights.load(save_path)
                assert without_model_al360_tai_insights.model is None

    @pytest.mark.parametrize('automl_format', [True, False])
    def test_al360_tai_insights_object_detection(self, automl_format):
    ...
    def test_al360_tai_insights_image_downloader_object_detection(self):
        ...
        get_data = ('test_al360_tai_vision_insights_save_and_load_scenarios'
