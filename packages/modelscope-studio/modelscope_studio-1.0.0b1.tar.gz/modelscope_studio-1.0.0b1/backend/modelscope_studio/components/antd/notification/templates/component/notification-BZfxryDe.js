import { g as Z, w as E } from "./Index-CpRM-BSJ.js";
...
function ve(t, n, r) {
  ...
  return t.$$set = (u) => {
    r(17, n = O(O({}, n), N(u))), "svelteInit" in u && r(5, i = u.svelteInit), "$$scope" in u && r(6, s = u.$$scope);
  }, n = N(n), [l, o, a, _, c, i, s, e, B, J];
}
class xe extends se {
  constructor(n) {
...
const y = Y(({
  ...
  return F(() => {
    ...
    if (n && window.MutationObserver) {
      ...
      d(), a = new window.MutationObserver(() => {
        var f, m;
        (f = e.current) != null && f.contains(i) && ((m = e.current) == null || m.removeChild(i)), d();
      }), a.observe(t, {
        attributes: !0,
        childList: !0,
        subtree: !0
    ...
    return () => {
      var d, f;
      i.style.display = "", (d = e.current) != null && d.contains(i) && ((f = e.current) == null || f.removeChild(i)), a == null || a.disconnect();
    };
  ...
  return F(() => (c ? _.open({
    ...
    onClose(...f) {
      p == null || p(!1), i == null || i(...f);
    }
  }) : _.destroy(a.key), () => {
    _.destroy(a.key);
  }), [c]), /* @__PURE__ */ h.jsxs(h.Fragment, {
    children: [s, d]
  });
});
export {
