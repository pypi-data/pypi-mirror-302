...
class DataPoint(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "data_present", b"data_present"]) -> None: ...
...
class TimeSeriesResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["result_timeseries", b"result_timeseries"]) -> None: ...
