  ...
  create view "f1"."staging"."stg_ergast__race__drivers_fastest_lap__dbt_tmp" as (
    with
...
formatted as (
    select
        ...
        if(result.fastest_lap_time_interval = to_milliseconds(0), null, result.fastest_lap_time_interval) as fastest_lap_time_interval,
