...
class mechanism27(bmutils):
    def __init__(self, settings):
        ...
        self.R_CAM = self.settings['R_CAM']
    ...
    def setup_plot(self):
        self.ax.set_title(f'Mechanism 27')
    ...
    def plot(self, theta = 0):    
        ...
        for index, instance in enumerate(self.instances):
            ...
            if instance["type"] == 0:
                ...
                x_CAM, y_CAM = self.create_circle_section(self.R_CAM, phase=angle-self.settings["theta_CAM"]/2, end_angle=self.settings["theta_CAM"])
                self.ax.plot(x_CAM, y_CAM, color='blue', linestyle='-')
                ...
                self.ax.plot([start_CAM[0], end_CAM[0]], [start_CAM[1], end_CAM[1]], color='blue')
