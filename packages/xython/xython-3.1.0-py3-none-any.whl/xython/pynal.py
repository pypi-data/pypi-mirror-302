...
class pynal():
	...
	def get_all_information_for_dt_obj_as_dic_style(self, input_dt_obj=""):
		if	not input_dt_obj:
			temp = self.change_dt_obj_to_utc(input_dt_obj)
			result = self.get_all_information_for_now_as_dic_style(temp)
		else:
			result = self.get_all_information_for_now_as_dic_style("")
		return result
	...
	def get_week_set_for_utc_timestamp(self, input_data=""):
		...
		yearweekno = time.strftime('%W', utf_local_time)
