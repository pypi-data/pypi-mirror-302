...
from labelo.core.utils.exceptions import (
    LabelStudioValidationErrorSentryIgnored,
)
from labelo.core.utils.io import find_file
...
def parse_config(config_string):
    ...
    """
    logger.warning('Using deprecated method - switch to labelo.tools.label_config.parse_config!')
