...
class CentralReachRequestsCore:
    ...
    def _update_cookies_auth(self):
        """This method performs the additional steps for authentication of the API by refreshing the cookies
        for the session
        """
    ...
    def _login_to_central_reach(self) -> None:
        self.central_reach_core = CentralReachCore(self.__login, self.__password, self.__auth_totp_key, headless=True)
