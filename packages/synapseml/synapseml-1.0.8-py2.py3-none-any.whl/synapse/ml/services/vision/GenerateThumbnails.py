...
class GenerateThumbnails(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GenerateThumbnails_ea5fe4c03b7a_error",
        handler=None,
        height=None,
        heightCol=None,
        imageBytes=None,
        ...
        imageUrl=None,
        imageUrlCol=None,
        outputCol="GenerateThumbnails_ea5fe4c03b7a_output",
        smartCropping=None,
        ...
        self._setDefault(errorCol="GenerateThumbnails_ea5fe4c03b7a_error")
        self._setDefault(outputCol="GenerateThumbnails_ea5fe4c03b7a_output")
