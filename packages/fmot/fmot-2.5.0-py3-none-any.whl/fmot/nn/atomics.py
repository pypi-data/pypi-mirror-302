...
class GMACv2(nn.Module):
    ...
    - int16
    - int24
    int24 is treated as a first-class citizen within fmot, but will result in fragmentation
    when converted to FQIR.

    This version also extends GMAC to the case where terms should be multiplied by fixed immediate values
    """

    def __init__(
        self,
        bits_out: Literal[8, 16, 24],
