...
class ColorOutput(ABC):
    """
    Abstract base class for color output.
    
    Subclasses must implement the `print_color` method.
    """

    reset = "\033[0m"

    @abstractmethod
    def print_color(self, *args) -> str:
        """
        Abstract method for printing color. 
        Must be implemented by subclasses.
        """
        pass


class RGB(ColorOutput):
    """
