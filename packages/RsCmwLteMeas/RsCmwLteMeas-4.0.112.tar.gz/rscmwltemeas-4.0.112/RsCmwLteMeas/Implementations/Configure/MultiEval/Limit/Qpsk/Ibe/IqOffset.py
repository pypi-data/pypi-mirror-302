...
class IqOffsetCls:
	...
	class IqOffsetStruct(StructBase):
		"""Response structure. Fields: \n
			- Offset_1: float: numeric Offset for high TX power range Range: -256 dBc to 256 dBc, Unit: dB
			- Offset_2: float: numeric Offset for intermediate TX power range Range: -256 dBc to 256 dBc, Unit: dB
			- Offset_3: float: numeric Offset for low TX power range Range: -256 dBc to 256 dBc, Unit: dB"""
		__meta_args_list = [
