...
class SSMParameterStore:
    ...
    def get_secret(self, secret_name: str):
        if secret_value := utils.get_environment_variable(secret_name):
            ...
            return secret_value
        if val := self._cached_secrets_map.get(secret_name):
        ...
        try:
            ...
            self._cached_secrets_map = r_get_parameter.parameter_json
            return self._cached_secrets_map[secret_name]
