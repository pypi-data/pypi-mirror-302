...
class SbomApi:
    ...
    def get_sbom_components(
        ...
        component_name: Annotated[Optional[StrictStr], Field(description="If provided, filter components by the component name")] = None,
        ...
        :param component_name: If provided, filter components by the component name
    ...
    def get_sbom_version(
        ...
        specification: Annotated[Optional[StrictStr], Field(description="Target specification of the sbom. Allowed values [cyclonedx1.6|cyclonedx1.5|spdx2.3]. default = cyclonedx1.6")] = None,
        ...
        :type state: str
        :param specification: Target specification of the sbom. Allowed values [cyclonedx1.6|cyclonedx1.5|spdx2.3]. default = cyclonedx1.6
