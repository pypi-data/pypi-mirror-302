...
from odrive.ui import multiple_choice, yes_no_prompt
...
async def write_firmware(device: Union[ODriveInDfuMode, RuntimeDevice], firmware: FirmwareFile, dfu_discoverer: DfuDeviceDiscovery, erase_all: bool, logger, installing_bootloader: bool):
    """
