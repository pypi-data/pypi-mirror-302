...
class barq:
    ...
    def get_inference_info(self, alias: Optional[str] = None) -> Dict[str, Any]:
        ...
        return self._request("GET", "/api/inference", params=params)['WingmanItems']
    ...
    def get_memory_banks(self) -> Dict[str, Any]:
        return self._request("GET", "/api/silk/memorybanks")['SilkMemoryBanks']
    ...
    def check_ingestion_progress(self, memory_bank_name: str) -> Dict[str, Any]:
        ingestions = self.get_ingestions()
        for item in ingestions.get('IngestionItems', []):
            if item['memoryBankName'] == memory_bank_name:
                return {
                    'status': item['status'],
        ...
        return {'error': f"No ingestion found for memory bank '{memory_bank_name}'"}
    ...
    def get_embedding(self, input_text: str) -> Dict[str, Any]:
        return self._request("POST", "/api/silk/embedding", data={"input": input_text})['data']
