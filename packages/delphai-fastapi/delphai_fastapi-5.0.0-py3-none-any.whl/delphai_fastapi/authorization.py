...
class TokenValidator:
    ...
    async def decode_token(self, token: str, audience: str) -> TokenPayload:
        """
    ...
    def _decode_token(
        self, token: str, keys: PublicKeys, audience: str, verify: bool = True
    ) -> TokenPayload:
        """
        ...
        try:
            return jwt.decode(
                token, keys, audience=audience, options={"verify_signature": verify}
            )
...
class _Authorization:
    ...
    async def fastapi_dependency(
        ...
        try:
            ...
            if not authorization.were_permissions_checked:
