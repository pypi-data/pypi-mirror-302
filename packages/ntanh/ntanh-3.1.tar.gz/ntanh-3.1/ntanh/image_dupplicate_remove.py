...
class Parameters1(BasePr):
    def __init__(self, ModuleName="TACT"):
        ...
        self.Max_random_image_to_move = 10
...
class ImageDuplicateRemover:
    ...
    def fnRemove(self):
        ...
        for i in tqdm(range(0,len(fis)-1, 2)):
            ...
            if is_Similar__mse(img1, img2, duplicate_threshold, name1, name2):
        ...
        for img_path in list_duplicate_imgs:
            ...
            print(f"Moved duplicate image: {img_path} to {outPath}")
        return NfilesRemove
