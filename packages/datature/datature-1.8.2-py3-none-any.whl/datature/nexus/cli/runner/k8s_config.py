...
def get_deployment_spec(namespace: str, logs_folder: Path) -> k8s_client.V1Deployment:
            ...
            spec=k8s_client.V1PodSpec(
                ...
                containers=[
                    k8s_client.V1Container(
                        name=RUNNER_DEPLOYMENT_NAME,
                        image=f"{os.getenv('DOCKER_REGISTRY', 'docker.datature.io')}/platform/models/runner:0.0.0",
