...
class Pedigree:
    ...
    def __init__(self,
        ...
        """
        self.G = nx.DiGraph() ## full pedigree graph
        self.M = nx.Graph()   ## mate graph
        self.S = nx.Graph()   ## (half)-sub graph
    ...
    def _add_nodes(self, sample_index:xft.index.SampleIndex):
        ...
        self.M.add_nodes_from(uid)
        self.S.add_nodes_from(uid)
    ...
    def _add_offspring(self,
        ...
        """
        ## parent offspring edges in Pedigree
        ...
        ## mating graph edges
        self.M.add_edges_from([(xx, yy) for (xx, yy) in zip(mating.reproducing_maternal_index.unique_identifier,
                                                            mating.reproducing_paternal_index.unique_identifier)])

    def update_sib_graph(self, gen)
