...
class ObjectExpr53(Decoder_1[str]):
...
string: Decoder_1[str] = ObjectExpr53()
...
char: Decoder_1[str] = ObjectExpr54()
...
class ObjectExpr57(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            ...
            def _arrow55(__unit: None=None) -> str:
                return out_arg

            def _arrow56(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow55, _arrow56)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr57()

class ObjectExpr58(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr58()

class ObjectExpr61(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow59(__unit: None=None) -> int8:
                return out_arg

            def _arrow60(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow59, _arrow60)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr61()

class ObjectExpr64(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow62(__unit: None=None) -> uint8:
                return out_arg

            def _arrow63(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow62, _arrow63)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr64()
...
class ObjectExpr71(Decoder_1[uint16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow69(__unit: None=None) -> uint16_1:
                return out_arg

            def _arrow70(v: uint16_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 16, FSharpRef(_arrow69, _arrow70)), out_arg)
...
uint16: Decoder_1[uint16_1] = ObjectExpr71()

class ObjectExpr74(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow73(v: int) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 32, FSharpRef(_arrow72, _arrow73)), out_arg)
...
int_1: Decoder_1[int] = ObjectExpr74()

class ObjectExpr77(Decoder_1[uint32_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint32_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow75(__unit: None=None) -> uint32_1:
                return out_arg

            def _arrow76(v: uint32_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 32, FSharpRef(_arrow75, _arrow76)), out_arg)
...
uint32: Decoder_1[uint32_1] = ObjectExpr77()

class ObjectExpr80(Decoder_1[int64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow78(__unit: None=None) -> int64_1:
                return out_arg

            def _arrow79(v: int64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, False, 64, FSharpRef(_arrow78, _arrow79)), out_arg)
...
int64: Decoder_1[int64_1] = ObjectExpr80()

class ObjectExpr83(Decoder_1[uint64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow81(__unit: None=None) -> uint64_1:
                return out_arg

            def _arrow82(v: uint64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, True, 64, FSharpRef(_arrow81, _arrow82)), out_arg)
...
uint64: Decoder_1[uint64_1] = ObjectExpr83()
...
class ObjectExpr86(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            parse_result = (try_parse_4(helpers.as_string(value_1), FSharpRef(_arrow84, _arrow85)), out_arg)
...
bigint: Decoder_1[int] = ObjectExpr86()

class ObjectExpr87(Decoder_1[bool]):
...
bool_1: Decoder_1[bool] = ObjectExpr87()

class ObjectExpr88(Decoder_1[float]):
...
float_1: Decoder_1[float] = ObjectExpr88()

class ObjectExpr89(Decoder_1[float32_1]):
...
float32: Decoder_1[float32_1] = ObjectExpr89()

class ObjectExpr92(Decoder_1[Decimal]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Decimal, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow90(__unit: None=None) -> Decimal:
                return out_arg

            def _arrow91(v: Decimal) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_5(helpers.as_string(value_1), FSharpRef(_arrow90, _arrow91)), out_arg)
...
decimal: Decoder_1[Decimal] = ObjectExpr92()

class ObjectExpr95(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            ...
            def _arrow93(__unit: None=None) -> Any:
                return out_arg

            def _arrow94(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_6(helpers.as_string(value_1), FSharpRef(_arrow93, _arrow94)), out_arg)
...
datetime_local: Decoder_1[Any] = ObjectExpr95()
...
class ObjectExpr98(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            ...
            match_value = (try_parse_7(helpers.as_string(value_1), FSharpRef(_arrow96, _arrow97)), out_arg)
...
timespan: Decoder_1[Any] = ObjectExpr98()
...
def decode_maybe_null(helpers: IDecoderHelpers_1[Any], path: str, decoder: Decoder_1[Any], value_1: Any) -> FSharpResult_2[Any | None, tuple[str, ErrorReason_1[_JSONVALUE]]]:
    if helpers.is_null_value(value_1):
        ...
        if match_value.tag == 1:
            def _arrow99(__unit: None=None, helpers: Any=helpers, path: Any=path, decoder: Any=decoder, value_1: Any=value_1) -> tuple[str, ErrorReason_1[_JSONVALUE]]:
            ...
            return FSharpResult_2(1, _arrow99())
...
def optional(field_name: str, decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr100(Decoder_1[_VALUE_ | None]):
...
def optional_at(field_names: FSharpList[str], decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr102(Decoder_1[_VALUE_ | None]):
...
def field(field_name: str, decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr103(Decoder_1[_VALUE_]):
...
def option(decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr106(Decoder_1[_VALUE_ | None]):
...
def list_1(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[Any]]:
    class ObjectExpr108(Decoder_1[FSharpList[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[FSharpList[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    if match_value.tag == 1:
                        def _arrow107(__unit: None=None) -> tuple[str, ErrorReason_1[__A_]]:
                        ...
                        x: tuple[str, ErrorReason_1[__A_]] | None = _arrow107()
                        error = x
