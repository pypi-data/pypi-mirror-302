...
setuptools.setup(
    ...
    name="al360_nlp_feature_extractors",
    ...
    url="https://github.com/affectlog360/al360-trustworthy-ai-widgets",
    # Packages
    packages=[
        "al360_nlp_feature_extractors",
        "al360_nlp_feature_extractors.data"
    ],
