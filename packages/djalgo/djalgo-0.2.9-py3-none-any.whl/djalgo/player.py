...
@staticmethod
def show(
    tracks: Union[Dict[str, List[Tuple[Union[int, List[int], None], float, float]]], 
                  List[Tuple[Union[int, List[int], None], float, float]], 
                  List[List[Tuple[Union[int, List[int], None], float, float]]]],
    ...
    Args:
        tracks: Can be one of the following:
            - A dictionary mapping instrument names to tracks
            - A single track (list of tuples)
            - A list of tracks
          Each track is a list of tuples. Each tuple contains:
    ...
    if isinstance(tracks, list):
        ...
        raise ValueError("Tracks must be a dictionary, a single track, or a list of tracks")
