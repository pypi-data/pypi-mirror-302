...
class CalculationServiceMarketService(HelicsSimulationExecutor):
    ...
    def __init__(self):
        ...
        calculation_information = HelicsCalculationInformation(energy_market_period_in_seconds, 0, True, False, True, "MarketPrice", None, publication_values, self.energy_market_price)
...
class TestSimulation(unittest.TestCase):
    ...
    def start_helics_broker(self, federates):
        broker = h.helicsCreateBroker("zmq", "helics_broker_test", f"-f {federates} --loglevel=NO_PRINT --timeout='60s'")
    ...
    def setUp(self):
        ...
        SETUP_COUNTER += 1
        print(f"Iteration {SETUP_COUNTER}")
