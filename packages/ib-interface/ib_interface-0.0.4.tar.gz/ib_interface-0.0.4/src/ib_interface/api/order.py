...
class OrderStatus:
    ...
    DoneStates: ClassVar[FrozenSet[str]] = frozenset(["Filled", "Cancelled", "ApiCancelled"])
    ActiveStates: ClassVar[FrozenSet[str]] = frozenset(["PendingSubmit", "ApiPending", "PreSubmitted", "Submitted"])
