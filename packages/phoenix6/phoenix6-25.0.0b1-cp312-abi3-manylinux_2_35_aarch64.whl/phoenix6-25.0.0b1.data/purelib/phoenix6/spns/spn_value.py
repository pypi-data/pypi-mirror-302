...
class SpnValue(Enum):
    ...
    TALON_FX_MOTOR_CONSTANTS_KT = 2113
    TALON_FX_MOTOR_CONSTANTS_KV = 2114
    TALON_FX_MOTOR_CONSTANTS_STALL_CURRENT = 2115
    SLOT0_KP = 2116
    SLOT0_KI = 2117
    SLOT0_KD = 2118
    SLOT0_KS = 2119
    ...
    SLOT2_KG = 2138
    SLOT2_KG_TYPE = 2139
    CONFIG_INVERTED = 2140
    CONFIG_SUPPLY_VLOWPASS_TAU = 2141
    CONFIG_BEEP_ON_BOOT = 2142
    CONFIG_NEUTRAL_MODE = 2143
    CONFIG_DUTY_CYCLE_NEUTRAL_DB = 2144
    CONFIG_STATOR_CURRENT_LIMIT = 2145
    CONFIG_STATOR_CURR_LIMIT_EN = 2146
    CONFIG_SUPPLY_CURRENT_LIMIT = 2147
    CONFIG_SUPPLY_CURR_LIMIT_EN = 2148
    CONFIG_PEAK_FORWARD_DC = 2149
    CONFIG_PEAK_REVERSE_DC = 2150
    CONFIG_PEAK_FORWARDV = 2151
    CONFIG_PEAK_REVERSEV = 2152
    CONFIG_PEAK_FOR_TORQ_CURR = 2153
    CONFIG_PEAK_REV_TORQ_CURR = 2154
    CONFIG_TORQUE_NEUTRAL_DB = 2155
    CONFIG_FEEDBACK_ROTOR_OFFSET = 2156
    CONFIG_SENSOR_TO_MECHANISM_RATIO = 2157
    CONFIG_ROTOR_TO_SENSOR_RATIO = 2158
    CONFIG_FEEDBACK_SENSOR_SOURCE = 2159
    CONFIG_FEEDBACK_REMOTE_SENSOR_ID = 2160
    CONFIG_DUTY_CYCLE_OPEN_LOOP_RAMP_PERIOD = 2161
    CONFIG_VOLTAGE_OPEN_LOOP_RAMP_PERIOD = 2162
    CONFIG_TORQUE_OPEN_LOOP_RAMP_PERIOD = 2163
    CONFIG_DUTY_CYCLE_CLOSED_LOOP_RAMP_PERIOD = 2164
    CONFIG_VOLTAGE_CLOSED_LOOP_RAMP_PERIOD = 2165
    CONFIG_TORQUE_CLOSED_LOOP_RAMP_PERIOD = 2166
    CONFIG_FORWARD_LIMIT_TYPE = 2167
    CONFIG_FORWARD_LIMIT_AUTOSET_POS_ENABLE = 2168
    CONFIG_FORWARD_LIMIT_AUTOSET_POS_VALUE = 2169
    CONFIG_FORWARD_LIMIT_ENABLE = 2170
    CONFIG_FORWARD_LIMIT_SOURCE = 2171
    CONFIG_FORWARD_LIMIT_REMOTE_SENSOR_ID = 2172
    CONFIG_REVERSE_LIMIT_TYPE = 2173
    CONFIG_REVERSE_LIMIT_AUTOSET_POS_ENABLE = 2174
    CONFIG_REVERSE_LIMIT_AUTOSET_POS_VALUE = 2175
    CONFIG_REVERSE_LIMIT_ENABLE = 2176
    CONFIG_REVERSE_LIMIT_SOURCE = 2177
    CONFIG_REVERSE_LIMIT_REMOTE_SENSOR_ID = 2178
    CONFIG_FORWARD_SOFT_LIMIT_ENABLE = 2179
    CONFIG_REVERSE_SOFT_LIMIT_ENABLE = 2180
    CONFIG_FORWARD_SOFT_LIMIT_THRESHOLD = 2181
    CONFIG_REVERSE_SOFT_LIMIT_THRESHOLD = 2182
    CONFIG_MOTION_MAGIC_CRUISE_VELOCITY = 2183
    CONFIG_MOTION_MAGIC_ACCELERATION = 2184
    CONFIG_MOTION_MAGIC_JERK = 2185
    CONFIG_MOTION_MAGIC_EXPO_KV = 2186
    CONFIG_MOTION_MAGIC_EXPO_KA = 2187
    CONFIG_PEAK_DIFF_DC = 2188
    CONFIG_PEAK_DIFFV = 2189
    CONFIG_PEAK_DIFF_TORQ_CURR = 2190
    CANCODER_VELOCITY = 2191
    CANCODER_POSITION = 2192
    CANCODER_ABS_POSITION = 2193
    CANCODER_RAW_VEL = 2195
    CANCODER_RAW_POS = 2196
    CANCODER_SUPPLY_VOLTAGE = 2197
    CANCODER_MAG_HEALTH = 2198
    SPN_CLEAR_STICKY_FAULTS = 2201
    PRO_MOTOR_OUTPUT_BRIDGE_TYPE_PUBLIC = 2202
    CONFIG_CONTINUOUS_WRAP = 2224
    CONFIG_SUPPLY_CURRENT_LOWER_LIMIT = 2230
    CONFIG_SUPPLY_CURRENT_LOWER_TIME = 2231
    CONFIG_DIFFERENTIAL_SENSOR_SOURCE = 2245
    CONFIG_DIFFERENTIAL_TALON_FXSENSOR_ID = 2246
    CONFIG_DIFFERENTIAL_REMOTE_SENSOR_ID = 2247
    CONFIG_BEEP_ON_CONFIG = 2286
    CONFIG_ALLOW_MUSIC_DUR_DISABLE = 2287
    COMPLIANCY_VERSION = 2288
    VERSION_IS_PRO_LICENSED = 2289
    PRO_SUPPLY_AND_TEMP_DEVICE_TEMP2 = 2328
    SLOT0_KS_SIGN = 2351
    SLOT1_KS_SIGN = 2352
    SLOT2_KS_SIGN = 2353
    TALON_FX_MOTOR_TYPE = 2354
    TALON_FX_MOTOR_OUTPUT_STATUS = 2355
    CONFIG_CONTROL_TIMESYNC_FREQ = 2401
    CONFIG_VELOCITY_FILTER_TIME_CONSTANT = 2402
