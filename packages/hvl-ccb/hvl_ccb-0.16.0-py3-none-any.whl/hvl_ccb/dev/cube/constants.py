...
class _T13Socket:
    ...
    def __get__(self, instance, owner) -> Union[Self, bool]:
        if instance is None:
...
class _Door(_BaseGetDescriptor):
    ...
    def __get__(self, instance, owner) -> Union[Self, DoorStatus]:
        """
...
class _EarthingRod(_BaseGetDescriptor):
    ...
    def __get__(self, instance, owner) -> Union[Self, EarthingRodStatus]:
        """
