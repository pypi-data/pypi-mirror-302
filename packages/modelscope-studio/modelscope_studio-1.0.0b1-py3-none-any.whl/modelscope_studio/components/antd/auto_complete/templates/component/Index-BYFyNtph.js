var Pt = typeof global == "object" && global && global.Object === Object && global, an = typeof self == "object" && self && self.Object === Object && self, S = Pt || an || Function("return this")(), A = S.Symbol, At = Object.prototype, sn = At.hasOwnProperty, un = At.toString, q = A ? A.toStringTag : void 0;
function ln(e) {
...
var w = Array.isArray, hn = 1 / 0, qe = A ? A.prototype : void 0, Ye = qe ? qe.toString : void 0;
function wt(e) {
  if (typeof e == "string")
    return e;
  if (w(e))
...
function Q(e, t, n, r) {
  ...
  for (var o = -1, a = t.length; ++o < a; ) {
    var s = t[o], l = void 0;
    l === void 0 && (l = e[s]), i ? Oe(n, s, l) : Et(n, s, l);
  }
  return n;
}
var We = Math.max;
...
function Rt(e, t) {
  var n = w(e), r = !n && Ce(e), i = !n && !r && ie(e), o = !n && !r && !i && Ft(e), a = n || r || i || o, s = a ? Qn(e.length, String) : [], l = s.length;
  for (var u in e)
...
var ye = U(S, "DataView"), ve = U(S, "Promise"), Te = U(S, "Set"), it = "[object Map]", Wo = "[object Object]", at = "[object Promise]", st = "[object Set]", ut = "[object WeakMap]", lt = "[object DataView]", Jo = D(ye), Qo = D(W), Vo = D(ve), ko = D(Te), ei = D(be), O = N;
(ye && O(new ye(new ArrayBuffer(1))) != lt || W && O(new W()) != it || ve && O(ve.resolve()) != at || Te && O(new Te()) != st || be && O(new be()) != ut) && (O = function(e) {
...
var ba = 1, ma = 2, ya = "[object Boolean]", va = "[object Date]", Ta = "[object Error]", Pa = "[object Map]", Aa = "[object Number]", Oa = "[object RegExp]", wa = "[object Set]", $a = "[object String]", Sa = "[object Symbol]", Ca = "[object ArrayBuffer]", Ea = "[object DataView]", dt = A ? A.prototype : void 0, _e = dt ? dt.valueOf : void 0;
...
function Na(e, t, n, r, i, o) {
  var a = w(e), s = w(t), l = a ? ht : O(e), u = s ? ht : O(t);
...
function Ha(e, t, n) {
  ...
  return o || ++r != i ? o : (i = e == null ? 0 : e.length, !!i && $e(i) && Ct(a, i) && (w(e) || Ce(e)));
}
function qa(e, t) {
...
function Va(e) {
  return typeof e == "function" ? e : e == null ? $t : typeof e == "object" ? w(e) ? Za(e[0], e[1]) : Ba(e) : Qa(e);
}
function ka(e) {
...
var ss = 1, us = 2, ls = 4, Wt = wo(function(e, t) {
  var n = {};
  if (e == null)
    return n;
  var r = !1;
...
function ks(e, t, n) {
  ...
  const d = cs(() => import("./auto-complete-BCFPgVLL.js"));
  let {
    gradio: _
  } = t, {
    props: y = {}
