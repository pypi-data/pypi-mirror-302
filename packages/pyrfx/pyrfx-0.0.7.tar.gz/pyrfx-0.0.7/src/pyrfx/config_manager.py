...
DEFAULT_CHAINS: Final[dict[str, dict[str, str | int]]] = {
    "zkSync": {
        ...
        "oracle_url": "https://qva2ytv0zj.execute-api.us-east-1.amazonaws.com/signed_prices/latest",
        "tokens_url": "https://qva2ytv0zj.execute-api.us-east-1.amazonaws.com/tokens",
