...
import { T as Tabs } from "./Tabs.4eEk3gxg.js";
import { a } from "./Tabs.4eEk3gxg.js";
  ...
  return {
    ...
    p(ctx2, [dirty]) {
      ...
      8)
        ...
        ctx2[3];
      if (dirty & /*inital_tabs*/
      16)
        tabs_changes.inital_tabs = /*inital_tabs*/
        ctx2[4];
      if (dirty & /*$$scope*/
      1024) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$set = ($$props2) => {
    ...
    if ("inital_tabs" in $$props2)
      $$invalidate(4, inital_tabs = $$props2.inital_tabs);
    if ("gradio" in $$props2)
