...
class CorePigeon2(ParentDevice):
    ...
    def get_yaw(self, refresh: bool = True) -> StatusSignal[degree]:
        ...
        """
        return self._common_lookup(SpnValue.PIGEON2_YAW.value, 0, None, "yaw", degree, True, refresh)
    ...
    def get_pitch(self, refresh: bool = True) -> StatusSignal[degree]:
        ...
        :rtype: StatusSignal[degree]
        """
        return self._common_lookup(SpnValue.PIGEON2_PITCH.value, 0, None, "pitch", degree, True, refresh)
    ...
    def get_roll(self, refresh: bool = True) -> StatusSignal[degree]:
        ...
        :rtype: StatusSignal[degree]
        """
        return self._common_lookup(SpnValue.PIGEON2_ROLL.value, 0, None, "roll", degree, True, refresh)
    ...
    def get_quat_w(self, refresh: bool = True) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(SpnValue.PIGEON2_QUATW.value, 0, None, "quat_w", float, True, refresh)
    ...
    def get_quat_x(self, refresh: bool = True) -> StatusSignal[float]:
        ...
        :rtype: StatusSignal[float]
        """
        return self._common_lookup(SpnValue.PIGEON2_QUATX.value, 0, None, "quat_x", float, True, refresh)
    ...
    def get_quat_y(self, refresh: bool = True) -> StatusSignal[float]:
        ...
        :rtype: StatusSignal[float]
        """
        return self._common_lookup(SpnValue.PIGEON2_QUATY.value, 0, None, "quat_y", float, True, refresh)
    ...
    def get_quat_z(self, refresh: bool = True) -> StatusSignal[float]:
        ...
        :rtype: StatusSignal[float]
        """
        return self._common_lookup(SpnValue.PIGEON2_QUATZ.value, 0, None, "quat_z", float, True, refresh)
    ...
    def get_gravity_vector_x(self, refresh: bool = True) -> StatusSignal[float]:
        ...
        :rtype: StatusSignal[float]
        """
        return self._common_lookup(SpnValue.PIGEON2_GRAVITY_VECTORX.value, 0, None, "gravity_vector_x", float, True, refresh)
    ...
    def get_gravity_vector_y(self, refresh: bool = True) -> StatusSignal[float]:
        ...
        :rtype: StatusSignal[float]
        """
        return self._common_lookup(SpnValue.PIGEON2_GRAVITY_VECTORY.value, 0, None, "gravity_vector_y", float, True, refresh)
    ...
    def get_gravity_vector_z(self, refresh: bool = True) -> StatusSignal[float]:
        ...
        :rtype: StatusSignal[float]
        """
        return self._common_lookup(SpnValue.PIGEON2_GRAVITY_VECTORZ.value, 0, None, "gravity_vector_z", float, True, refresh)
    ...
    def get_temperature(self, refresh: bool = True) -> StatusSignal[celsius]:
        ...
        """
        return self._common_lookup(SpnValue.PIGEON2_TEMPERATURE.value, 0, None, "temperature", celsius, True, refresh)
    ...
    def get_no_motion_enabled(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(SpnValue.PIGEON2_NO_MOTION_CAL_ENABLED.value, 0, None, "no_motion_enabled", bool, True, refresh)
    ...
    def get_no_motion_count(self, refresh: bool = True) -> StatusSignal[float]:
        ...
        :rtype: StatusSignal[float]
        """
        return self._common_lookup(SpnValue.PIGEON2_NO_MOTION_COUNT.value, 0, None, "no_motion_count", float, True, refresh)
    ...
    def get_temperature_compensation_disabled(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.PIGEON2_TEMP_COMP_DISABLED.value, 0, None, "temperature_compensation_disabled", bool, True, refresh)
    ...
    def get_up_time(self, refresh: bool = True) -> StatusSignal[second]:
        ...
        """
        return self._common_lookup(SpnValue.PIGEON2_UP_TIME.value, 0, None, "up_time", second, True, refresh)
    ...
    def get_accum_gyro_x(self, refresh: bool = True) -> StatusSignal[degree]:
        ...
        :rtype: StatusSignal[degree]
        """
        return self._common_lookup(SpnValue.PIGEON2_ACCUM_GYROX.value, 0, None, "accum_gyro_x", degree, True, refresh)
    ...
    def get_accum_gyro_y(self, refresh: bool = True) -> StatusSignal[degree]:
        ...
        :rtype: StatusSignal[degree]
        """
        return self._common_lookup(SpnValue.PIGEON2_ACCUM_GYROY.value, 0, None, "accum_gyro_y", degree, True, refresh)
    ...
    def get_accum_gyro_z(self, refresh: bool = True) -> StatusSignal[degree]:
        ...
        :rtype: StatusSignal[degree]
        """
        return self._common_lookup(SpnValue.PIGEON2_ACCUM_GYROZ.value, 0, None, "accum_gyro_z", degree, True, refresh)
    ...
    def get_angular_velocity_x_world(self, refresh: bool = True) -> StatusSignal[degrees_per_second]:
        ...
        """
        return self._common_lookup(SpnValue.PIGEON2_ANGULAR_VELOCITY_XWORLD.value, 0, None, "angular_velocity_x_world", degrees_per_second, True, refresh)
    ...
    def get_angular_velocity_y_world(self, refresh: bool = True) -> StatusSignal[degrees_per_second]:
        ...
        :rtype: StatusSignal[degrees_per_second]
        """
        return self._common_lookup(SpnValue.PIGEON2_ANGULAR_VELOCITY_YWORLD.value, 0, None, "angular_velocity_y_world", degrees_per_second, True, refresh)
    ...
    def get_angular_velocity_z_world(self, refresh: bool = True) -> StatusSignal[degrees_per_second]:
        ...
        :rtype: StatusSignal[degrees_per_second]
        """
        return self._common_lookup(SpnValue.PIGEON2_ANGULAR_VELOCITY_ZWORLD.value, 0, None, "angular_velocity_z_world", degrees_per_second, True, refresh)
    ...
    def get_acceleration_x(self, refresh: bool = True) -> StatusSignal[g]:
        ...
        """
        return self._common_lookup(SpnValue.PIGEON2_ACCELERATIONX.value, 0, None, "acceleration_x", g, True, refresh)
    ...
    def get_acceleration_y(self, refresh: bool = True) -> StatusSignal[g]:
        ...
        :rtype: StatusSignal[g]
        """
        return self._common_lookup(SpnValue.PIGEON2_ACCELERATIONY.value, 0, None, "acceleration_y", g, True, refresh)
    ...
    def get_acceleration_z(self, refresh: bool = True) -> StatusSignal[g]:
        ...
        :rtype: StatusSignal[g]
        """
        return self._common_lookup(SpnValue.PIGEON2_ACCELERATIONZ.value, 0, None, "acceleration_z", g, True, refresh)
    ...
    def get_supply_voltage(self, refresh: bool = True) -> StatusSignal[volt]:
        ...
        """
        return self._common_lookup(SpnValue.PIGEON2_SUPPLY_VOLTAGE.value, 0, None, "supply_voltage", volt, True, refresh)
    ...
    def get_angular_velocity_x_device(self, refresh: bool = True) -> StatusSignal[degrees_per_second]:
        ...
        :rtype: StatusSignal[degrees_per_second]
        """
        return self._common_lookup(SpnValue.PIGEON2_ANGULAR_VELOCITYX.value, 0, None, "angular_velocity_x_device", degrees_per_second, True, refresh)
    ...
    def get_angular_velocity_y_device(self, refresh: bool = True) -> StatusSignal[degrees_per_second]:
        ...
        :rtype: StatusSignal[degrees_per_second]
        """
        return self._common_lookup(SpnValue.PIGEON2_ANGULAR_VELOCITYY.value, 0, None, "angular_velocity_y_device", degrees_per_second, True, refresh)
    ...
    def get_angular_velocity_z_device(self, refresh: bool = True) -> StatusSignal[degrees_per_second]:
        ...
        :rtype: StatusSignal[degrees_per_second]
        """
        return self._common_lookup(SpnValue.PIGEON2_ANGULAR_VELOCITYZ.value, 0, None, "angular_velocity_z_device", degrees_per_second, True, refresh)
    ...
    def get_magnetic_field_x(self, refresh: bool = True) -> StatusSignal[microtesla]:
        ...
        """
        return self._common_lookup(SpnValue.PIGEON2_MAGNETIC_FIELDX.value, 0, None, "magnetic_field_x", microtesla, True, refresh)
    ...
    def get_magnetic_field_y(self, refresh: bool = True) -> StatusSignal[microtesla]:
        ...
        :rtype: StatusSignal[microtesla]
        """
        return self._common_lookup(SpnValue.PIGEON2_MAGNETIC_FIELDY.value, 0, None, "magnetic_field_y", microtesla, True, refresh)
    ...
    def get_magnetic_field_z(self, refresh: bool = True) -> StatusSignal[microtesla]:
        ...
        :rtype: StatusSignal[microtesla]
        """
        return self._common_lookup(SpnValue.PIGEON2_MAGNETIC_FIELDZ.value, 0, None, "magnetic_field_z", microtesla, True, refresh)
    ...
    def get_raw_magnetic_field_x(self, refresh: bool = True) -> StatusSignal[microtesla]:
        ...
        :rtype: StatusSignal[microtesla]
        """
        return self._common_lookup(SpnValue.PIGEON2_RAW_MAGNETIC_FIELDX.value, 0, None, "raw_magnetic_field_x", microtesla, True, refresh)
    ...
    def get_raw_magnetic_field_y(self, refresh: bool = True) -> StatusSignal[microtesla]:
        ...
        :rtype: StatusSignal[microtesla]
        """
        return self._common_lookup(SpnValue.PIGEON2_RAW_MAGNETIC_FIELDY.value, 0, None, "raw_magnetic_field_y", microtesla, True, refresh)
    ...
    def get_raw_magnetic_field_z(self, refresh: bool = True) -> StatusSignal[microtesla]:
        ...
        :rtype: StatusSignal[microtesla]
        """
        return self._common_lookup(SpnValue.PIGEON2_RAW_MAGNETIC_FIELDZ.value, 0, None, "raw_magnetic_field_z", microtesla, True, refresh)
    ...
    def get_fault_bootup_accelerometer(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_PIGEON2_BOOTUP_ACCEL.value, 0, None, "fault_bootup_accelerometer", bool, True, refresh)
    ...
    def get_sticky_fault_bootup_accelerometer(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_PIGEON2_BOOTUP_ACCEL.value, 0, None, "sticky_fault_bootup_accelerometer", bool, True, refresh)
    ...
    def get_fault_bootup_gyroscope(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_PIGEON2_BOOTUP_GYROS.value, 0, None, "fault_bootup_gyroscope", bool, True, refresh)
    ...
    def get_sticky_fault_bootup_gyroscope(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_PIGEON2_BOOTUP_GYROS.value, 0, None, "sticky_fault_bootup_gyroscope", bool, True, refresh)
    ...
    def get_fault_bootup_magnetometer(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_PIGEON2_BOOTUP_MAGNE.value, 0, None, "fault_bootup_magnetometer", bool, True, refresh)
    ...
    def get_sticky_fault_bootup_magnetometer(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_PIGEON2_BOOTUP_MAGNE.value, 0, None, "sticky_fault_bootup_magnetometer", bool, True, refresh)
    ...
    def get_fault_boot_into_motion(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_PIGEON2_BOOT_INTO_MOTION.value, 0, None, "fault_boot_into_motion", bool, True, refresh)
    ...
    def get_sticky_fault_boot_into_motion(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_PIGEON2_BOOT_INTO_MOTION.value, 0, None, "sticky_fault_boot_into_motion", bool, True, refresh)
    ...
    def get_fault_data_acquired_late(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_PIGEON2_DATA_ACQUIRED_LATE.value, 0, None, "fault_data_acquired_late", bool, True, refresh)
    ...
    def get_sticky_fault_data_acquired_late(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_PIGEON2_DATA_ACQUIRED_LATE.value, 0, None, "sticky_fault_data_acquired_late", bool, True, refresh)
    ...
    def get_fault_loop_time_slow(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_PIGEON2_LOOP_TIME_SLOW.value, 0, None, "fault_loop_time_slow", bool, True, refresh)
    ...
    def get_sticky_fault_loop_time_slow(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_PIGEON2_LOOP_TIME_SLOW.value, 0, None, "sticky_fault_loop_time_slow", bool, True, refresh)
    ...
    def get_fault_saturated_magnetometer(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_PIGEON2_SATURATED_MAGNE.value, 0, None, "fault_saturated_magnetometer", bool, True, refresh)
    ...
    def get_sticky_fault_saturated_magnetometer(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_PIGEON2_SATURATED_MAGNE.value, 0, None, "sticky_fault_saturated_magnetometer", bool, True, refresh)
    ...
    def get_fault_saturated_accelerometer(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_PIGEON2_SATURATED_ACCEL.value, 0, None, "fault_saturated_accelerometer", bool, True, refresh)
    ...
    def get_sticky_fault_saturated_accelerometer(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_PIGEON2_SATURATED_ACCEL.value, 0, None, "sticky_fault_saturated_accelerometer", bool, True, refresh)
    ...
    def get_fault_saturated_gyroscope(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_PIGEON2_SATURATED_GYROS.value, 0, None, "fault_saturated_gyroscope", bool, True, refresh)
    ...
    def get_sticky_fault_saturated_gyroscope(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_PIGEON2_SATURATED_GYROS.value, 0, None, "sticky_fault_saturated_gyroscope", bool, True, refresh)
