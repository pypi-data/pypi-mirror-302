...
function k_(l, e, t) {
  return l == null ? t ? `/proxy=${t}file=` : `${e}/file=` : w_(l) ? l : t ? `/proxy=${t}file=${l}` : `${e}/file=${l}`;
}
...
function Er(l) {
  ...
  return n = new St({
    ...
    h() {
      O_(t, "margin-right", "1px"), et(e, "class", "like-button svelte-u350v8");
    },
    m(a, r) {
...
function P_(l) {
  ...
  return {
    ...
    p(p, [y]) {
      ...
      2 && En(m, 1)) : (m = Er(p), m.c(), En(m, 1), m.m(e, null)) : m && (R_(), _l(m, 1, 1, () => {
        m = null;
      }), I_());
    },
    i(p) {
...
class W_ {
  constructor(e, t = {
    ...
    Ce(this, "_layout");
    this._layout = V_(e, t), this._layout.mount();
  }
  unmount() {
...
const {
  ...
  get_spread_object: K_,
  get_spread_update: J_,
  globals: Q_,
  group_outros: Rt,
  init: x_,
  insert_hydration: Xe,
  ...
  return a = v(l), r = b[a] = E[a](l), {
    ...
    m(g, S) {
      ...
      for (let w = 0; w < y.length; w += 1)
        y[w] && y[w].m(o, null);
      l[49](o), le(t, s), le(t, f), b[a].m(f, null), c = Y_(
        t,
        /*div2_elementresize_handler*/
        l[51].bind(t)
      ), u = !0;
...
function Lr(l) {
  ...
  return {
    ...
    d(w) {
      w && Y(e), E && E.d(), bt(i), b && b.d(), Ca(g, w), l[43](null), y = !1, ed(C);
    }
  };
}
function Ir(l) {
...
function dd(l, e, t) {
  ...
  async function $t(k) {
    var an;
    if (typeof k != "number" || (await id(), h[k] === void 0)) return;
  ...
  function In() {
    re == null || re.unmount(), re = new W_(P, {
      cols: de,
      gap: q
    });
  }
...
function Dd(l) {
  ...
  return (
    ...
    l[0]), t = new md({
      props: f
    }), wd.push(() => pd(t, "selected_index", s)), t.$on(
      "click",
      /*click_handler*/
      l[30]
    ), t.$on(
      ...
      c() {
        o && o.c(), e = Id(), Oi(t.$$.fragment);
      },
      l(r) {
        o && o.l(r), e = vd(r), Ni(t.$$.fragment, r);
      },
      m(r, c) {
        o && o.m(r, c), Cd(r, e, c), Pi(t, r, c), i = !0;
      },
      p(r, c) {
        var _;
        /*loading_status*/
        r[1] ? o ? (o.p(r, c), c[0] & /*loading_status*/
        2 && Kt(o, 1)) : (o = Mr(r), o.c(), Kt(o, 1), o.m(e.parentNode, e)) : o && (Ad(), yn(o, 1, 1, () => {
          o = null;
        }), kd());
        const u = {};
        c[0] & /*loading_status*/
