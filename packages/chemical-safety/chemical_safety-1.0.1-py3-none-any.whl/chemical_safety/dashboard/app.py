    ...
    def generate_label():    
        ...
        if 'print' in request.form:
            try:
                ...
                create_label_pdf(container_name, signal_word, [f'static/img/{p}.png' for p in list(all_selected_pictograms)], hazard_statements, generator_name, pdf_path)
                ...
                print('Did not successfully print')
                return render_template('lookup_fail.html',msg="Did not successfully print.")
