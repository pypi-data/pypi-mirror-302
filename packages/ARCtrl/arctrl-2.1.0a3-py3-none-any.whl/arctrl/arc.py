...
class ARC:
    ...
    def RemoveAssay(self, assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3109(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3108:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3107(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(assay_identifier, i.AssayIdentifiers, ObjectExpr3108())
        ...
        def _arrow3112(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3111(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3110(__unit: None=None) -> IEnumerable_1[Contract]:
                    return map_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract, studies)

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(isa)), delay(_arrow3110))

            return append(singleton(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow3111))

        return list(to_list(delay(_arrow3112)))
    ...
    def RenameAssay(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3115(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3114:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3113(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_assay_identifier, i.AssayIdentifiers, ObjectExpr3114())
        ...
        def _arrow3117(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3116(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow3116))

        return list(to_list(delay(_arrow3117)))
    ...
    def RenameStudy(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3120(__unit: None=None) -> bool:
                ...
                return contains(old_study_identifier, i.StudyIdentifiers, ObjectExpr3119())
        ...
        def _arrow3122(__unit: None=None) -> IEnumerable_1[Contract]:
            ...
            return append(singleton(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow3121))

        return list(to_list(delay(_arrow3122)))
    ...
    def GetUpdateContracts(self, __unit: None=None) -> Array[Contract]:
        this: ARC = self
        match_value: ArcInvestigation | None = this.ISA
        def _arrow3123(__unit: None=None) -> bool:
            inv: ArcInvestigation = match_value
            return inv.StaticHash == 0

        def _arrow3124(__unit: None=None) -> Array[Contract]:
            inv_1: ArcInvestigation = match_value
            return this.GetWriteContracts()

        def _arrow3138(__unit: None=None) -> Array[Contract]:
            ...
            def _arrow3137(__unit: None=None) -> IEnumerable_1[Contract]:
                ...
                def _arrow3136(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    def _arrow3129(s: ArcStudy) -> IEnumerable_1[Contract]:
                        ...
                        def _arrow3128(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value_1 is not None:
                                if DataMap__get_StaticHash(match_value_1) == 0:
                                    ...
                                    def _arrow3127(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                def _arrow3125(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_2, safe_hash(dm_2))
                                    return empty()

                                return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow3125))
                                ...
                                return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow3126))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow3128))

                    def _arrow3135(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow3134(a: ArcAssay) -> IEnumerable_1[Contract]:
                            ...
                            def _arrow3133(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_2 is not None:
                                    if DataMap__get_StaticHash(match_value_2) == 0:
                                        ...
                                        def _arrow3132(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    def _arrow3130(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_6, safe_hash(dm_6))
                                        return empty()

                                    return append(singleton(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow3130))
                                    ...
                                    return append(singleton(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow3131))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow3133))

                        return collect(_arrow3134, inv_2.Assays)

                    return append(collect(_arrow3129, inv_2.Studies), delay(_arrow3135))

                return append(singleton(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(inv_2)) if (inv_2.StaticHash != hash_1) else empty(), delay(_arrow3136))

            return to_array(delay(_arrow3137))

        return (_arrow3124() if _arrow3123() else _arrow3138()) if (match_value is not None) else this.GetWriteContracts()
        ...
        def _arrow3142(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3141(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3140(__unit: None=None) -> IEnumerable_1[Contract]:
                    def _arrow3139(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow3139))

                return append(singleton(gitattributes_contract), delay(_arrow3140))

            return append(singleton(Init_createInitContract_6DFDD678(branch)), delay(_arrow3141))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_3(s_1: ArcStudy) -> Any:
            ...
            def _arrow3150(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow3149(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3148(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3147(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3146(kv: Any) -> IEnumerable_1[str]:
                                text_value: str = kv[1].ToFreeTextCell().AsFreeText
                                def _arrow3145(__unit: None=None) -> IEnumerable_1[str]:
                                    def _arrow3144(__unit: None=None) -> IEnumerable_1[str]:
                                        return singleton(((((("" + study_foldername) + "/") + "protocols") + "/") + text_value) + "")

                                    return append(singleton(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow3144))

                                return append(singleton(text_value), delay(_arrow3145))

                            return collect(_arrow3146, table.Values)

                        return collect(_arrow3147, s_1.Tables)

                    return append(singleton(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow3148))

                return append(singleton(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow3149))
            ...
            return of_seq(to_list(delay(_arrow3150)), ObjectExpr3151())
        ...
        def mapping_4(a: ArcAssay) -> Any:
            ...
            def _arrow3159(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow3158(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3157(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3156(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3155(kv_1: Any) -> IEnumerable_1[str]:
                                ...
                                def _arrow3154(__unit: None=None) -> IEnumerable_1[str]:
                                    ...
                                    return append(singleton(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow3153))

                                return append(singleton(text_value_1), delay(_arrow3154))

                            return collect(_arrow3155, table_1.Values)

                        return collect(_arrow3156, a.Tables)

                    return append(singleton(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow3157))

                return append(singleton(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow3158))
            ...
            return of_seq(to_list(delay(_arrow3159)), ObjectExpr3160())
        ...
        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr3143()), union_many(map(mapping_3, registered_studies, None), ObjectExpr3152()), union_many(map(mapping_4, registered_assays, None), ObjectExpr3161())]), ObjectExpr3162())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3163(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow3163)(tree_1)

            else: 
                return tree_1


        def _arrow3165(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow3164(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow3164)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3165()), FileSystemTree.from_file_paths([]))
    ...
    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr3166())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3167(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not (n_1.find(".") == 0)

                return FileSystemTree.filter_folders(_arrow3167)(tree_1)

            else: 
                return tree_1


        def _arrow3169(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow3168(n: str) -> bool:
                return not (n.find(".") == 0)

            return FileSystemTree.filter_files(_arrow3168)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3169()), FileSystemTree.from_file_paths([]))
    ...
    def DefaultContracts() -> Any:
        ...
        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr3170())

    @staticmethod
    def from_rocrate_json_string(s: str) -> ARC:
        def _arrow3171(__unit: None=None) -> ArcInvestigation | None:
    ...
    def GetValidationPackagesConfigWriteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3174:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3173(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3174()):
    ...
    def GetValidationPackagesConfigDeleteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3176:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3175(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains_1(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3176()):
            def predicate(p: str) -> bool:
