...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_e3a8f4695386_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_e3a8f4695386_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_e3a8f4695386_error")
        self._setDefault(outputCol="SpeakerEmotionInference_e3a8f4695386_output")
