...
"""
MetaMart source for the profiler
"""
import traceback
...
class ProfilerSourceAndEntity(BaseModel):
    """Return class for the MetaMart Profiler Source"""
...
class MetaMartSource(Source):
    ...
    def _validate_service_name(self):
        """Validate service name exists in MetaMart"""
    ...
    def get_table_entities(self, database):
        """
        List and filter MetaMart tables based on the
