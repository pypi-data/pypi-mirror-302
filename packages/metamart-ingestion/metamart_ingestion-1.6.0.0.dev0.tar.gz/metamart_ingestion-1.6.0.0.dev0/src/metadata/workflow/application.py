...
class AppRunner(Step, ABC):
    ...
    def __init__(
        self,
        config: MetaMartApplicationConfig,
        metadata: MetaMart,
    ):
    ...
    def create(
        ...
        config = MetaMartApplicationConfig.model_validate(config_dict)
...
class ApplicationWorkflow(BaseWorkflow, ABC):
    ...
    def __init__(self, config_dict: dict):
        ...
        self.config = MetaMartApplicationConfig.model_validate(config_dict)

        # Applications are associated to the MetaMart Service
