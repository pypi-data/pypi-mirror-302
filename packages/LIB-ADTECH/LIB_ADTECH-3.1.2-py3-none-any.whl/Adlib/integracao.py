...
from Adlib.api import putRequestFunction
...
def importarArquivos(virtaus, idBanco: int, codigoBanco: int, nomeBanco: str, substring: str, formatoArquivo: str, usuarioWindows: str):
    ...
    try:
        putRequestFunction('importando', idBanco)
        ...
        if qntArquivos == 0:
            putRequestFunction('sem arquivos para integrar', idBanco)
        ...
        for i, arquivo in enumerate(arquivosFiltrados, start=1):
            ...
            try:
                ...
                putRequestFunction('ligado', idBanco)
        ...
        print(erro)
        print('Não deu certo')
        putRequestFunction('erro', idBanco)
