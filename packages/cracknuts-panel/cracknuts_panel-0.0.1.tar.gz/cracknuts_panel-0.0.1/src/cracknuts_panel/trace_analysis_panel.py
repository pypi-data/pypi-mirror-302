...
import numpy as np
from cracknuts.solver.trace import TraceDataset, NumpyTraceDataset
from traitlets import traitlets

from cracknuts_panel.panel import MsgHandlerPanelWidget


class TraceAnalysisPanelWidget(MsgHandlerPanelWidget):
    ...
    def _show_trace(self, channel_slice, trace_slice):
        channel_indexes, trace_indexes, traces, datas = self._trace_dataset.data[channel_slice, trace_slice]
    ...
    def show_default_trace(self):
        ...
        self._show_trace(0, slice(0, trace_count if trace_count < self._DEFAULT_SHOW_INDEX_THRESHOLD else self._DEFAULT_SHOW_INDEX_THRESHOLD))
