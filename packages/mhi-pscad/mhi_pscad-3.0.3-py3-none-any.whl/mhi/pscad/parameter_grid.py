...
class ParameterGrid:
    ...
    def _param_grid(self, **kwargs):
        self._pscad._param_grid(**kwargs)     # pylint: disable=protected-access
    ...
    def save(self, filename: str, folder: Optional[str] = None) -> None:
        ...
        return self._pscad._param_grid_save(filename)   # pylint: disable=protected-access
    ...
    def load(self, filename: str, folder: Optional[str] = None) -> None:
        ...
        return self._pscad._param_grid_load(filename)   # pylint: disable=protected-access
