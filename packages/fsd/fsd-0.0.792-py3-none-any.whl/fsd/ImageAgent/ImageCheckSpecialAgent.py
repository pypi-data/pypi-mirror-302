...
class ImageCheckSpecialAgent:
    ...
    async def get_image_check_plan(self, user_prompt, original_prompt_language):
        ...
        messages = [
            ...
            {
                "role": "user",
                "content": f"Find ONLY NEW PNG, png, JPG, jpg, JPEG, jpeg, or .ico images. DO NOT INCLUDE ANY OTHER types of images such as svg. Identify images that need to be generated in this development plan: {user_prompt}"
            }
        ]
