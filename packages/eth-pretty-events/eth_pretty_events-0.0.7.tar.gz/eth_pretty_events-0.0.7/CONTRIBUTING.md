...
Welcome to `eth-pretty-events` contributor's guide.
...
If you experience bugs or general issues with `eth-pretty-events`, please have a look
...
You can help improve `eth-pretty-events` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`eth-pretty-events` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `eth-pretty-events`'s files. While this mechanism can
...
```
conda create -n eth-pretty-events python=3 six virtualenv pytest pytest-cov
conda activate eth-pretty-events
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/eth-pretty-events.git
   cd eth-pretty-events
   ```
...
5. Install [pre-commit]:
   ...
   `eth-pretty-events` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/eth-pretty-events
[issue tracker]: https://github.com/<USERNAME>/eth-pretty-events/issues
