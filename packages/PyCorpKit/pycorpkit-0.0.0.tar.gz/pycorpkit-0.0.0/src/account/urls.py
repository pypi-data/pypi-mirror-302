...
from src.account.views.invitation import InvitationAcceptViewSet, InvitationViewSet
from src.account.views.login import LoginViewSet
from src.account.views.register import (
    ActivateUserViewSet,
    RegisterUserViewSet,
    ResendActivationEmailViewSet,
)
from src.account.views.role import (
    PermissionsViewSet,
