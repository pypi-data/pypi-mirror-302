...
class KeywordsAIParams(KeywordsAIBaseModel):
    ...
    def __init__(self, **data):
        ...
        self._assign_related_field("organization", "organization_id", data)
        self._assign_related_field("organization_key", "organization_key_id", data)
        self._assign_related_field("trace", "trace_id", data)
        self._assign_related_field("user", "user_id", data)
        super().__init__(**data)
