...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_be9e8e443975_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_be9e8e443975_output",
        ...
        self._setDefault(errorCol="OCR_be9e8e443975_error")
        self._setDefault(outputCol="OCR_be9e8e443975_output")
