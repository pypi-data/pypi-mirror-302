...
class ScheduledQueryManager(object):
    ...
    UPDATE_MASK = {'paths': ['destination_dataset_id', 'display_name', 'schedule', 'params']}
    ...
    def delete_scheduled_query(self, old_ref, new_ref, file_path):
        ...
        config_name = self.__get_config_name(self.git_manager.repo.diff(old_ref, new_ref, '--', file_path))
