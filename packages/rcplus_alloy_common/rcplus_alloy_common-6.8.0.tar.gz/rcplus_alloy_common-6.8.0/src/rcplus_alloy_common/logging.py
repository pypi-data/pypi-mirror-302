...
class CustomJsonFormatter(jsonlogger.JsonFormatter):
    ...
    def _get_lambda_alloy_tag(self, software_component: str, name: str):
...
if LOG_SET_EXCEPTHOOK.lower() in set(["true", "1"]):
    logger.debug("Setting excepthook")
    sys.excepthook = excepthook
elif LOG_SET_EXCEPTHOOK.lower() not in set(["false", "0"]):
