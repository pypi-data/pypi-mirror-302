...
class LinearSolver(ngsolve.la.BaseMatrix):
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('atol', 'callback_sol', 'tol', 'display', 'pre', 'ress', 'fig', 'residuals', 'maxiter', '_final_residual', 'printrates', 'callback', 'mat', 'iterations', 'sol', 'clear_output', 'ax', 'plt', 'its', 'plotrates')
