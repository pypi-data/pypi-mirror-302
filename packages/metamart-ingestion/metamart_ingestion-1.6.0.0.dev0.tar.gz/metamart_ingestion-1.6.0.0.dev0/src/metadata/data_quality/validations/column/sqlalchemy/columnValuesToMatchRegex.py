    ...
    def _run_results(
        ...
        if not res:
            ...
            raise ValueError(
                ...
                "\t1. check the documentation: https://docs.meta-mart.org/v1.3.x/connectors/ingestion/workflows/data-quality/tests\n"
                "\t2. reach out to the Digitrans team for support"
            )
