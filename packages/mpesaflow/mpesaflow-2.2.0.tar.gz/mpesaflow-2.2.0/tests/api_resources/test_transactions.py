...
class TestTransactions:
    ...
    def test_method_list(self, client: Mpesaflow) -> None:
        ...
        assert_matches_type(SyncMyCursorIDPage[Transaction], transaction, path=["response"])
...
class TestAsyncTransactions:
    ...
    async def test_method_list(self, async_client: AsyncMpesaflow) -> None:
        ...
        assert_matches_type(AsyncMyCursorIDPage[Transaction], transaction, path=["response"])
