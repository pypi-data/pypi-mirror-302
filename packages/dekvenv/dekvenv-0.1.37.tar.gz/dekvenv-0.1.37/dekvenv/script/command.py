...
def add(
        ...
        all_extras: Annotated[bool, typer.Option("--all/--no-all")] = True):
    ...
    if pkg:
        cmd = f'pdm add "{name}" {extras_str} {args} -v -p {path_scripts_item}'
        ...
        cmd = f'pdm add file:///{file} {extras_str} {args} -v -p {path_scripts_item}'
