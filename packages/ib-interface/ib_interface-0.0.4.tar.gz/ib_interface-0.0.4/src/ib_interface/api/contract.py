...
class Contract:
    ...
    def __eq__(self, other):
        return isinstance(other, Contract) and (
            self.conId and self.conId == other.conId or util.dataclassAsDict(self) == util.dataclassAsDict(other)
        )
...
class Stock(Contract):
    def __init__(self, symbol: str = "", exchange: str = "", currency: str = "", **kwargs):
        ...
        """
        Contract.__init__(self, secType="STK", symbol=symbol, exchange=exchange, currency=currency, **kwargs)
...
class Index(Contract):
    def __init__(self, symbol: str = "", exchange: str = "", currency: str = "", **kwargs):
        ...
        Args:
            ...
            currency: Underlying currency.
        """
        Contract.__init__(self, "IND", symbol=symbol, exchange=exchange, currency=currency, **kwargs)
...
class CFD(Contract):
    def __init__(self, symbol: str = "", exchange: str = "", currency: str = "", **kwargs):
        ...
        Args:
            ...
            currency: Underlying currency.
        """
        Contract.__init__(self, "CFD", symbol=symbol, exchange=exchange, currency=currency, **kwargs)
...
class Commodity(Contract):
    def __init__(self, symbol: str = "", exchange: str = "", currency: str = "", **kwargs):
        ...
        Args:
            ...
            currency: Underlying currency.
        """
        Contract.__init__(self, "CMDTY", symbol=symbol, exchange=exchange, currency=currency, **kwargs)
...
class Crypto(Contract):
    def __init__(self, symbol: str = "", exchange: str = "", currency: str = "", **kwargs):
        ...
        Args:
            ...
            currency: Underlying currency.
        """
        Contract.__init__(self, secType="CRYPTO", symbol=symbol, exchange=exchange, currency=currency, **kwargs)
    ...
    def _parseSessions(self, s: str) -> List[TradingSession]:
        ...
        for sess in s.split(";"):
            if not sess or "CLOSED" in sess:
                continue
            sessions.append(
                TradingSession(*[dt.datetime.strptime(t, "%Y%m%d:%H%M").replace(tzinfo=tz) for t in sess.split("-")])
            )
        return sessions
