...
class IdeaDevelopment:
    ...
    def initial_setup(self, role, crawl_logs, context):
        ...
        system_prompt = (
            ...
            "- Clearly describe what needs to be done with the API. NO STEPS OR INSTRUCTIONS ON HOW TO USE ARE NEEDED. JUST SPECIFY EXACTLY THE PURPOSE OF USING THE API AND WHERE TO USE IT.\n"
            "- Provide any valuable information, such as Request Body or Response Example, and specify the format if applicable.\n"
            "Example:\n"
