...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            {"messages": [{"type": "error", "content": "unknown code", "id": 5880323636}]},
        ),
        (
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            {
                "messages": [{"type": "warning", "content": "posting in previous month"}],
                "value": datetime.date.fromisoformat("2023-05-20"),
            },
        ),
        (
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            {"messages": [{"type": "warning", "content": "Value is too large", "id": 5880324090}]},
        ),
        (
            {
                "line_items": [
            ...
            {
                "messages": [
                    {"type": "warning", "content": "Value is too large", "id": 5880324090},
                    {"type": "warning", "content": "Value is too large", "id": 5880324100},
                ]
            },
        ),
        (
            ...
            {"messages": [{"type": "warning", "content": "Value is too large", "id": 5880324100}]},
        ),
    ),
)
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            {"messages": [{"type": "warning", "content": "Item status does not exist", "id": 5880324089}]},
        ),
        (
            {
                "line_items": [
            ...
            {
                "messages": [
                    {"type": "error", "content": "Item number is wrong", "id": 5880324093},
                    {"type": "warning", "content": "Item status does not exist", "id": 5880324094},
                ]
            },
        ),
    ),
