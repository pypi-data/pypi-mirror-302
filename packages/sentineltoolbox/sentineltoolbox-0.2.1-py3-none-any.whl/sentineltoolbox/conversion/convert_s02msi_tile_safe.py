...
def convert_xml_metadata(safe_path: Path, *, product_level: Literal["L1C", "L2A"]) -> dict[str, Any]:
    ...
    xml_accessor = AccessorXML(roots=roots, namespaces=get_xml_namespaces(product_level=product_level))
...
def get_xml_namespaces(*, product_level: str) -> dict[str, dict[str, str]]:
    """
    Get XML namespaces
    ...
    namespaces = {
        "product_namespaces": {
            ...
            "n1": f"https://psd-14.sentinel2.eo.esa.int/PSD/User_Product_Level-{level_name}.xsd",
            "xsi": "http://www.w3.org/2001/XMLSchema-instance",
        },
        "tile_namespaces": {
            "n1": f"https://psd-14.sentinel2.eo.esa.int/PSD/S2_PDI_Level-{level_name}_Tile_Metadata.xsd",
            "xsi": "http://www.w3.org/2001/XMLSchema-instance",
        },
        "datastrip_namespaces": {
            ...
            "safe": "http://www.esa.int/safe/sentinel/1.1",
            "sentinel-safe": "http://www.esa.int/safe/sentinel/1.1",
            "n1": f"https://psd-14.sentinel2.eo.esa.int/PSD/S2_PDI_Level-{level_name}_Datastrip_Metadata.xsd",
            "xsi": "http://www.w3.org/2001/XMLSchema-instance",
        },
        "manifest_namespaces": {
            "safe": "http://www.esa.int/safe/sentinel/1.1",
