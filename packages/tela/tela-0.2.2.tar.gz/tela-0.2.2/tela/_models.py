...
from ._types import AnyMapping, Body, Headers, IncEx, ModelT, NotGiven, Query, Timeout
from ._utils import (
    PropertyInfo,
    coerce_boolean,
    extract_type_arg,
...
class BaseModel(pydantic.BaseModel):
    ...
    if TYPE_CHECKING:
        ...
        """The ID of the request, returned via the X-Request-ID header. Useful for debugging requests and reporting issues to Tela.
