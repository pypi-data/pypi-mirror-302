...
import al360_trustworthyai
from al360_taiutils.exceptions import UserConfigValidationException
from al360_trustworthyai._internal._served_model_wrapper import ServedModelWrapper
from al360_trustworthyai._internal.constants import (FileFormats, Metadata,
...
class RAIBaseInsights(ABC):
    ...
    @abstractmethod
    def _validate_al360_tai_insights_input_parameters(self, *args):
    ...
    def _save_data(self, path):
        ...
        self._write_to_file(Path(path) /
                            ...
                            json.dumps(
                                {"al360_trustworthyai": al360_trustworthyai.__version__}))
