...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_c9be27a89ed1_error",
        handler=None,
        outputCol="Detect_c9be27a89ed1_output",
        ...
        self._setDefault(errorCol="Detect_c9be27a89ed1_error")
        self._setDefault(outputCol="Detect_c9be27a89ed1_output")
