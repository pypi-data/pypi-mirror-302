...
def encoder(inv: ArcInvestigation) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2760()), try_include("Title", _arrow2762, inv.Title), try_include("Description", _arrow2768, inv.Description), try_include("SubmissionDate", _arrow2770, inv.SubmissionDate), try_include("PublicReleaseDate", _arrow2772, inv.PublicReleaseDate), try_include_seq("OntologySourceReferences", _arrow2774, inv.OntologySourceReferences), try_include_seq("Publications", _arrow2775, inv.Publications), try_include_seq("Contacts", _arrow2776, inv.Contacts), try_include_seq("Assays", _arrow2777, inv.Assays), try_include_seq("Studies", _arrow2778, inv.Studies), try_include_seq("RegisteredStudyIdentifiers", _arrow2780, inv.RegisteredStudyIdentifiers), try_include_seq("Comments", _arrow2781, inv.Comments)]))
...
def _arrow2795(get: IGetters) -> ArcInvestigation:
    ...
    return ArcInvestigation(_arrow2783(), _arrow2784(), _arrow2785(), _arrow2786(), _arrow2787(), _arrow2788(), _arrow2789(), _arrow2790(), _arrow2791(), _arrow2792(), _arrow2793(), _arrow2794())
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcInvestigation]:
    def _arrow2829(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcInvestigation:
        ...
        def _arrow2822(__unit: None=None) -> Array[OntologySourceReference] | None:
            arg_11: Decoder_1[Array[OntologySourceReference]] = resize_array(decoder_3)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("OntologySourceReferences", arg_11)
        ...
        return ArcInvestigation(_arrow2817(), _arrow2818(), _arrow2819(), _arrow2820(), _arrow2821(), _arrow2822(), _arrow2823(), _arrow2824(), _arrow2825(), _arrow2826(), _arrow2827(), _arrow2828())
