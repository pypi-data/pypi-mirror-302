...
def run_script():
    ...
    try:
        ...
        if IS_MAC:
            command = ['mjpython', '-m', 'dart_physics.runs.teleop', '--task', task, '--robot', robot_file_name, \
                    '--avp', '--th', extra] 
        else:mjp
            command = ['python', '-m','dart_physics.runs.teleop', '--task', task, '--robot', robot_file_name, \
                       '--headless', '--avp', '--th', extra] 
...
def list_files():
    ...
    try:
        ...
        for img_file in image_files:
            with open(os.path.join("./cfgs", img_file+'.png'), "rb") as image_file:
