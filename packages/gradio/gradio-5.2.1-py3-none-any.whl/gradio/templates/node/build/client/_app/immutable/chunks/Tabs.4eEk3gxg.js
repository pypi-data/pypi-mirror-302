...
function create_if_block(ctx) {
  ...
  return {
    ...
    p(ctx2, dirty) {
      if (dirty[0] & /*tabs, $selected_tab, change_tab, dispatch*/
      49176) {
...
function create_each_block(key_1, ctx) {
  ...
  return {
    ...
    p(new_ctx, dirty) {
      ...
      24 && button_aria_selected_value !== (button_aria_selected_value = /*t*/
      ctx[29].id === /*$selected_tab*/
      ctx[4])) {
...
function instance($$self, $$props, $$invalidate) {
  ...
  component_subscribe($$self, selected_tab_index, (value) => $$invalidate(25, $selected_tab_index = value));
  ...
  function change_tab(id) {
    ...
    if (tab_to_activate && tab_to_activate.interactive && tab_to_activate.visible && $selected_tab !== tab_to_activate.id) {
      ...
      dispatch("change");
      $$invalidate(5, overflow_menu_open = false);
    }
  }
  onMount(() => {
  ...
  function handle_menu_overflow() {
    ...
    Array.from(tab_nav_el.querySelectorAll("button")).forEach((item) => {
      ...
      $$invalidate(9, is_overflowing = tab_rect.right > tab_menu_rect.right || tab_rect.left < tab_menu_rect.left);
      if (is_overflowing) {
    ...
    $$invalidate(10, overflow_has_selected_tab = handle_overflow_has_selected_tab($selected_tab));
  }
  function handle_overflow_has_selected_tab(selected_tab2) {
    if (selected_tab2 === false || !overflow_nav)
      return false;
    return tabs.some((t) => t.id === selected_tab2 && overflow_nav.contains(document.querySelector(`[data-tab-id="${t.id}"]`)));
  }
  ...
  function div0_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      tab_nav_el = $$value;
      $$invalidate(7, tab_nav_el);
    });
  }
  const click_handler_1 = () => $$invalidate(5, overflow_menu_open = !overflow_menu_open);
  function div1_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      overflow_nav = $$value;
      $$invalidate(8, overflow_nav);
    });
  }
  function span_binding($$value) {
    binding_callbacks[$$value ? "unshift" : "push"](() => {
      overflow_menu = $$value;
      $$invalidate(6, overflow_menu);
    });
  }
  $$self.$$set = ($$props2) => {
    ...
    if ("inital_tabs" in $$props2)
      $$invalidate(17, inital_tabs = $$props2.inital_tabs);
    if ("$$scope" in $$props2)
  ...
  $$self.$$.update = () => {
    ...
    8) {
      $$invalidate(11, has_tabs = tabs.length > 0);
    }
