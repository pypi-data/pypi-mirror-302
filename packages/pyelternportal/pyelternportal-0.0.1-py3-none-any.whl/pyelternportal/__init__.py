...
from .pupil import Pupil, Pupils
...
class ElternPortalAPI:
    ...
    async def async_appointment(self) -> None:
        ...
        async with self.session.get(url) as response:
            ...
            self.pupils.set_pupil_appointments(self.pupil_id, appointments)
    ...
    async def async_lesson(self) -> None:
        ...
        async with self.session.get(url) as response:
            ...
            self.pupils.set_pupil_lessons(self.pupil_id, lessons)
    ...
    async def async_letter(self) -> None:
        ...
        self.pupils.set_pupil_letters(self.pupil_id, letters)
    ...
    async def async_poll(self) -> None:
        ...
        self.pupils.set_pupil_polls(self.pupil_id, polls)
    ...
    async def async_register(self) -> None:
        ...
        self.pupils.set_pupil_registers(self.pupil_id, registers)
    ...
    async def async_sicknote(self) -> None:
        ...
        self.pupils.set_pupil_sicknotes(self.pupil_id, sicknotes)
