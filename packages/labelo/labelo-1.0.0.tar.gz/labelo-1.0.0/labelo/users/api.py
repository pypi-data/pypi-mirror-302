...
@method_decorator(
    ...
    Save details for a specific user, such as their name or contact information, in Labelo.
    """,
        manual_parameters=[
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='List the users that exist on the Labelo server.',
    ),
)
@method_decorator(
    name='create',
    decorator=swagger_auto_schema(
        ...
        operation_description='Create a user in Labelo.',
        request_body=UserSerializer,
    ),
)
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Get info about a specific Labelo user, based on the user ID.',
        manual_parameters=[
            openapi.Parameter(name='id', type=openapi.TYPE_INTEGER, in_=openapi.IN_PATH, description='User ID'),
        ],
    ),
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description="""
        Update details for a specific user, such as their name or contact information, in Labelo.
        """,
        manual_parameters=[
            openapi.Parameter(name='id', type=openapi.TYPE_INTEGER, in_=openapi.IN_PATH, description='User ID'),
        ],
...
@method_decorator(
    ...
    decorator=swagger_auto_schema(
        ...
        operation_description='Delete a specific Labelo user.',
        manual_parameters=[
            openapi.Parameter(name='id', type=openapi.TYPE_INTEGER, in_=openapi.IN_PATH, description='User ID'),
        ],
    ),
