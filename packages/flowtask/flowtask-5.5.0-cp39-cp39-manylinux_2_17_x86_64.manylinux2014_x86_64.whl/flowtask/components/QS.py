...
from .support import TemplateSupport
...
class QS(FlowComponent, TemplateSupport, PandasDataframe):
    ...
    Overview
        ...
        This component supports QuerySource, making transformations of data and returning a transformed Pandas DataFrame.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        TemplateSupport.__init__(self, **kwargs)
