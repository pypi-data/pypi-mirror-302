...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="VerifyFaces_291228ea0ead_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_291228ea0ead_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_291228ea0ead_error")
        self._setDefault(outputCol="VerifyFaces_291228ea0ead_output")
