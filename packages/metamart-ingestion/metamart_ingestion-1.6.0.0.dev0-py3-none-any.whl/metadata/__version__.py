...
"""
Module for getting versions of MetaMart and python
"""
...
def get_client_version() -> str:
    """
    Get metamart-ingestion module version
    :return: client version
    """
    raw_version = version("metamart-ingestion")
    return get_client_version_from_string(raw_version)


def get_metadata_version() -> str:
    """
    Return the MetaMart version
    """
