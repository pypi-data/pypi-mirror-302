...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2231(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2234(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2235(x: IEncodable, oa: Any=oa) -> IEncodable:
        return x

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2231()), ("@type", list_1_2(singleton(ObjectExpr2232()))), try_include("name", _arrow2234, oa.Name), try_include_list("additionalProperties", _arrow2235, additional_properties), ("@context", context_jsonvalue)]))
...
class ObjectExpr2238(Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]]):
    def Decode(self, s: IDecoderHelpers_1[Any], json: Any) -> FSharpResult_2[tuple[MaterialAttributeValue | None, FactorValue | None], tuple[str, ErrorReason_1[__A_]]]:
        def _arrow2237(__unit: None=None) -> str:
        ...
        if (_arrow2237() if s.has_property("additionalType", json) else "") == "FactorValue":
...
ROCrate_additionalPropertyDecoder: Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]] = ObjectExpr2238()

def _arrow2242(get: IGetters) -> Sample:
    ...
    def _arrow2241(__unit: None=None) -> FSharpList[Source] | None:
        arg_7: Decoder_1[FSharpList[Source]] = list_1_3(ROCrate_decoder_3)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("derivesFrom", arg_7)

    return Sample(_arrow2239(), _arrow2240(), pattern_input[0], pattern_input[1], _arrow2241())


ROCrate_decoder: Decoder_1[Sample] = object(_arrow2242)
...
def ISAJson_encoder(id_map: Any | None, oa: Sample) -> IEncodable:
    def f(oa_1: Sample, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2246(value: str, oa_1: Any=oa_1) -> IEncodable:
            class ObjectExpr2245(IEncodable):
                def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                    return helpers.encode_string(value)

            return ObjectExpr2245()

        def _arrow2248(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2249(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        def _arrow2250(fv: FactorValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, fv)

        def _arrow2251(oa_3: Source, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, oa_3)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2246, ROCrate_genID(oa_1)), try_include("name", _arrow2248, oa_1.Name), try_include_list_opt("characteristics", _arrow2249, oa_1.Characteristics), try_include_list_opt("factorValues", _arrow2250, oa_1.FactorValues), try_include_list_opt("derivesFrom", _arrow2251, oa_1.DerivesFrom)]))
