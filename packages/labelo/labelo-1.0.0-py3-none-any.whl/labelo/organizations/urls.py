...
_api_urlpattens = [
    ...
    #A new path is added for updating members' roles when an administrator changes roles in the frontend.
    path('<int:pk>/memberships/update/<int:user_id>', api.OrganizationMemberUpdate.as_view(), name='organization-memberships-update'),
...
urlpatterns = [
    ...
    path('warning/organization', views.organization_warning, name='organization-warning'),
    ...
    path('api/invite/send-mail', api.SendEmailAPIView.as_view(), name='send-invite-mail'),
    path('api/invite/resend-mail', api.ResendEmailAPI.as_view(), name='resend-invitation-mail'),
    path('api/invite/revoke', api.RevokInvitationAPIView.as_view(), name='revoke-invitation-mail'),
    path('api/user/<int:pk>/switch-organization', api.SwitchOrganizationAPI.as_view(), name='switch-organization'),
