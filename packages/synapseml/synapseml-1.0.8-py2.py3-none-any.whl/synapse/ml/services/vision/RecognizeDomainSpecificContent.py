...
class RecognizeDomainSpecificContent(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="RecognizeDomainSpecificContent_ceec12252575_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        model=None,
        modelCol=None,
        outputCol="RecognizeDomainSpecificContent_ceec12252575_output",
        ...
        self._setDefault(errorCol="RecognizeDomainSpecificContent_ceec12252575_error")
        self._setDefault(outputCol="RecognizeDomainSpecificContent_ceec12252575_output")
