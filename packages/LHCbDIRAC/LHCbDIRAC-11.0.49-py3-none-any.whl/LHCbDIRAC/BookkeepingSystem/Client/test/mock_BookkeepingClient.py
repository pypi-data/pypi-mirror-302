...
bkc_mock.getListOfRunsInProd.return_value = {"OK": True, "Value": [97019]}


def fake_getInputOuputFilesForProd(prod, run_number):
    if prod != 0:
        raise NotImplementedError("Only prod 0 is implemented")
    if run_number != 97019:
        raise NotImplementedError("Only run 97019 is implemented")
    return {
        "OK": True,
        "Value": [
            ["aa.raw", "bb.raw", "Yes", "RAW"],
            ["aa.raw", "bb.log", "Yes", "LOG"],
        ],
    }


bkc_mock.getInputOuputFilesForProd.side_effect = fake_getInputOuputFilesForProd
