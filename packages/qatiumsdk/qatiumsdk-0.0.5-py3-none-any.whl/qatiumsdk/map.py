...
class Map:
  ...
  def hide_map_layer(self, type: ElementType, group: Optional[Union[valve.ValveGroupType, junction.JunctionGroupType, pipe.PipeGroupType]]) -> None:
    """
    ...
    Example:
        ...
        >>> sdk.map.hide_map_layer(ElementType.PIPE, pipe.PipeGroupType.Lateral)
    """
    return self.sdk.map.hideMapLayer(type, ffi.to_js(group))


  def show_map_layer(self, type: ElementType, group: Optional[Union[valve.ValveGroupType, junction.JunctionGroupType, pipe.PipeGroupType]]) -> None:
    """
    ...
    Example:
        ...
        >>> sdk.map.show_map_layer(ElementType.JUNCTION, junction.JunctionGroupType.CustomerPoint)
    """
