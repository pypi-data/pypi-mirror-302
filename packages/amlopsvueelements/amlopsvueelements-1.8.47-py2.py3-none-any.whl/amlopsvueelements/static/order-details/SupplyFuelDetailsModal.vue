          ...
          <div class="supply-modal-body">
            ...
            <div class="supply-modal-body-content-wrap flex">
              <div class="supply-modal-body-content w-full flex flex-col gap-2">
                <div
                  v-if="supplyFuelDetails?.issues.length > 0"
                      ...
                      >
                        <div class="supply-modal-body-content-block-body-name w-8/12">
                          ...
                          >
                            ...
                            <div class="supply-modal-body-tooltip">
                              <div
                                v-for="(note, noteId) in supplyFuel.results[resultIndex].tax_notes"
                                :key="noteId"
                                v-html="note"
                              ></div>
                            </div>
...
const { data: supplyFuelDetails, callFetch: fetchSupplierFuelDetails } = useFetch<
  any,
  (supplierId: number, detailsId: number) => Promise<any>
>(async (supplierId: number, detailsId: number) => {
