...
class pcell:
	...
	def draw_line_basic(self, sheet_name, xyxy, *para_list):
		...
		excel.draw_line_in_range("", [2,2,5,5], "", "blu","", 1)
	...
	def draw_line_in_range(self, sheet_name, xyxy, position, line_style, thickness, scolor):
		"""
		보관용
		"""
		self.draw_line_basic(sheet_name, xyxy, position, line_style, thickness, scolor)
