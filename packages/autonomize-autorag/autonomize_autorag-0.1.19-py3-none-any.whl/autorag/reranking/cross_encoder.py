...
class CrossEncoderReranker(Reranker):
    ...
    .. code-block:: python
        ...
        from autorag.reranking.cross_encoder import CrossEncoderReranker
    ...
    def _rerank(
        ...
        **kwargs: Any
        ...
        ranks = [
            ContentWithScore(content=document, reranking_score=score)
            for document, score in zip(documents, scores)
        ]
        ranks = sorted(ranks, key=lambda x: x.reranking_score, reverse=True)
