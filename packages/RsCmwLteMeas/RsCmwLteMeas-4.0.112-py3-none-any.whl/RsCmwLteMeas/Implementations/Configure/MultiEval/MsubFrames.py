...
class MsubFramesCls:
	...
	class MsubFramesStruct(StructBase):
		"""Response structure. Fields: \n
			- Sub_Frame_Offset: int: decimal Start of the measured subframe range relative to the trigger event. Range: 0 to 9
			- Sub_Frame_Count: int: decimal Length of the measured subframe range. Range: 1 to 320
			- Meas_Subframe: int: decimal Subframe containing the measured slots for modulation and spectrum results. Range: 0 to SubframeCount-1"""
		__meta_args_list = [
