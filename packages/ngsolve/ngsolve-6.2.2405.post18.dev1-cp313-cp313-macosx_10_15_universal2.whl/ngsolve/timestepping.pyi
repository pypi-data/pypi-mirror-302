...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('c', '_lin_solver_cls', 'bfmstar', 'gfu_old', 'dt', 'time', '_lin_solver_args')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('c', 'gfv_old', '_lin_solver_cls', 'gfu_old', 'bfmstar', 'dt', 'time', 'gfa_old', '_lin_solver_args')
