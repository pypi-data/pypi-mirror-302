...
MAPPING_LEGACY_SEMANTIC_TO_DPR = load_resource_file("metadata/mapping_legacy_dpr.json")
PRODUCT_FORMAT = load_resource_file("metadata/product_formats.json")
...
def _extract_data_from_product_filename(filename: str, **kwargs: Any) -> dict[str, Any]:
    ...
    if fmt.startswith("product/eopf"):
        ...
        try:
            ...
            s2prod = S2MSIL1CProductURI.from_string(filename[:37] + "_TXXXXX_00010101T000000.SAFE")
    ...
    def to_string(
        ...
        **kwargs: Any,
        ...
        if extension is None:
            extension = PRODUCT_FORMAT.get(self.semantic, {}).get("ext", ".zarr")
