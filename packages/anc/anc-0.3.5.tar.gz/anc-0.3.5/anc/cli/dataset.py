...
def status():
    ...
    try:
        ...
        print(f"Sorry, you can't get queue info outside of clusters, please use it in a notebook")
...
def status(task_id):
    ...
    try:
        ...
        print(f"Sorry, you can't run this command outside of clusters, please use it in a notebook")
    except json.JSONDecodeError:
        print("Sorry: received invalid JSON response from server")
    except KeyboardInterrupt:
        print(f"Operation interrupted.")
