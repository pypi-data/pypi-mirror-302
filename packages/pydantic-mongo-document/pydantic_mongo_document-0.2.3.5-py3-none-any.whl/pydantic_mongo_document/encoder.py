...
class JsonEncoder(json.JSONEncoder):
    ...
    def is_object_id(self, o: Any) -> bool:
        try:
    ...
    def encode(self, o: Any, reveal_secrets: bool = False) -> Any:
        ...
        if self.is_object_id(o):
            return self.object_id_type.validate_python(o, context=self.CONTEXT)
    ...
    def encode_dict(
        self, obj: dict[str, Any], reveal_secrets: bool = False
    ) -> dict[str, Any]:
