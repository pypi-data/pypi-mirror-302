    ...
    try:
        ...
        for root, dirs, files in os.walk(runner_env.JOB_CWD):
            ...
            for file in files:
                ...
                logger.info(f"Uploading {file_path} to job results folder")
