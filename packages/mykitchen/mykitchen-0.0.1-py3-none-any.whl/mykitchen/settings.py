...
ASGI_APPLICATION = "mykitchen.asgi.application"
...
LOGGING = {
    ...
    "loggers": {
        ...
        "mykitchen": {
            "handlers": ["stdout"],
            "level": env.log_level(
                "MYKITCHEN_LOG_LEVEL", default="INFO"
            ),
        },
    },
}
...
SECRET_KEY = env.str("SECRET_KEY", default="secret1")
