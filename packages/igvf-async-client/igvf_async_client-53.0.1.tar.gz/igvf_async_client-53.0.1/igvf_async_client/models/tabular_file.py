...
"""
    ...
    The version of the OpenAPI document: 53.0.1
...
class TabularFile(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.file_format:
            _dict['file_format'] = self.file_format.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file_format": FileFormat.from_dict(obj["file_format"]) if obj.get("file_format") is not None else None,
