...
class Parameters(tactParametters):
    def __init__(self, ModuleName="TACT"):
        ...
        self.cover_yolo_string__resize_after_crop_HW=[600, 800]
        self.Brightness = 50
...
class ImageAugmentation:
    ...
    def Change_image_multiple_ways(self, image,image_path, options):
        ...
        if options.get("cover_yolo_string", False):            
            ...
            if mParams.cover_yolo_string__resize_after_crop_HW:
                image = cv2.resize( image, mParams.cover_yolo_string__resize_after_crop_HW )
