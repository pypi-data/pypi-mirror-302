...
def encoder(study: ArcStudy) -> IEncodable:
    ...
    def _arrow2583(__unit: None=None, study: Any=study) -> IEncodable:
    ...
    def _arrow2585(value_1: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2587(value_3: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2589(value_5: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2591(value_7: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2592(oa: Publication, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2593(person: Person, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2594(oa_1: OntologyAnnotation, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2595(table: ArcTable, study: Any=study) -> IEncodable:
        return encoder_7(table)

    def _arrow2596(dm: DataMap, study: Any=study) -> IEncodable:
        return encoder_8(dm)

    def _arrow2598(value_9: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2599(comment: Comment, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2583()), try_include("Title", _arrow2585, study.Title), try_include("Description", _arrow2587, study.Description), try_include("SubmissionDate", _arrow2589, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2591, study.PublicReleaseDate), try_include_seq("Publications", _arrow2592, study.Publications), try_include_seq("Contacts", _arrow2593, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2594, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2595, study.Tables), try_include("DataMap", _arrow2596, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2598, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow2599, study.Comments)]))
...
def _arrow2613(get: IGetters) -> ArcStudy:
    ...
    return ArcStudy(_arrow2601(), _arrow2602(), _arrow2603(), _arrow2604(), _arrow2605(), _arrow2606(), _arrow2607(), _arrow2608(), _arrow2609(), _arrow2610(), _arrow2611(), _arrow2612())


decoder: Decoder_1[ArcStudy] = object(_arrow2613)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> IEncodable:
    ...
    def _arrow2617(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        value: str = study.Identifier
    ...
    def _arrow2619(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2621(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2623(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2625(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2626(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2627(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2628(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2629(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2630(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2632(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2633(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2617()), try_include("Title", _arrow2619, study.Title), try_include("Description", _arrow2621, study.Description), try_include("SubmissionDate", _arrow2623, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2625, study.PublicReleaseDate), try_include_seq("Publications", _arrow2626, study.Publications), try_include_seq("Contacts", _arrow2627, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2628, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2629, study.Tables), try_include("DataMap", _arrow2630, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2632, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow2633, study.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow2647(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        ...
        def _arrow2640(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = resize_array(decoder_2)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)
        ...
        def _arrow2642(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow2643(__unit: None=None) -> Array[ArcTable] | None:
            arg_17: Decoder_1[Array[ArcTable]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Tables", arg_17)

        def _arrow2644(__unit: None=None) -> DataMap | None:
            arg_19: Decoder_1[DataMap] = decoder_compressed_2(string_table, oa_table, cell_table)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("DataMap", arg_19)

        def _arrow2645(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredAssayIdentifiers", arg_21)

        def _arrow2646(__unit: None=None) -> Array[Comment] | None:
            arg_23: Decoder_1[Array[Comment]] = resize_array(decoder_6)
            object_arg_11: IOptionalGetter = get.Optional
            return object_arg_11.Field("Comments", arg_23)

        return ArcStudy(_arrow2635(), _arrow2636(), _arrow2637(), _arrow2638(), _arrow2639(), _arrow2640(), _arrow2641(), _arrow2642(), _arrow2643(), _arrow2644(), _arrow2645(), _arrow2646())

    return object(_arrow2647)
...
def ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    ...
    def _arrow2651(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2655(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2657(value_4: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2659(value_6: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2661(value_8: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2662(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow2664(value_10: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2666(value_12: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow2667(oa_1: Publication, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_1(oa_1)

    def _arrow2668(oa_2: Person, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_2(oa_2)

    def _arrow2670(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], IEncodable]:
        study_name: str | None = s.Identifier
        def _arrow2669(oa_3: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, None, oa_3)

        return _arrow2669

    def _arrow2672(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], IEncodable]:
        study_name_1: str | None = s.Identifier
        def _arrow2671(a_1: ArcAssay) -> IEncodable:
            return ROCrate_encoder_4(study_name_1, a_1)

        return _arrow2671

    def _arrow2673(comment: Comment, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2651()), ("@type", list_1_1(singleton(ObjectExpr2652()))), ("additionalType", ObjectExpr2653()), ("identifier", _arrow2655()), try_include("filename", _arrow2657, file_name), try_include("title", _arrow2659, s.Title), try_include("description", _arrow2661, s.Description), try_include_seq("studyDesignDescriptors", _arrow2662, s.StudyDesignDescriptors), try_include("submissionDate", _arrow2664, s.SubmissionDate), try_include("publicReleaseDate", _arrow2666, s.PublicReleaseDate), try_include_seq("publications", _arrow2667, s.Publications), try_include_seq("people", _arrow2668, s.Contacts), try_include_list("processSequence", _arrow2670(), processes), try_include_seq("assays", _arrow2672(), assays_1), try_include_seq("comments", _arrow2673, s.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2685(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow2675(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow2675()), create_missing_identifier())
    ...
    tables: Array[ArcTable] | None = map(mapping_2, _arrow2676())
    def _arrow2677(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
    ...
    def _arrow2684(__unit: None=None) -> Array[Comment] | None:
        arg_22: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_22)

    return (ArcStudy(identifier, _arrow2677(), _arrow2678(), _arrow2679(), _arrow2680(), _arrow2681(), _arrow2682(), _arrow2683(), tables, None, assay_identifiers, _arrow2684()), default_arg(assays, empty()))


ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow2685)
...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow2686(ps: FSharpList[Process], s_1: Any=s_1) -> IEncodable:
            return encoder_12(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow2686, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, IEncodable | None]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow2688(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow2687(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow2687

        encoded_protocols = try_include_list("protocols", _arrow2688(), value_5)
        ...
        def _arrow2692(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2695(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2697(value_9: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2699(value_11: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2701(value_13: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2703(value_15: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow2704(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow2705(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow2706(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow2708(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow2707(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_4(study_name_1, None, id_map, oa_4)

            return _arrow2707

        def _arrow2710(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], IEncodable]:
            study_name_2: str | None = s_1.Identifier
            def _arrow2709(a_2: ArcAssay) -> IEncodable:
                return ISAJson_encoder_5(study_name_2, id_map, a_2)

            return _arrow2709

        def _arrow2711(comment: Comment, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_6(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2692()), ("filename", ObjectExpr2693()), ("identifier", _arrow2695()), try_include("title", _arrow2697, study.Title), try_include("description", _arrow2699, study.Description), try_include("submissionDate", _arrow2701, study.SubmissionDate), try_include("publicReleaseDate", _arrow2703, study.PublicReleaseDate), try_include_seq("publications", _arrow2704, study.Publications), try_include_seq("people", _arrow2705, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow2706, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow2708(), processes), try_include_seq("assays", _arrow2710(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow2711, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow2713(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow2713, f, s, id_map)
...
def _arrow2733(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    ...
    def def_thunk(__unit: None=None) -> str:
        ...
        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow2715()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow2714(), def_thunk)
    ...
    def _arrow2717(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
    ...
    def _arrow2721(__unit: None=None) -> Array[Publication] | None:
        arg_21: Decoder_1[Array[Publication]] = resize_array(ISAJson_decoder_4)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("publications", arg_21)

    def _arrow2730(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2732(__unit: None=None) -> Array[Comment] | None:
        arg_25: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_11: IOptionalGetter = get.Optional
        return object_arg_11.Field("comments", arg_25)

    return (ArcStudy(identifier, _arrow2717(), _arrow2718(), _arrow2719(), _arrow2720(), _arrow2721(), None if (len(persons) == 0) else persons, _arrow2730(), tables, None, assay_identifiers, _arrow2732()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2733)
