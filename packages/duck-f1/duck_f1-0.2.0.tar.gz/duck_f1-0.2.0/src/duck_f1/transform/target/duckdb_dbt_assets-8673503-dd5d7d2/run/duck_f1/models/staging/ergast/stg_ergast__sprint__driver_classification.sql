  ...
  create view "f1"."staging"."stg_ergast__sprint__driver_classification__dbt_tmp" as (
    with
...
sprints_windows as (
    select
        *,
        ...
        sprint_time
        - lag(sprint_time) over (partition by session_id order by position_order) as sprint_time_gap
    from sprints
),
