...
class PII(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        domain=None,
        domainCol=None,
        errorCol="PII_fd54dedc8811_error",
        handler=None,
        language=None,
        languageCol=None,
        modelVersion=None,
        modelVersionCol=None,
        outputCol="PII_fd54dedc8811_output",
        piiCategories=None,
        ...
        self._setDefault(errorCol="PII_fd54dedc8811_error")
        self._setDefault(outputCol="PII_fd54dedc8811_output")
