...
class StringifiedJSONHandler(StructuredHandlerBase):
    ...
    async def _process_call_async(
        ...
        return await self._process_call_helper(messages, model, response_model, temperature, api_call_method, use_ephemeral_cache_only)
    ...
    def _process_call_sync(
        ...
        return self._process_call_helper(messages, model, response_model, temperature, api_call_method, use_ephemeral_cache_only)
