...
class SchemaCommandExecutor:
    ...
    def _transform_mutations(self) -> list[tuple[glue.Schema | None, glue.RegisterSchema | glue.DeleteSchema]]: ...
    def _execute_mutation(self, mutation: glue.RegisterSchema | glue.DeleteSchema) -> list[glue.Schema | None]: ...
    def _transform_change_mutations_to_register(self, mutations: list[glue.ChangeSchema]) -> tuple[glue.Schema, glue.RegisterSchema]: ...
