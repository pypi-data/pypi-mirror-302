...
from ..cli.console import console, ROBBIE_BLUE, SPINNER
...
class Deploy:
    ...
    def remote_function_deploy(func, args, kwargs, job_config: PositronJob):
        ...
        try:
            ...
            with Live(Spinner(SPINNER, text=Text("Packaging up workspace artifacts...(1 of 3)", style=ROBBIE_BLUE)),refresh_per_second=20, console=console, transient=True):
            ...
            with Live(Spinner(SPINNER, text=Text("Uploading workspace to Robbie...(2 of 3)", style=ROBBIE_BLUE)),refresh_per_second=20, console=console, transient=True):
            ...
            with Live(Spinner(SPINNER, text=Text("Waiting for remote job to finish...", style=ROBBIE_BLUE)),refresh_per_second=20, console=console, transient=True):
