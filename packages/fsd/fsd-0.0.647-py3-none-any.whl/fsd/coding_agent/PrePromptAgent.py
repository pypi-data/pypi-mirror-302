        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "processed_prompt: Translate non-technical parts of non-English prompts to English if needed, without changing the original meaning. Do not modify any provided technical information such as APIs. Correct grammar and provide a clear, concise version based on project insights. Exclude any mentions or questions about the AI model being used.\n"
                    ...
                    "4. All coding request, update features, missing images, logic bug fixed, new features (requires development plan), update UI/layout. Also use this for image generation requests that require subsequent coding to integrate the image.\n"
                    "5. Direct install dependencies only\n"
                    "6. Directly request to open/run/compile project only\n"
