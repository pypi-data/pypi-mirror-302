...
class PostgresConnection(BaseModel):
    ...
    database: Annotated[
        str,
        Field(
            description='Database of the data source. This is optional parameter, if you would like to restrict the metadata reading to a single database. When left blank, MetaMart Ingestion attempts to scan all the databases.',
            title='Database',
        ),
    ]
    ...
    classificationName: Annotated[
        ...
        Field(
            'PostgresPolicyTags',
            description='Custom MetaMart Classification name for Postgres policy tags.',
