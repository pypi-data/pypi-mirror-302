...
class MagnetSensorConfigs:
    ...
    def __str__(self) -> str:
        ...
        ss.append("    AbsoluteSensorRange: " + str(self.absolute_sensor_range))
        return "\n".join(ss)
...
class FeedbackConfigs:
    ...
    def __init__(self):
        ...
        The velocity Kalman filter will adjust to act as a low-pass with this
        value as its time constant. If the user is aiming for an expected
        cutoff frequency, the frequency is calculated as 1 / (2 * π * τ) with
        τ being the time constant.
