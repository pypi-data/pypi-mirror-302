...
class AnalyzeDocument(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AnalyzeDocument_dc06be4ddf04_error",
        features=None,
        featuresCol=None,
        imageBytes=None,
        imageBytesCol=None,
        ...
        outputCol="AnalyzeDocument_dc06be4ddf04_output",
        pages=None,
        pagesCol=None,
        pollingDelay=300,
        ...
        self._setDefault(errorCol="AnalyzeDocument_dc06be4ddf04_error")
        self._setDefault(initialPollingDelay=300)
        self._setDefault(maxPollingRetries=1000)
        self._setDefault(outputCol="AnalyzeDocument_dc06be4ddf04_output")
