...
class CollectionInfoResponse(_message.Message):
    __slots__ = ("response", "status", "vectors_count", "indexed_vector_count", "data_block_count", "meta")
    RESPONSE_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    meta: CollectionMeta
    def __init__(self, response: _Optional[_Union[_common_pb2.OperationStatus, str]] = ..., status: _Optional[str] = ..., vectors_count: _Optional[int] = ..., indexed_vector_count: _Optional[int] = ..., data_block_count: _Optional[int] = ..., meta: _Optional[_Union[CollectionMeta, _Mapping]] = ...) -> None: ...
