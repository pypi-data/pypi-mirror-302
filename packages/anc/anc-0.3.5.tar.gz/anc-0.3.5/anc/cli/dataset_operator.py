...
class DatasetOperator:
    def __init__(self):
        try:
            ...
            print(f"Sorry, you can't connected to our cluster, try to start a notebook and try again")
            sys.exit(1)
    ...
    def remote_add(self, version, source_path, message):
        ...
        try:
            ...
            print(f"Sorry, you can't add dataset outside of clusters, please use it in a notebook")
    ...
    def list_dataset(self, dataset_name):
        try:
            ...
            if response.status_code == 200:
                ...
                print("Failed to retrieve datasets now. Status code:", response.status_code)
        except RequestException as e:
            print(f"Sorry, you can't run command outside of clusters, please use it in a notebook")
        except json.JSONDecodeError:
            print("Error: Received invalid JSON response from server")
        except KeyboardInterrupt:
            print(f"Operation interrupted.")
