...
class PolicyWaiversApi:
    ...
    def add_policy_waiver_by_policy_violation_id(
        self,
        owner_type: Annotated[str, Field(strict=True, description="Indicates the scope of the waiver. Possible values are application, organization, repository, repository_manager, repository_container, global.")],
        ...
        :param owner_type: Indicates the scope of the waiver. Possible values are application, organization, repository, repository_manager, repository_container, global. (required)
        :type owner_type: str
