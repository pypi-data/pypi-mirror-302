...
const en = ["interactive", "gradio", "server", "target", "theme_mode", "root", "name", "visible", "elem_id", "elem_classes", "elem_style", "_internal", "props", "value", "attached_events"];
function vs(e, t = {}) {
...
function iu(e, t, n) {
  ...
  const d = ms(() => import("./upload.dragger-DfpDRDJu.js"));
  let {
    gradio: l
  } = t, {
    props: p = {}
