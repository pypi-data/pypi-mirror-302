...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_7c6ef5b7ebaa_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_7c6ef5b7ebaa_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_7c6ef5b7ebaa_error")
        self._setDefault(outputCol="AnalyzeImage_7c6ef5b7ebaa_output")
