...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_aa3a7bacc3f3_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_aa3a7bacc3f3_output",
        ...
        self._setDefault(errorCol="Transliterate_aa3a7bacc3f3_error")
        self._setDefault(outputCol="Transliterate_aa3a7bacc3f3_output")
