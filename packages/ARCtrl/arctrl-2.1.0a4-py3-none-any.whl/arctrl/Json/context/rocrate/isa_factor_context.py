...
IContext_reflection = _expr1335

def _arrow1344(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1336()), ("Factor", ObjectExpr1337()), ("factorName", ObjectExpr1338()), ("annotationValue", ObjectExpr1339()), ("termSource", ObjectExpr1340()), ("termAccession", ObjectExpr1341()), ("comments", ObjectExpr1342())])
    ...
    return ObjectExpr1343()


context_jsonvalue: IEncodable = _arrow1344()
