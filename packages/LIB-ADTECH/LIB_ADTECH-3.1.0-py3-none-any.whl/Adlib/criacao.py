...
def main(nomeFerramenta: str, codigoLoja: str, userBanco: str, senhaBanco: str, loginBanco: Callable[[ChromeOptions,str,str], None],
criarUsuario: Callable[[ChromeOptions,str,str], None], userVirtaus: str, senhaVirtaus: str, via: str = "Virtaus"):
            ...
            try:
                while True:
                    try:
                        ...
                        print(f"Não há solicitações do banco {nomeFerramenta} no momento {hora}:{minutos}")
                        sleep(30)
                        #virtaus.refresh()
...
if __name__=="__main__":
    ...
    main("DIGIO", "4258", userDigio, senhaDigio, loginDigio, criarUsuario, userVirtaus, senhaVirtaus)