...
class TeamStatsService:
    ...
    def get_team_stats(self, fixture_id: int) -> Dict[str, TeamStats]:
        response = self.team_repository.get_team_stats(fixture_id)
        fixture = self.fixture_service.get_fixture(fixture_id)
