...
class RedirectViewServletContextJspConfigDescriptorJspPropertyGroupsInner(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["buffer", "includeCodas", "deferredSyntaxAllowedAsLiteral", "trimDirectiveWhitespaces", "errorOnUndeclaredNamespace", "elIgnored", "scriptingInvalid", "pageEncoding", "isXml", "includePreludes", "defaultContentType", "urlPatterns"]
