"""
Este módulo contiene la clase `CalculadorMapaDensidad`, que se utiliza para calcular mapas de
densidad utilizando imágenes de fondo y datos de ovitrampas.
...
from mosqGIS.modulos.obtener_densidad_inicial import obtener_densidad_inicial
