  ...
  create view "f1"."intermediate"."int_standings__constructors__dbt_tmp" as (
    with
round_stats as (
    select
    ...
    from "f1"."staging"."stg_ergast__standings__constructors" as standing
    inner join
        "f1"."staging"."stg_ergast__constructors" as constructor
        on standing.constructor_id = constructor.constructor_id
    inner join "f1"."staging"."stg_ergast__races" as _session on standing.session_id = _session.session_id
    window
