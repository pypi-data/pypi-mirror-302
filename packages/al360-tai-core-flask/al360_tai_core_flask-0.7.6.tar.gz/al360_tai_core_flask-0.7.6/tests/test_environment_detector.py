...
from al360_tai_core_flask.environments.azure_nb_environment import AzureNBEnvironment
from al360_tai_core_flask.environments.credentialed_vm_environment import \
    CredentialedVMEnvironment
from al360_tai_core_flask.environments.databricks_environment import (
    DATABRICKS_ENV_VAR, DatabricksEnvironment)
from al360_tai_core_flask.environments.local_ipython_environment import \
    LocalIPythonEnvironment
from al360_tai_core_flask.environments.public_vm_environment import \
    PublicVMEnvironment
...
class TestEnvironmentDetector(object):
    ...
    def test_public_vm(self, mocker):
        mocker.patch('al360_tai_core_flask.FlaskHelper._is_local_port_available',
                     return_value=True)
    ...
    def test_azure_nb(self, mocker):
        ...
        mocker.patch(
            'al360_tai_core_flask.environments.azure_nb_environment.'
