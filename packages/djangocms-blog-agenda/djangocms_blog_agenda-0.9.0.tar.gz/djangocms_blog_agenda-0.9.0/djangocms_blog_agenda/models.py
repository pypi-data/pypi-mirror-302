...
class PostExtension(models.Model):
    ...
    def get_next_occurrence(self):
        return self.recurrences.after(
            self.event_start_date, inc=True, dtstart=self.event_start_date
        )
    ...
    def occurrences(self) -> list:
        if self.recurrences:
            ...
            return self.recurrences.between(dtstart, dtend, dtstart=dtstart)
        return []
    ...
    def get_post_occurrences(self, after=None):
        ...
        if self.recurrences:
            for occurrence in self.occurrences:
                if not after or occurrence >= after:
                    new_instance = Post(
                        **{
                            field: value
                    ...
                    new_instance.occurrence = occurrence
