...
def ActiveMGResource_get__session_name__active_mg_get(
...
def ActiveMGResource_patch__session_name__active_mg_patch(
    session_name: str,
...
def CallFunctionResource_post__session_name__call_post(
    session_name: str,
    data: CallFunction,
    api_config_override: Optional[APIConfig] = None,
...
def CallFunctionStateResource_get__session_name__call__call_id__get(
...
def CallFunctionStateResource_delete__session_name__call__call_id__delete(
    session_name: str, call_id: str, api_config_override: Optional[APIConfig] = None
) -> None:
    api_config = api_config_override if api_config_override else APIConfig()
...
def ScanSavingResource_get__session_name__scan_saving_get(
    session_name: str, api_config_override: Optional[APIConfig] = None
) -> ScanSaving:
    api_config = api_config_override if api_config_override else APIConfig()
...
def ScanSavingResource_post__session_name__scan_saving_post(
    session_name: str,
...
def ScanSavingResource_patch__session_name__scan_saving_patch(
    session_name: str,
