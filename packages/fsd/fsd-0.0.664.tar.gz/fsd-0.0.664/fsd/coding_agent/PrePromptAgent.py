        ...
        messages = [
            {
                ...
                "content": (
                    ...
                    "4. MUST FORR All coding request, update features, missing images, logic bug fixed, new features (requires development plan), update UI/layout. Also use this for image generation requests that require subsequent coding to integrate the image.\n"
