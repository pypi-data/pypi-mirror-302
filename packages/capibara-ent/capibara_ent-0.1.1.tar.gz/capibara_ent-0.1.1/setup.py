...
setup(
    ...
    version="0.1.1",  # Initial version of the package
    author="Marco Durán",  # Your name as the author of the package
    author_email="marco@anachcroni.co",  # Your email address
    description=(
        "Un modelo de lenguaje avanzado que integra Mamba SSM, "
        "manejo multilingüe y características éticas"
    ...
    install_requires=[
        ...
        "mamba-ssm>=1.0.0",  # Ensure the correct version of Mamba SSM
        "langdetect>=1.0.9",  # Language detection library
        "fastapi>=0.68.0",  # FastAPI for creating APIs
        "uvicorn>=0.15.0",  # Uvicorn as ASGI server
    ],
    extras_require={
        ...
        "gpu": [  # Dependencies specific for GPU use
            "cupy-cuda11x>=11.0.0"
        ],
    },
