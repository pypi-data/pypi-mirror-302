...
def save_resnet_config(output_path:str='configs/debug/resnet_debug.yaml'):
...
def save_retinanet_config(output_path:str):
...
def save_maskrcnn_config(output_path:str):
...
def save_bert_config(output_path:str):
...
if __name__ == '__main__':
    ...
    save_resnet_config('./configs/debug/resnet_debug.yaml')
    save_retinanet_config('./configs/debug/retinanet_debug.yaml')
    save_maskrcnn_config('./configs/debug/maskrcnn_debug.yaml')
    save_bert_config('./configs/debug/bert_debug.yaml')
