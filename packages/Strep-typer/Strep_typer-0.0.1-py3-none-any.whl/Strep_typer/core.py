...
__all__ = ['PACKAGE_NAME', 'DEV_MODE', 'PACKAGE_DIR', 'PROJECT_DIR', 'config', 'set_env_variables', 'get_config',
           'show_project_env_vars', 'get_samplesheet', 'cli']

# %% ../nbs/00_core.ipynb 4
# Need the Strep_typer for a few functions, this can be considered a static var

import importlib
import importlib.util
import os

PACKAGE_NAME: str = "Strep_typer"  # Make sure to adjust this to your package name
DEV_MODE: bool = (
