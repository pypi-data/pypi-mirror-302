...
class ParentDevice:
    ...
    def __init__(self, device_id: int, model: str, canbus: str):
        ...
        self.__compliancy = self._common_lookup(SpnValue.COMPLIANCY_VERSION.value, 0, None, "Compliancy", int, False, True)
        self.__reset_signal = self._common_lookup(SpnValue.STARTUP_RESET_FLAGS.value, 0, None, "ResetFlags", int, False, True)
    ...
    def _common_lookup(self, spn: int, map_iter: int, generator: Callable[[], dict[int, StatusSignal]], signal_name: str, signal_type: type[T], report_on_construction: bool, refresh: bool) -> StatusSignal[T]:
