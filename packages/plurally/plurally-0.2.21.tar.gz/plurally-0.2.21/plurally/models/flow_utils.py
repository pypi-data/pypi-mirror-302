...
def ungroup_subflow_data(flow_serialized, node_id):
    ...
    pos_x = node["pos_x"]
    pos_y = node["pos_y"]
    subflow_data = flow_serialized["nodes"].pop(ix)
    ...
    return node_ids, connected_to_run_handle, subflow_data
...
def adapt_flow_data(data):
    ...
    for n in data["nodes"]:
        ...
        if kls.PLURALLY_VERSION != version_from and kls.PLURALLY_VERSION != 0:
            ...
            if ungroup:
                ...
                subnode_ids, connected_to_run_handle, subflow_data = (
                ...
                subflows_to_regroup[n["_node_id"]] = {
                    ...
                    "connected_to_run_handle": connected_to_run_handle,
    ...
    return data, subflows_to_regroup
