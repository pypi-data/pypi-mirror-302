...
SET_DB = get_env('SET_DB', 'sqllite')


if SET_DB == 'postgres':
    DJANGO_DB = DJANGO_DB_POSTGRESQL
else:
    DJANGO_DB = DJANGO_DB_SQLITE
...
from labelo.core.utils import sentry

sentry.init_sentry(release_name='labelo', release_version=__version__)
...
# in Labelo Community version, feature flags are always ON
...
try:
    ...
    find_node('labelo', FEATURE_FLAGS_FILE, 'file')
except IOError:
