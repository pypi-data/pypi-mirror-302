      ...
      <div class="order-step bg-white w-6/12 border border-transparent rounded-md">
        ...
        <div class="order-step-content compliance-status w-full flex flex-col p-[0.75rem] gap-2">
          ...
          <div class="w-full flex gap-2">
            ...
            <div class="order-step-content-el-status py-[0.25rem] px-[0.75rem]">
              Approval required
            </div>
          </div>
        </div>
      ...
      <div class="order-step bg-white w-6/12 border border-transparent rounded-md">
        ...
        <div class="order-step-content compliance-status w-full flex flex-col p-[0.75rem] gap-2">
          ...
          <div class="w-full flex gap-2">
            ...
            <div class="order-step-content-el-status-warn py-[0.25rem] px-[0.75rem]">
...
const { callFetch: fetchOrder } = useFetch<any, (order: any) => Promise<any>>(
  async (order: any) => {
...
const { callFetch: fetchFlightAirportLocation } = useFetch<any, (id: number) => Promise<any>>(
  async (id: number) => {
...
const { callFetch: fetchFlightAircraftLocation } = useFetch<any, (id: number) => Promise<any>>(
  async (id: number) => {
