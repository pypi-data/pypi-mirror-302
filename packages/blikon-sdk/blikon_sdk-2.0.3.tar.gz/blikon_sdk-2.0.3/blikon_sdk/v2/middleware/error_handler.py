...
class ErrorHandlingMiddleware:
    ...
    def setup(self):
        ...
        async def validation_exception_handler(request: Request, exc: Exception) -> JSONResponse:
            ...
            detail = "Validation error"  # Mensaje genérico para los errores de validación
    ...
    async def _handleError(self, status_code: int, request: Request, message: str, exc,
        ...
        # Report the error to the 'Contingency Service'
        self._report_error(error_detail, exc.__traceback__)
    ...
    async def _report_error(self, error_detail: ErrorDetail, traceback: str) -> None:
        try:
            print(f"ERROR REPORTED: {error_detail.error_message}")
