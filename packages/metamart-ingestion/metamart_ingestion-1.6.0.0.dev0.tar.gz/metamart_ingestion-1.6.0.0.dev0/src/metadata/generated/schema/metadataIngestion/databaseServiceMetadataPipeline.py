...
class DatabaseServiceMetadataPipeline(BaseModel):
    ...
    markDeletedStoredProcedures: Annotated[
        ...
        Field(
            True,
            description='Optional configuration to soft delete stored procedures in MetaMart if the source stored procedures are deleted. Also, if the stored procedures is deleted, all the associated entities like lineage, etc., with that stored procedures will be deleted',
