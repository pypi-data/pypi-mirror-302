...
_api_urlpatterns = [
    ...
    path('assignees', api.TaskAsigneeAPI.as_view(), name='task-assignee'),
...
urlpatterns = [
    ...
    path('api/comments', api.CommentAPI.as_view(), name='task-comments'),
    path('api/comments/<int:pk>/', api.UpdateCommentAPI.as_view(), name='task-update-comments'),
    path('api/annotation/review/<int:pk>/', api.AnnotationReviewAPI.as_view(), name='api-annotation-review'),
    path('api/dm/tasks/search', api.TaskSearch.as_view(), name="task-search")
]
