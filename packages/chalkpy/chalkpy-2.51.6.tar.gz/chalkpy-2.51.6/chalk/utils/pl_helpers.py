...
def _is_version_gte(version: str, target: str) -> bool:
...
try:
    ...
    is_new_polars = _is_version_gte(pl.__version__, "0.18.0")
    polars_has_pad_start = _is_version_gte(pl.__version__, "0.19.12")
except ImportError:
    is_new_polars = False
