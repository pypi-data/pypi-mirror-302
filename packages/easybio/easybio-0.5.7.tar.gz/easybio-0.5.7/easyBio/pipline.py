...
def main():
    ...
    parser.add_argument("-nomd5", "--NoCheckMd5", action='store_true',
                        help="Whether to show the download progress")
    ...
    CheckMd5 = not args.NoCheckMd5
    
    print(f"downloadFist:{downloadFist}")
    print(f"showDownloadProgress:{showDownloadProgress}")
    print(f"checkMd5:{CheckMd5}")
