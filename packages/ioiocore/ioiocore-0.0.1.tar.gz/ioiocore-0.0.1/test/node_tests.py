...
class SourceInvalid(ioc.Node):
    def __init__(self):
        super().__init__(outputPorts = ['out1', 'out1'])
...
class FilterInvalid1(ioc.Node):
    def __init__(self):
        super().__init__(inputPorts = ['in1', 'in1'], outputPorts = ['out1', 'out2'])
...
class FilterInvalid2(ioc.Node):
    def __init__(self):
        super().__init__(inputPorts = ['in1', 'in2'], outputPorts = ['out1', 'out1'])
...
class FilterInvalid3(ioc.Node):
    def __init__(self):
        super().__init__(inputPorts = ['in1', 'in2'], outputPorts = ['in1', 'in2'])
...
class SinkInvalid(ioc.Node):
    def __init__(self, event_handler):
        super().__init__(inputPorts = ['in1', 'in1'])
