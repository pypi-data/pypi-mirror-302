...
from ....types.shared.project_user import ProjectUser
from ....types.organization.projects import user_list_params, user_create_params
    ...
    def create(
        ...
        *,
        ...
        return self._post(
            ...
            body=maybe_transform({"role": role}, user_create_params.UserCreateParams),
    ...
    async def create(
        ...
        *,
        ...
        return await self._post(
            f"/organization/projects/{project_id}/users/{user_id}",
            body=await async_maybe_transform({"role": role}, user_create_params.UserCreateParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=ProjectUser,
