...
class DutyCycleOut:
    ...
    def __init__(self, output: float, enable_foc: bool = True, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, use_timesync: bool = False):
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDutyCycleOut(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.output, self.enable_foc, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.use_timesync))
