...
class Record(BaseModel):
    ...
    fs: Optional[float] = Field(None, title="Phred-scaled p-value using Fisher's exact test to detect strand bias.")
    ...
    zygosity: Optional[str] = Field(None, title="The zygosity.")
