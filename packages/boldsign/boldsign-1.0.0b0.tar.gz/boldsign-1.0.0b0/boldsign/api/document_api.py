...
class DocumentApi:
    ...
    @validate_call
    def v1_document_change_recipient_patch(
        self,
        ...
        _param = self._v1_document_change_recipient_patch_serialize(
            document_id=document_id,
    ...
    @validate_call
    def v1_document_change_recipient_patch_with_http_info(
        self,
        document_id: Annotated[StrictStr, Field(description="The documentID details.")],
        change_recipient: Annotated[ChangeRecipient, Field(description="The new recipient details.")],
        _request_timeout: Union[
    ...
    @validate_call
    def v1_document_change_recipient_patch_without_preload_content(
        self,
        document_id: Annotated[StrictStr, Field(description="The documentID details.")],
        change_recipient: Annotated[ChangeRecipient, Field(description="The new recipient details.")],
        _request_timeout: Union[
    ...
    def _v1_document_change_recipient_patch_serialize(
        self,
        document_id,
        change_recipient,
        _request_auth,
