...
class DifferentialVoltage:
    ...
    def __init__(self, target_output: volt, differential_position: rotation, enable_foc: bool = True, differential_slot: int = 1, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, use_timesync: bool = False):
