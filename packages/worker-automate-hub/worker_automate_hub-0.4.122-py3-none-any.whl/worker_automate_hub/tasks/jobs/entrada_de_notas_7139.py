...
async def entrada_de_notas_7139(task):
    ...
    try:
        ...
        try:
            ...
            console.print("Não possui nenhum Information após a confirmar...\n")
        ...
        try:
            ...
            try:
                ...
                try:
                    console.print(f"Tentando clicar no segundo Botão &OK...\n")
                    btn_ok = main_window.child_window(title="&OK")
                    btn_ok.click()
                    retorno = True
                except Exception as second_inner_e:
                    console.print(f"Erro ao clicar no botão OK: {second_inner_e}")
                    retorno = False
