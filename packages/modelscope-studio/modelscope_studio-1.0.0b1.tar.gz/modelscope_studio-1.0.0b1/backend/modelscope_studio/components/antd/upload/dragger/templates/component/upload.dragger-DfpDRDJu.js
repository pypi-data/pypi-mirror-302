import { g as fe, w as x } from "./Index-jD_27ANx.js";
const b = window.ms_globals.React, J = window.ms_globals.React.useMemo, ae = window.ms_globals.React.forwardRef, de = window.ms_globals.React.useRef, ue = window.ms_globals.React.useState, pe = window.ms_globals.React.useEffect, D = window.ms_globals.ReactDOM.createPortal, we = window.ms_globals.antd.Upload;
var Y = {
  exports: {}
}, S = {};
/**
...
function Q(e, o, r) {
  ...
  for (s in o) ve.call(o, s) && !ye.hasOwnProperty(s) && (n[s] = o[s]);
...
function j(e) {
  ...
  if (e._reactElement)
    return o.push(D(b.cloneElement(e._reactElement, {
      ...e._reactElement.props,
      children: b.Children.toArray(e._reactElement.props.children).map((n) => {
        if (b.isValidElement(n) && n.props.__slot__) {
          ...
          return b.cloneElement(n, {
            ...n.props,
            el: l,
            children: [...b.Children.toArray(n.props.children), ...t]
          });
        }
        return null;
      })
  ...
  return pe(() => {
    ...
    if (o && window.MutationObserver) {
      let c = function() {
        ...
        i = u, a(p), i.style.display = "contents", y(), (_ = t.current) == null || _.appendChild(i);
      };
...
const Qe = We(({
  ...
  const F = e["showUploadList.downloadIcon"] || e["showUploadList.removeIcon"] || e["showUploadList.previewIcon"] || e["showUploadList.extra"] || typeof r == "object", m = Je(r), O = v(m.showPreviewIcon), d = v(m.showRemoveIcon), te = v(m.showDownloadIcon), N = v(n), oe = v(t), ne = v(s == null ? void 0 : s.format), re = v(l), se = v(a), le = v(i), ie = v(y), ce = v(w), A = J(() => (u == null ? void 0 : u.map((h) => ({
    ...h,
