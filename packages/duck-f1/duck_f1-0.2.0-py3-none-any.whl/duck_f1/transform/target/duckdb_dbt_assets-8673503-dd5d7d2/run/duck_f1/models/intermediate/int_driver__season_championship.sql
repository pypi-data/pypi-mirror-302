  ...
  create view "f1"."intermediate"."int_driver__season_championship__dbt_tmp" as (
    with
round_stats as (
    select
        driver.driver_id,
    ...
    from "f1"."staging"."stg_ergast__standings__drivers" as standing
    inner join
        "f1"."staging"."stg_ergast__drivers" as driver
