...
class IOPipeline:
    ...
    def add_node(self, name: str, node: IONode):
    ...
    def __get_ports(self, n1 : IONode):
        return [n1.__dict__()[NodeInfo.INPUTS.value], n1.__dict__()[NodeInfo.OUTPUTS.value]]

    def __n1_is_output(self, n1 : IONode, port_name1 : str, n2 : IONode, port_name2 : str ):
    ...
    def __check_nodes(self, node_name1 : str, node_name2 : str):
        n1 : IONode = None
        try:
            n1 : IONode = self.__nodes[node_name1] 
        except:
            raise ValueError(f'Pipeline does not contain \'{node_name1}\'.')
        try:
            n2 : IONode = self.__nodes[node_name2]
        except:
