...
class Progress(Thread):
    ...
    def run(self):
        ...
        while True:
            ...
            self.print_status(current_size=current_size,
                              ...
                              displayed_time=displayed_time,
                              prefix=self.prefix)
            self.update_progress_value(current_size, total_length)
    ...
    def update_progress_value(self, current_size, total_length):
        frac = float(current_size) / total_length
        percentage = frac * 100
        self.job_entity.progress_value.set(percentage)
    ...
    def done_progress(self):
        ...
        self.last_printed_len = 0
        self.current_size = 0
        self.job_entity.status.set('PROCESSED')
