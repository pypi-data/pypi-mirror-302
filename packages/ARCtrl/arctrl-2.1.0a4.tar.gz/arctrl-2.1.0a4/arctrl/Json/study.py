...
def _arrow2724(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    ...
    def _arrow2722(__unit: None=None) -> Array[OntologyAnnotation] | None:
    ...
    def _arrow2723(__unit: None=None) -> Array[Comment] | None:
        arg_25: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_11: IOptionalGetter = get.Optional
        return object_arg_11.Field("comments", arg_25)

    return (ArcStudy(identifier, _arrow2717(), _arrow2718(), _arrow2719(), _arrow2720(), _arrow2721(), None if (len(persons) == 0) else persons, _arrow2722(), tables, None, assay_identifiers, _arrow2723()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2724)
