...
class MembersClient(Client):
    ...
    async def update_client_credential(
        ...
        resp_model = str(resp.content)  # type: ignore
        return resp_model
    ...
    async def create_organisation_invite(
        ...
        try:
            resp_model = list.model_validate(resp.json())
        except pydantic_core.ValidationError:
            raise EnsureException(
                f"The response came back in an unexpected format: {resp.text}"
            )
    ...
    async def get_jwks(
        self,
    ) -> members_schemas.JWKS:
        """ """
        path_params: Dict[str, Any] = {}
        resp = await self.get("/oauth/.well-known/jwks", params=path_params)

        try:
            resp_model = members_schemas.JWKS.model_validate(resp.json())
        except pydantic_core.ValidationError:
            raise EnsureException(
                f"The response came back in an unexpected format: {resp.text}"
            )
    ...
    async def authorize(
        self,
        query_arguments: members_queries.AuthorizeQuery,
    ) -> None:
        """ """
        # get rid of items where None
        query_params = {
        ...
        path_params: Dict[str, Any] = {}
        await self.get("/oauth/authorize", params=path_params | query_params)

        return

    async def authorize_complete(
        self,
        query_arguments: members_queries.AuthorizeCompleteQuery,
    ) -> None:
        """ """
        # get rid of items where None
        query_params = {
        ...
        path_params: Dict[str, Any] = {}
        await self.get("/oauth/authorize/complete", params=path_params | query_params)

        return

    async def get_access_token(
        self,
        body: Union[members_schemas.GetTokenParams, str],
    ) -> members_schemas.TokenResponse:
        """ """
        path_params: Dict[str, Any] = {}
        resp = await self.post(
            "/oauth/token",
        ...
        try:
            resp_model = members_schemas.TokenResponse.model_validate(resp.json())
        except pydantic_core.ValidationError:
            raise EnsureException(
                f"The response came back in an unexpected format: {resp.text}"
            )
    ...
    async def validate_external_token(
        self,
        rest_of_path: Union[str, None] = None,
    ) -> bool:
        """ """
        path_params: Dict[str, Any] = {
            "rest_of_path": rest_of_path,
        }
        resp = await self.get(f"/oauth/validate{rest_of_path}", params=path_params)

        resp_model = bool(resp.content)  # type: ignore
        return resp_model

    async def post_validate_external_token(
        self,
        rest_of_path: Union[str, None] = None,
    ) -> bool:
        """ """
        ...
        resp = await self.post(f"/oauth/validate{rest_of_path}", params=path_params)

        resp_model = bool(resp.content)  # type: ignore
        return resp_model

    async def put_validate_external_token(
        self,
        rest_of_path: Union[str, None] = None,
    ) -> bool:
        """ """
        ...
        resp = await self.put(f"/oauth/validate{rest_of_path}", params=path_params)

        resp_model = bool(resp.content)  # type: ignore
        return resp_model

    async def patch_validate_external_token(
        self,
        rest_of_path: Union[str, None] = None,
    ) -> bool:
        """ """
        ...
        resp = await self.patch(f"/oauth/validate{rest_of_path}", params=path_params)

        resp_model = bool(resp.content)  # type: ignore
        return resp_model

    async def delete_validate_external_token(
        self,
        rest_of_path: Union[str, None] = None,
    ) -> bool:
        """ """
        ...
        resp = await self.delete(f"/oauth/validate{rest_of_path}", params=path_params)
