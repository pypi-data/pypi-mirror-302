...
#   filename:  <stdin>
#   timestamp: 2024-10-10T16:53:55+00:00
...
class JWKS(BaseModel):
    keys: Annotated[List[Dict[str, Any]], Field(title="Keys")]
...
class ResponseType(RootModel[Literal["code"]]):
    root: Annotated[Literal["code"], Field("code", title="ResponseType")]
...
class SupportedCodeChallengeMethods(RootModel[Literal["S256"]]):
    root: Annotated[
        Literal["S256"], Field("S256", title="SupportedCodeChallengeMethods")
    ]
...
class TokenResponse(BaseModel):
    ...
    scope: Annotated[Optional[str], Field(None, title="Scope")]
    refresh_token: Annotated[Optional[str], Field(None, title="Refresh Token")]
    refresh_expires_at: Annotated[
        Optional[int], Field(None, title="Refresh Expires At")
    ]
    id_token: Annotated[Optional[str], Field(None, title="Id Token")]
    id_expires_at: Annotated[Optional[int], Field(None, title="Id Expires At")]
...
class GetTokenParams(BaseModel):
    ...
    client_secret: Annotated[Optional[str], Field(None, title="Client Secret")]
    code: Annotated[Optional[str], Field(None, title="Code")]
    redirect_uri: Annotated[Optional[str], Field(None, title="Redirect Uri")]
    code_verifier: Annotated[Optional[str], Field(None, title="Code Verifier")]
    refresh_token: Annotated[Optional[str], Field(None, title="Refresh Token")]
...
class SubInvite(BaseModel):
    ...
    organisation_id: Annotated[UUID, Field(title="Organisation Id")]
    roles: Annotated[List[RoleBase], Field(title="Roles")]
    system_type: SystemTypes
...
class Invite(BaseModel):
    ...
    created_at: Annotated[Optional[datetime.datetime], Field(None, title="Created At")]
    updated_at: Annotated[Optional[datetime.datetime], Field(None, title="Updated At")]
    inviter_id: Annotated[UUID, Field(title="Inviter Id")]
    invitee_email: Annotated[EmailStr, Field(title="Invitee Email")]
    status: InviteStatus
    expires_at: Annotated[datetime.datetime, Field(title="Expires At")]
