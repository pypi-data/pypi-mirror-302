...
class Field:
    ...
    contains:
     - evaluation points
     - if applicable: surface elements or volume elements
    ...
    def __init__(
        ...
        Args:
            ...
            ds (torch.Tensor, optional): optional surface elements corresponding to each position. If given, used in field integration. Defaults to None.
