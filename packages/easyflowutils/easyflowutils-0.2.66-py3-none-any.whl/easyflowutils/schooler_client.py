...
class SchoolerClient:
    ...
    def get_course_students(self, course_id: int) -> dict[str, Any]:
        return self.get(f"courses/{course_id}/students")

    def enroll_students_in_course(self, course_id: int, students_data: list[dict]) -> dict[str, Any]:
        return self.post(f"courses/{course_id}/enroll_students", {"students_data": students_data})

    def enroll_single_student_in_course(self, course_id: int, student_data: dict) -> dict[str, Any]:
    ...
    def update_single_student_in_course(self, course_id: int, student_data: dict[str, Any]) -> dict[str, Any]:
    ...
    def delete_single_student_from_course(self, course_id: int, student_id: int) -> dict[str, Any]:
    ...
    def get_school_details(self, school_id: int) -> dict[str, Any]:
        return self.get(f"schools/{school_id}")

    def get_school_students(self, school_id: int) -> dict[str, Any]:
        return self.get(f"schools/{school_id}/students")

    def enroll_students_in_school(self, school_id: int, students_data: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    def get_courses_of_student_by_email(self, email: str) -> list[dict[str, Any]]:
        return self.search_students(email=email).get("courses", [])
