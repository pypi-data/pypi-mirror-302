...
def inject_gadget_into_apk(apk_path:str, arch:str, decompiled_path:str, main_activity:str = None, config:str = None, script:str = None):
    ...
    # Upload Gadget config and script files
...
def run(apk_path: str, arch: str, main_activity: str,
        sign:bool, skip_decompile:bool, skip_recompile:bool,
        config:str, script:str, use_aapt2:bool, no_res:bool):
    ...
    inject_gadget_into_apk(apk_path, arch, decompiled_path, main_activity, config, script)
