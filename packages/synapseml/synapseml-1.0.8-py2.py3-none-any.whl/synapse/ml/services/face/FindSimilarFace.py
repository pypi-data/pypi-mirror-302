...
class FindSimilarFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="FindSimilarFace_499998a9fb26_error",
        faceId=None,
        faceIdCol=None,
        faceIds=None,
        faceIdsCol=None,
        ...
        mode=None,
        modeCol=None,
        outputCol="FindSimilarFace_499998a9fb26_output",
        ...
        self._setDefault(errorCol="FindSimilarFace_499998a9fb26_error")
        self._setDefault(outputCol="FindSimilarFace_499998a9fb26_output")
