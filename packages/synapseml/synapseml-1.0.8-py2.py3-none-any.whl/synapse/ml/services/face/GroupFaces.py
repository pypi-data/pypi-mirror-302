...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GroupFaces_28284b79f25a_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_28284b79f25a_output",
        ...
        self._setDefault(errorCol="GroupFaces_28284b79f25a_error")
        self._setDefault(outputCol="GroupFaces_28284b79f25a_output")
