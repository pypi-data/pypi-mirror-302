...
class mechanism25(bmutils):
    ...
    def plot(self, theta = 0):    
        ...
        for index, instance in enumerate(self.instances):
            ...
            if 0 <= instance_theta and instance_theta < self.theta_limits[0]:
                ...
                d_theta_5 = self.theta_forward/2 + R1/R2 * R3/R5 * (instance_theta-self.theta_limits[0])
    ...
    def Settings(R1=5,R2=1, theta_forward=0.5*np.pi, return_fraction=1/3, animation_rounds=2, speed=0.5, num_instances=2):
        ...
        theta_limits = []
        s_limit_1 = theta_forward/2 * R4
        theta_1_section_1 = s_limit_1/R1

        theta_limits.append(theta_1_section_1)
        theta_return = 2*np.pi - theta_forward
        s_limit_2_R5 = theta_return * R5
        theta_3 = s_limit_2_R5/ R3

        theta_1_section_2 = R2/R1 * theta_3 # theta_2 = theta_3
