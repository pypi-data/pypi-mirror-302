...
class Executor(ExecutorBase['ModelType']):
    ...
    @staticmethod
    def _process_data(data: dict[str, Any], select_related: dict[tuple[str, Address, str], Any] | None = ...) -> dict[str, Any]: ...
    def _build_query_statement(self, select_related: dict[tuple[str, Address, str], Any] | None = ..., *, is_count: bool = ...) -> glue.QueryStatement: ...
    def _build_joins(self, parent_alias: str, select_related: dict[tuple[str, Address, str], Any] | None) -> list[glue.JoinQuery] | None: ...
    def _build_only(self, select_related: dict[tuple[str, Address, str], Any] | None) -> list[glue.FieldReference] | None: ...
    def _build_joined_only(self, current_address: Address, select_related: dict[tuple[str, Address, str], Any]) -> list[glue.FieldReference]: ...
    def _build_nested_only(self, select_related: dict[tuple[str, Address, str], Any]) -> list[glue.FieldReferenceAliased]: ...
    def _build_conditions(self, conditions: Q | None, *, is_lakehouse: bool = ...) -> glue.Conditions | None: ...
    @staticmethod
