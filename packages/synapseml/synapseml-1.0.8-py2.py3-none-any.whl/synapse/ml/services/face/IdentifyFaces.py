...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="IdentifyFaces_3d7f269babd5_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_3d7f269babd5_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_3d7f269babd5_error")
        self._setDefault(outputCol="IdentifyFaces_3d7f269babd5_output")
