...
class WeblinxTasks:
    ...
    def reset(
        ...
        extra_properties = preprocess_extra_props(extra_properties, min_area=50, max_area=500_000)
        remove_overlapping_bboxes(extra_properties, inplace=True, iou_threshold=0.75)
