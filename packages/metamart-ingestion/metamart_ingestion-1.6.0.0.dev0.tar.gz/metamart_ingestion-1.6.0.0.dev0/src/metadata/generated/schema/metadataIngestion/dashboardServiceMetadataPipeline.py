...
class DashboardServiceMetadataPipeline(BaseModel):
    ...
    markDeletedDashboards: Annotated[
        ...
        Field(
            True,
            description='Optional configuration to soft delete dashboards in MetaMart if the source dashboards are deleted. Also, if the dashboard is deleted, all the associated entities like lineage, etc., with that dashboard will be deleted',
    ...
    markDeletedDataModels: Annotated[
        ...
        Field(
            True,
            description='Optional configuration to soft delete data models in MetaMart if the source data models are deleted. Also, if the data models is deleted, all the associated entities like lineage, etc., with that data models will be deleted',
    ...
    overrideMetadata: Annotated[
        ...
        Field(
            False,
            description="Set the 'Override Metadata' toggle to control whether to override the existing metadata in the MetaMart server with the metadata fetched from the source. If the toggle is set to true, the metadata fetched from the source will override the existing metadata in the MetaMart server. If the toggle is set to false, the metadata fetched from the source will not override the existing metadata in the MetaMart server. This is applicable for fields like description, tags, owner and displayName",
