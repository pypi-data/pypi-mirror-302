...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_480ab4667a2e_error",
        ...
        maxTokens=None,
        maxTokensCol=None,
        messagesCol="OpenAIPrompt_480ab4667a2e_messages",
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_480ab4667a2e_output",
        postProcessing="",
        ...
        self._setDefault(errorCol="OpenAIPrompt_480ab4667a2e_error")
        self._setDefault(messagesCol="OpenAIPrompt_480ab4667a2e_messages")
        self._setDefault(outputCol="OpenAIPrompt_480ab4667a2e_output")
