        ...
        try:
            ...
            while True:
                try:
                    ...
                    count += 1
                    if count >= retry:
                        raise SonusAIError("speech_recognition exception: ValueError retry count exceeded.") from None
            ...
            raise SonusAIError(f"Could not request results from Google Speech Recognition service: {e}") from e
