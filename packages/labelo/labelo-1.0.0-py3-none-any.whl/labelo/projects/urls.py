...
_api_urlpatterns = [
    ...
    path('bulk-delete/', api.BulkDeleteProjectsAPI.as_view(), name='bulk-delete-projects'),
    ...
    path('<int:pk>/members/', api.ProjectMemborsAPI.as_view(), name='project-members'),
    path('<int:pk>/get-users/', api.GetUsersAPI.as_view(), name='project-get-users'),
    # project duplicate
    path('<int:pk>/duplicate/', api.DuplicateProjectAPI.as_view(), name='duplicate-project'),
]
