...
def _arrow2756(__unit: None=None) -> Decoder_1[Any]:
    def decode(__unit: None=None) -> Decoder_1[Any]:
        ...
        def _arrow2754(value_7: int) -> Any:
            return value_7

        def _arrow2755(value_8: Decimal) -> Any:
            return value_8

        return one_of(of_array([map_1(_arrow2751, decode_object), map_1(_arrow2752, resize_array), map_1(_arrow2753, string), map_1(_arrow2754, int_1), map_1(_arrow2755, decimal)]))

    return decode(None)


decoder: Decoder_1[Any] = _arrow2756()
