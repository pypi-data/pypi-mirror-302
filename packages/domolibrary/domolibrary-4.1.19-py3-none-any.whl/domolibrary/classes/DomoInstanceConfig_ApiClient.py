# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/classes/50_DomoInsanceConfig_Client.ipynb.

# %% auto 0
__all__ = ['ApiClient', 'ApiClients']

# %% ../../nbs/classes/50_DomoInsanceConfig_Client.ipynb 2
...
# %% ../../nbs/classes/50_DomoInsanceConfig_Client.ipynb 3
...
# %% ../../nbs/classes/50_DomoInsanceConfig_Client.ipynb 6
@dataclass
class ApiClient:
...
# %% ../../nbs/classes/50_DomoInsanceConfig_Client.ipynb 7
@dataclass
class ApiClients:
    auth: dmda.DomoAuth
    ...
    async def get_by_name(
        ...
        return next(
            (
                domo_client
                for domo_client in self.domo_clients
                if domo_client.name == client_name
            )
        )

# %% ../../nbs/classes/50_DomoInsanceConfig_Client.ipynb 11
@patch_to(ApiClients)
