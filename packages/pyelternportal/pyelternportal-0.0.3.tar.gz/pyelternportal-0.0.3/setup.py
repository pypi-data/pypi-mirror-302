...
setup(
    ...
    description="Python client library to retrieve data provided by eltern-portal.org",
    ...
    # This field is OPTIONAL
    url="https://github.com/michull/pyelternportal",

    # The author name and email fields are self explanatory.
    # These fields are OPTIONAL
    #author_name="michull",
    #author_email="michull@github.com",
    ...
    # This field is OPTIONAL
    keywords="api elternportal homeassistant",
