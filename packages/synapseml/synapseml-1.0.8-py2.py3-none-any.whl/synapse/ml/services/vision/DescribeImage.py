...
class DescribeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DescribeImage_b4e9731d78e6_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        outputCol="DescribeImage_b4e9731d78e6_output",
        ...
        self._setDefault(errorCol="DescribeImage_b4e9731d78e6_error")
        self._setDefault(outputCol="DescribeImage_b4e9731d78e6_output")
