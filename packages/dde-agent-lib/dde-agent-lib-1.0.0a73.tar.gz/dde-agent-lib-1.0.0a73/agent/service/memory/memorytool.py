...
class MemoryService:
    ...
    def retrieve_complete_memory_without_discard_keyword(self, session_id: str, max_round: int = 20, max_length: int = 4000, remove_current_chat: bool = True, rag_switch: bool = False):
        '''
