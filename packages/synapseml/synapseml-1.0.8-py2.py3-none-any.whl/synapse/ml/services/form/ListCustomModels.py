...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ListCustomModels_89abcf2a3019_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_89abcf2a3019_output",
        ...
        self._setDefault(errorCol="ListCustomModels_89abcf2a3019_error")
        self._setDefault(outputCol="ListCustomModels_89abcf2a3019_output")
