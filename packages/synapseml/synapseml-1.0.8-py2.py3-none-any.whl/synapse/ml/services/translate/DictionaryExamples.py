...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryExamples_6d90ee31c33c_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_6d90ee31c33c_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_6d90ee31c33c_error")
        self._setDefault(outputCol="DictionaryExamples_6d90ee31c33c_output")
