...
URLS: Dict[PipelineType, str] = {
    PipelineType.metadata: "https://docs.meta-mart.org/connectors/ingestion/workflows/metadata",
    PipelineType.profiler: "https://docs.meta-mart.org/connectors/ingestion/workflows/profiler",
    PipelineType.TestSuite: "https://docs.meta-mart.org/connectors/ingestion/workflows/data-quality",
    PipelineType.lineage: "https://docs.meta-mart.org/connectors/ingestion/workflows/lineage",
    PipelineType.usage: "https://docs.meta-mart.org/connectors/ingestion/workflows/usage",
    PipelineType.dbt: "https://docs.meta-mart.org/connectors/ingestion/workflows/dbt",
}
...
class WorkflowInitErrorHandler:
    ...
    def _print_more_info(pipeline_type: PipelineType) -> None:
        ...
        log_ansi_encoded_string(
            ...
            + "\nOr join us in Slack: https://slack.meta-mart.org/"
        )
