...
def _arrow1555(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1548()), ("arc", ObjectExpr1549()), ("CreativeWork", ObjectExpr1550()), ("about", ObjectExpr1551()), ("conformsTo", ObjectExpr1553())])
