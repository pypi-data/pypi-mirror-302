    ...
    *
    ...
    def __init__(self, channel):
        ...
        self.Send = channel.unary_unary(
                '/rbt.thirdparty.mailgun.v1.MessageInterface/Send',
        ...
        self.SendTask = channel.unary_unary(
                '/rbt.thirdparty.mailgun.v1.MessageInterface/SendTask',
...
def add_MessageInterfaceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'rbt.thirdparty.mailgun.v1.MessageInterface', rpc_method_handlers)
...
class MessageInterface(object):
    ...
    *
    ...
    def Send(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rbt.thirdparty.mailgun.v1.MessageInterface/Send',
    ...
    def SendTask(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/rbt.thirdparty.mailgun.v1.MessageInterface/SendTask',
