                                    ...
                                    <table bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0" width="100%" style="box-sizing:border-box;max-width:420px;width:100%">
                                        ...
                                        <tr>
                                            <td align="center" style="padding: 20px 0 0 0">
                                                <img src="{email_icon_url}" alt="icon_email">
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 40px 0" align="right">
                                                <a href="https://www.facebook.com/thezonesmart" style="text-decoration: none; margin: 0 2px">
                                                    <img src="https://storage.yandexcloud.net/zs-static/email/sn_icons/facebook-icon.png" alt="facebook">
                                                </a>
                                                <a href="https://www.instagram.com/zonesmart.ru/" style="text-decoration: none; margin: 0 2px">
                                                    <img src="https://storage.yandexcloud.net/zs-static/email/sn_icons/instagram-icon.png" alt="instagram">
                                                </a>
                                                <a href="https://www.linkedin.com/company/zonesmart/" style="text-decoration: none; margin: 0 2px">
                                                    <img src="https://storage.yandexcloud.net/zs-static/email/sn_icons/linkedin-icon.png" alt="linkedin">
                                                </a>
                                                <a href="https://www.youtube.com/channel/UCYV_W03i-Ygoh_6-ENW-33Q" style="text-decoration: none; margin: 0 2px">
                                                    <img src="https://storage.yandexcloud.net/zs-static/email/sn_icons/youtube-icon.png" alt="youtube">
                                                </a>
                                            </td>
                                        </tr>
                                        <tr>
