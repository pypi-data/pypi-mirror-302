...
# Lowest supported version of scikit-learn
SCIKIT_LEARN_LOWEST_SUPPORTED_VERSION = "1.1.3"
...
class MLFlowMetaLiterals:
    """Constants related to MLFlow metdata."""

    BASE_MODEL_NAME = "base_model_name"
    IS_AUTOML_MODEL = "is_automl_model"
...
class Dependencies:
    ...
    PACKAGE_REPLACEMENT_LIST = {
        'en-core-web-sm': 'https://aka.ms/automl-resources/packages/en_core_web_sm-3.4.1.tar.gz'
    }

    CONDA_CHANNELS_LIST = ['conda-forge', 'anaconda', 'cerebis', 'pytorch', 'nvidia']
