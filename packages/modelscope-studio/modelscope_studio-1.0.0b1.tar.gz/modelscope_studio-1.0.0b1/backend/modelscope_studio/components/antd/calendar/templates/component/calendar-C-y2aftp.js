import { g as re, w as R } from "./Index-NjY-NGP9.js";
  ...
  return {
    ...
    l(s) {
      n = Q(s, "REACT-PORTAL-TARGET", {
        class: !0
      }), Y(n).forEach(b), o = _e(s), e && e.l(s), l = G(), this.h();
    },
    h() {
      Z(n, "class", "svelte-1rt0kpf");
    },
    ...
    p(s, [a]) {
      ...
      16 && O(e, 1)) : (e = V(s), e.c(), O(e, 1), e.m(l.parentNode, l)) : e && (ye(), P(e, 1, 1, () => {
        e = null;
      }), fe());
    },
    i(s) {
    ...
    d(s) {
      s && (b(n), b(o), b(l)), t[8](null), e && e.d(s);
    }
  };
}
function H(t) {
  ...
  return ne(() => {
    ...
    if (n && window.MutationObserver) {
      let c = function() {
        ...
        i = _, a(d), i.style.display = "contents", h(), (y = e.current) == null || y.appendChild(i);
      };
...
const Me = Le(({
  ...
  const _ = v(t), y = v(h), I = v(f), S = v(p), k = E(() => n ? A(n) : void 0, [n]), L = E(() => o ? A(o) : void 0, [o]), u = E(() => Array.isArray(l) ? l.map((m) => A(m)) : void 0, [l]);
  return /* @__PURE__ */ J.jsx(oe, {
    ...
    onChange: (m, ...g) => {
      a(m.valueOf() / 1e3), r == null || r(m.valueOf() / 1e3, ...g);
    },
    onPanelChange: (m, ...g) => {
      e == null || e(m.valueOf() / 1e3, ...g);
    },
    onSelect: (m, ...g) => {
      s == null || s(m.valueOf() / 1e3, ...g);
    }
  });
});
export {
