...
class Job(_message.Message):
    __slots__ = ["feeder", "scenarios", "years", "commonConfig", "generatorConfig", "executorConfig", "resultProcessorConfig"]
    ...
    def __init__(self, feeder: _Optional[str] = ..., scenarios: _Optional[_Iterable[str]] = ..., years: _Optional[_Iterable[int]] = ..., commonConfig: _Optional[str] = ..., generatorConfig: _Optional[str] = ..., executorConfig: _Optional[str] = ..., resultProcessorConfig: _Optional[str] = ...) -> None: ...
