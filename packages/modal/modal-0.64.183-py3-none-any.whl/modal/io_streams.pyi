...
class _StreamReader:
    ...
    def _get_logs(self) -> typing.AsyncIterator[typing.Optional[modal_proto.api_pb2.TaskLogs]]: ...
    def __aiter__(self): ...
...
class StreamReader:
    ...
    class ___get_logs_spec(typing_extensions.Protocol):
        def __call__(self) -> typing.Iterator[typing.Optional[modal_proto.api_pb2.TaskLogs]]: ...
        def aio(self) -> typing.AsyncIterator[typing.Optional[modal_proto.api_pb2.TaskLogs]]: ...
