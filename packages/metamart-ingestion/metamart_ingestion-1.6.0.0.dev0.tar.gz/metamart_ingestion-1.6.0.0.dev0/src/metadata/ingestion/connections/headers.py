...
def render_query_header(ometa_version: str) -> str:
    """
    Render the query header for MetaMart Queries
    """

    header_obj = {"app": "MetaMart", "version": ometa_version}
...
def _(_, conn, cursor, statement, parameters, context, executemany):
    ...
    """
    version = pkg_resources.require("metamart-ingestion")[0].version
...
def inject_query_header(
    ...
    """
    Inject the query header for MetaMart Queries
    """
