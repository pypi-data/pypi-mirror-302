...
class Bunch6dT(object):
    ...
    get_total_N = _swig_new_instance_method(_RF_Track.Bunch6dT_get_total_N)
...
class Bunch6d(object):
    ...
    get_total_N = _swig_new_instance_method(_RF_Track.Bunch6d_get_total_N)
