...
class DatabricksConnection(BaseModel):
    ...
    catalog: Annotated[
        ...
        Field(
            None,
            description='Catalog of the data source(Example: hive_metastore). This is optional parameter, if you would like to restrict the metadata reading to a single catalog. When left blank, MetaMart Ingestion attempts to scan all the catalog.',
            title='Catalog',
        ),
    ]
