...
class ConcatenateClipsArgs:
    ...
    def __init__(self, deviceID: int, deviceName: str, startEpoch: int, endEpoch: int, uploadURL: str, postbackURL: str, videoClipIDs: list):
        self.deviceID = deviceID
        self.deviceName = deviceName
        ...
        self.videoClipIDs = videoClipIDs


class ConferenceArgs:

    def __init__(self, url: str, roomName: str, displayName: str, videoWidth: int = 1280, videoHeight: int = 720, framerate: int = 30, videoBitrate: int = 1000000, sendVideo: bool = True, sendAudio: bool = True, receiveVideo: bool = True, receiveAudio: bool = True):
        self.url = url
