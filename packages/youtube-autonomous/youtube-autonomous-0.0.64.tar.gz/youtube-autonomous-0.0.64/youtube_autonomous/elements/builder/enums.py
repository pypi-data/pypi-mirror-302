...
from yta_multimedia.video.generation.manim.classes.video.test_video_manim_animation import TestVideoMobjectIn2DManimAnimation
...
class Premade(Enum):
    ...
    TEST_3D = TestVideoMobjectIn2DManimAnimation
