...
class StorageServiceMetadataPipeline(BaseModel):
    ...
    markDeletedContainers: Annotated[
        ...
        Field(
            True,
            description='Optional configuration to soft delete containers in MetaMart if the source containers are deleted. Also, if the topic is deleted, all the associated entities with that containers will be deleted',
