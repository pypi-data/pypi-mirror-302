        ...
        with open(uploadFile.path, "rb") as f:
            picture_response = client.post(
                ...
                timeout=httpx.Timeout(
                    connect=REQUESTS_CNX_TIMEOUT, read=uploadTimeout, write=5, pool=5
                ),
            )
...
def complete_upload_set(gvs: Panoramax, client: httpx.Client, uploadSet: UploadSet):
...
def _login_if_needed(client: httpx.Client, panoramax: Panoramax) -> bool:
