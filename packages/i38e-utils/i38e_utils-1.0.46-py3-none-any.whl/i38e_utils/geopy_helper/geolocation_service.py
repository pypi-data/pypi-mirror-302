...
ibis_nominatim_url = os.environ.get('IBIS_NOMINATIM_URL', None)
ibis_geolocator_test_place = os.environ.get('IBIS_GEOLOCATOR_TEST_PLACE', "San Jose, Costa Rica")
...
class GeolocationService:
    ...
    def _initialize_geolocator(self):
        nominatim_url = ibis_nominatim_url
        ...
        try:
            ...
            location = self.geolocator.geocode(ibis_geolocator_test_place)
            if location:
                if self.debug:
