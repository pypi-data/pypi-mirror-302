...
IContext_reflection = _expr1476

def _arrow1490(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1477()), ("bio", ObjectExpr1478()), ("Protocol", ObjectExpr1479()), ("name", ObjectExpr1480()), ("protocolType", ObjectExpr1481()), ("description", ObjectExpr1482()), ("version", ObjectExpr1483()), ("components", ObjectExpr1484()), ("reagents", ObjectExpr1485()), ("computationalTools", ObjectExpr1486()), ("uri", ObjectExpr1487()), ("comments", ObjectExpr1488())])
    ...
    return ObjectExpr1489()


context_jsonvalue: IEncodable = _arrow1490()
