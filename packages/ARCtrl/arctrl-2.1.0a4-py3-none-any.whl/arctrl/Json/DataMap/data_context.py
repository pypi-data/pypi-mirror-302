...
def encoder(dc: DataContext) -> IEncodable:
    ...
    def _arrow2391(oa: OntologyAnnotation, dc: Any=dc) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2394(oa_1: OntologyAnnotation, dc: Any=dc) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2397(oa_2: OntologyAnnotation, dc: Any=dc) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2399(value: str, dc: Any=dc) -> IEncodable:
    ...
    def _arrow2405(value_2: str, dc: Any=dc) -> IEncodable:
    ...
    def _arrow2410(value_4: str, dc: Any=dc) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("data", encoder_1(dc)), try_include("explication", _arrow2391, DataContext__get_Explication(dc)), try_include("unit", _arrow2394, DataContext__get_Unit(dc)), try_include("objectType", _arrow2397, DataContext__get_ObjectType(dc)), try_include("description", _arrow2399, DataContext__get_Description(dc)), try_include("generatedBy", _arrow2405, DataContext__get_GeneratedBy(dc)), try_include("label", _arrow2410, DataContext__get_Label(dc))]))
...
def _arrow2434(get: IGetters) -> DataContext:
    data: Data
    ...
    def _arrow2430(__unit: None=None) -> str | None:
    ...
    return DataContext__ctor_Z780A8A2A(data.ID, data.Name, data.DataType, data.Format, data.SelectorFormat, _arrow2424(), _arrow2427(), _arrow2428(), _arrow2430(), _arrow2432(), _arrow2433(), data.Comments)


decoder: Decoder_1[DataContext] = object(_arrow2434)
