...
def OntologyAnnotation_encoder(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1612(value: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1614(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1616(value_4: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr1615(IEncodable):
            def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
                return helpers_2.encode_string(value_4)

        return ObjectExpr1615()

    def _arrow1617(comment: Comment, oa: Any=oa) -> IEncodable:
        return encoder(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("annotationValue", _arrow1612, oa.Name), try_include("termSource", _arrow1614, oa.TermSourceREF), try_include("termAccession", _arrow1616, oa.TermAccessionNumber), try_include_seq("comments", _arrow1617, oa.Comments)]))
    ...
    return ObjectExpr1618()


def _arrow1623(get: IGetters) -> OntologyAnnotation:
    ...
    return OntologyAnnotation.create(_arrow1619(), _arrow1620(), _arrow1621(), _arrow1622())


OntologyAnnotation_decoder: Decoder_1[OntologyAnnotation] = object(_arrow1623)
...
def OntologyAnnotation_compressedEncoder(string_table: Any, oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1625(s: str, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encode_string(string_table, s)

    def _arrow1626(s_1: str, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encode_string(string_table, s_1)

    def _arrow1627(s_2: str, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encode_string(string_table, s_2)

    def _arrow1628(comment: Comment, string_table: Any=string_table, oa: Any=oa) -> IEncodable:
        return encoder(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("a", _arrow1625, oa.Name), try_include("ts", _arrow1626, oa.TermSourceREF), try_include("ta", _arrow1627, oa.TermAccessionNumber), try_include_seq("comments", _arrow1628, oa.Comments)]))
    ...
    return ObjectExpr1629()


def OntologyAnnotation_compressedDecoder(string_table: Array[str]) -> Decoder_1[OntologyAnnotation]:
    def _arrow1634(get: IGetters, string_table: Any=string_table) -> OntologyAnnotation:
        ...
        def _arrow1633(__unit: None=None) -> Array[Comment] | None:
            arg_7: Decoder_1[Array[Comment]] = resize_array(decoder)
            object_arg_3: IOptionalGetter = get.Optional
            return object_arg_3.Field("comments", arg_7)

        return OntologyAnnotation(_arrow1630(), _arrow1631(), _arrow1632(), _arrow1633())

    return object(_arrow1634)
...
def OntologyAnnotation_ROCrate_encoderDefinedTerm(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1638(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1641(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1643(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1645(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1646(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1638()), ("@type", ObjectExpr1639()), try_include("annotationValue", _arrow1641, oa.Name), try_include("termSource", _arrow1643, oa.TermSourceREF), try_include("termAccession", _arrow1645, oa.TermAccessionNumber), try_include_seq("comments", _arrow1646, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow1652(get: IGetters) -> OntologyAnnotation:
    def _arrow1648(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("annotationValue", AnnotationValue_decoder)
    ...
    def _arrow1651(__unit: None=None) -> Array[Comment] | None:
        arg_7: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("comments", arg_7)

    return OntologyAnnotation.create(_arrow1648(), _arrow1649(), _arrow1650(), _arrow1651())


OntologyAnnotation_ROCrate_decoderDefinedTerm: Decoder_1[OntologyAnnotation] = object(_arrow1652)
...
def OntologyAnnotation_ROCrate_encoderPropertyValue(oa: OntologyAnnotation) -> IEncodable:
    ...
    def _arrow1656(__unit: None=None, oa: Any=oa) -> IEncodable:
        value: str = OntologyAnnotation_ROCrate_genID(oa)
    ...
    def _arrow1659(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1661(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow1662(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1656()), ("@type", ObjectExpr1657()), try_include("category", _arrow1659, oa.Name), try_include("categoryCode", _arrow1661, oa.TermAccessionNumber), try_include_seq("comments", _arrow1662, oa.Comments), ("@context", context_jsonvalue_1)]))
    ...
    return ObjectExpr1663()


def _arrow1667(get: IGetters) -> OntologyAnnotation:
    ...
    def _arrow1666(__unit: None=None) -> Array[Comment] | None:
    ...
    return OntologyAnnotation.create(_arrow1664(), None, _arrow1665(), _arrow1666())


OntologyAnnotation_ROCrate_decoderPropertyValue: Decoder_1[OntologyAnnotation] = object(_arrow1667)
...
def OntologyAnnotation_ISAJson_encoder(id_map: Any | None, oa: OntologyAnnotation) -> IEncodable:
    def f(oa_1: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow1671(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1673(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1675(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1677(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow1678(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return encoder(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1671, OntologyAnnotation_ROCrate_genID(oa_1)), try_include("annotationValue", _arrow1673, oa_1.Name), try_include("termSource", _arrow1675, oa_1.TermSourceREF), try_include("termAccession", _arrow1677, oa_1.TermAccessionNumber), try_include_seq("comments", _arrow1678, comments)]))
        ...
        return ObjectExpr1679()

    if id_map is not None:
        def _arrow1680(o: OntologyAnnotation, id_map: Any=id_map, oa: Any=oa) -> str:
            return OntologyAnnotation_ROCrate_genID(o)

        return encode(_arrow1680, f, oa, id_map)
