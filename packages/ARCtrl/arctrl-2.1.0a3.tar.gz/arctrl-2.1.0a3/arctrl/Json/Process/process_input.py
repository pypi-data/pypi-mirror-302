...
def _arrow2234(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2235(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2236(Item_2: Data) -> ProcessInput:
...
ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2234, ROCrate_decoder_1), map(_arrow2235, ROCrate_decoder_2), map(_arrow2236, ROCrate_decoder_3), map(_arrow2239, ROCrate_decoder_4)]))
...
def _arrow2244(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2246(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2248(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2251(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2244, ISAJson_decoder_1), map(_arrow2246, ISAJson_decoder_2), map(_arrow2248, ISAJson_decoder_3), map(_arrow2251, ISAJson_decoder_4)]))
