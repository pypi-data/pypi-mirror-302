<template>
  <div class="w-full h-full flex flex-col gap-2">
    ...
    <div class="compliance-step bg-white w-full border border-transparent rounded-md">
      ...
      <div class="compliance-step-content-divider py-[0.5rem] px-[0.75rem] uppercase">
        Aircraft Recent Destinations
      </div>
      <div class="compliance-step-content w-full flex flex-col">
        <div
          v-for="(el, destinationId) in mockDestinations"
          :key="destinationId"
          class="compliance-step-content-destination-el flex w-full py-5 px-[0.75rem]"
        >
      ...
      <div class="compliance-step-content w-full flex flex-col">
        <div
          ...
          :key="activity.date"
          class="compliance-step-content-activity border-0 rounded-lg pl-[0.75rem] flex"
        >
...
const mockActivity = [
  {
    ...
    description:
      'Admin Edit Session: End. A really long message there to show the correct expansion of the element on the side. This element should be way bigger then the other.'
  },
...
const { callFetch: fetchCompliance } = useFetch<any, (order: any) => Promise<any>>(
  async (order: any) => {
