...
class AddDocuments(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="AddDocuments_10da52055ad3_error",
        handler=None,
        indexName=None,
        outputCol="AddDocuments_10da52055ad3_output",
        serviceName=None,
        ...
        self._setDefault(errorCol="AddDocuments_10da52055ad3_error")
        self._setDefault(outputCol="AddDocuments_10da52055ad3_output")
