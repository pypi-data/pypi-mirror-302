...
from moapy.data_pre import Point, Stress_Strain_Component, Length, enUnitLength
# ==== Concrete Material ====
...
class SlabSection(MBaseModel):
    ...
    Slab
    """
    thickness: Length = dataclass_field(default=Length(value=150.0, unit=enUnitLength.MM), title="Thick", description="Thickness")
