...
"""
MetaMart is the high level Python API that serves as a wrapper
...
working with MetaMart entities.
"""
import traceback
...
class MetaMart(
    ...
    """
    Generic interface to the MetaMart API
    ...
    client: REST
    _auth_provider: MetaMartAuthenticationProvider
    config: MetaMartConnection
    ...
    def __init__(
        ...
        self._auth_provider = MetaMartAuthenticationProvider.create(self.config)
