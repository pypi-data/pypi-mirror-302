...
class PipelineServiceMetadataPipeline(BaseModel):
    ...
    markDeletedPipelines: Annotated[
        ...
        Field(
            True,
            description='Optional configuration to soft delete Pipelines in MetaMart if the source Pipelines are deleted. Also, if the Pipeline is deleted, all the associated entities like lineage, etc., with that Pipeline will be deleted',
