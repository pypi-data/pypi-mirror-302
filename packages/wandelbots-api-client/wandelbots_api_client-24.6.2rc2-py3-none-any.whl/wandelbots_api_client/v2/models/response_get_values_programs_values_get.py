...
RESPONSEGETVALUESPROGRAMSVALUESGET_ANY_OF_SCHEMAS = ["ArrayOutput", "Capture", "PointCloud", "PyjectoryDatatypesSerializerOrientation", "PyjectoryDatatypesSerializerPose", "PyjectoryDatatypesSerializerPosition", "bytearray", "float", "int", "str"]

class ResponseGetValuesProgramsValuesGet(BaseModel):
    """
    ...
    # data type: bytearray
    anyof_schema_4_validator: Optional[Union[StrictBytes, StrictStr]] = None
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ResponseGetValuesProgramsValuesGet.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ResponseGetValuesProgramsValuesGet with anyOf schemas: ArrayOutput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ResponseGetValuesProgramsValuesGet with anyOf schemas: ArrayOutput, Capture, PointCloud, PyjectoryDatatypesSerializerOrientation, PyjectoryDatatypesSerializerPose, PyjectoryDatatypesSerializerPosition, bytearray, float, int, str. Details: " + ", ".join(error_messages))
        else:
            return instance
...
ResponseGetValuesProgramsValuesGet.model_rebuild(raise_errors=False)
