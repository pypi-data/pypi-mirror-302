...
from ..models.committee_de_registration_cred_type import CommitteeDeRegistrationCredType
from ..types import UNSET, Unset

T = TypeVar("T", bound="CommitteeDeRegistration")


@_attrs_define
class CommitteeDeRegistration:
    """
    Attributes:
        ...
        cred_type (Union[Unset, CommitteeDeRegistrationCredType]):
    ...
    cred_type: Union[Unset, CommitteeDeRegistrationCredType] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_cred_type, Unset):
            ...
            cred_type = CommitteeDeRegistrationCredType(_cred_type)

        epoch = d.pop("epoch", UNSET)

        committee_de_registration = cls(
        ...
        committee_de_registration.additional_properties = d
        return committee_de_registration
