        ...
        try:
            if Config.sca_lang=="osv":
                ...
                if Config.sca_ignore:
                    ...
                    logging.info("SCA exclude file: ", Config.sca_exclude_files )
...
## custom script for zap auth scan automation
    ...
    if args.appToken is not None:
        ...
        logging.info(f"Found {Config.boman_config_file} config file and switching to CLI config")
    else:
        logging.error(f"The {Config.boman_config_file} file is not found and tokens were not found in cli arguments as well")
