...
class Calculation(_message.Message):
    __slots__ = ["column_dtype", "description", "expr", "name", "root", "tags"]
    class TagsEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: ClassVar[int]
        VALUE_FIELD_NUMBER: ClassVar[int]
    ...
    expr: str
    name: str
    root: _calculation_node__client_pb2.CalculationNode
    tags: _containers.ScalarMap[str, str]
    def __init__(self, name: Optional[str] = ..., expr: Optional[str] = ..., column_dtype: Optional[Union[_data_type__client_pb2.DataType, Mapping]] = ..., root: Optional[Union[_calculation_node__client_pb2.CalculationNode, Mapping]] = ..., description: Optional[str] = ..., tags: Optional[Mapping[str, str]] = ...) -> None: ...
...
class MaterializedFeatureViewArgs(_message.Message):
    __slots__ = ["aggregation_interval", "aggregation_leading_edge", "aggregation_secondary_key", "aggregations", "attributes", "batch_compute", "batch_schedule", "batch_trigger", "compaction_enabled", "data_source_type", "embeddings", "environment", "feature_start_time", "incremental_backfills", "inferences", "lifetime_start_time", "manual_trigger_backfill_end_time", "max_backfill_interval", "monitoring", "offline_store", "offline_store_legacy", "online_store", "output_stream", "run_transformation_validation", "schema", "secondary_key_output_columns", "serving_ttl", "stream_compute", "stream_processing_mode", "stream_tile_size", "stream_tiling_enabled", "tecton_materialization_runtime", "timestamp_field", "transform_server_group"]
...
class RealtimeArgs(_message.Message):
    ...
    ATTRIBUTES_FIELD_NUMBER: ClassVar[int]
    CALCULATIONS_FIELD_NUMBER: ClassVar[int]
    ...
    schema: _spark_schema__client_pb2.SparkSchema
    def __init__(self, schema: Optional[Union[_spark_schema__client_pb2.SparkSchema, Mapping]] = ..., environments: Optional[Iterable[str]] = ..., attributes: Optional[Iterable[Union[Attribute, Mapping]]] = ..., calculations: Optional[Iterable[Union[Calculation, Mapping]]] = ...) -> None: ...
