...
def encoder(comment: Comment) -> IEncodable:
    ...
    def _arrow1578(value: str, comment: Any=comment) -> IEncodable:
    ...
    def _arrow1580(value_2: str, comment: Any=comment) -> IEncodable:
        class ObjectExpr1579(IEncodable):
            def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                return helpers_1.encode_string(value_2)

        return ObjectExpr1579()

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("name", _arrow1578, comment.Name), try_include("value", _arrow1580, comment.Value)]))
    ...
    return ObjectExpr1581()


def _arrow1584(get: IGetters) -> Comment:
    def _arrow1582(__unit: None=None) -> str | None:
    ...
    return Comment(_arrow1582(), _arrow1583())


decoder: Decoder_1[Comment] = object(_arrow1584)
...
def ROCrate_encoder(comment: Comment) -> IEncodable:
    ...
    def _arrow1588(__unit: None=None, comment: Any=comment) -> IEncodable:
    ...
    def _arrow1591(value_2: str, comment: Any=comment) -> IEncodable:
    ...
    def _arrow1593(value_4: str, comment: Any=comment) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1588()), ("@type", ObjectExpr1589()), try_include("name", _arrow1591, comment.Name), try_include("value", _arrow1593, comment.Value), ("@context", context_jsonvalue)]))
...
def _arrow1597(get: IGetters) -> Comment:
    def _arrow1595(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)
    ...
    return Comment(_arrow1595(), _arrow1596())


ROCrate_decoder: Decoder_1[Comment] = object(_arrow1597)
...
def ISAJson_encoder(id_map: Any | None, comment: Comment) -> IEncodable:
    def f(comment_1: Comment, id_map: Any=id_map, comment: Any=comment) -> IEncodable:
        ...
        def _arrow1602(value: str, comment_1: Any=comment_1) -> IEncodable:
            class ObjectExpr1601(IEncodable):
                def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                    return helpers.encode_string(value)

            return ObjectExpr1601()

        def _arrow1604(value_2: str, comment_1: Any=comment_1) -> IEncodable:
        ...
        def _arrow1606(value_4: str, comment_1: Any=comment_1) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1602, ROCrate_genID(comment_1)), try_include("name", _arrow1604, comment_1.Name), try_include("value", _arrow1606, comment_1.Value)]))
    ...
    if id_map is None:
        ...
        def _arrow1608(c: Comment, id_map: Any=id_map, comment: Any=comment) -> str:
            return ROCrate_genID(c)

        return encode(_arrow1608, f, comment, id_map)
