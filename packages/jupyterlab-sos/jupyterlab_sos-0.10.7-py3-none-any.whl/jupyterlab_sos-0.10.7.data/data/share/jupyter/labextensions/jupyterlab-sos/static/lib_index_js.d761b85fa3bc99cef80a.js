        ...
        context.sessionContext.ready.then(() => {
            ...
            void ((_b = (_a = context.sessionContext.session) === null || _a === void 0 ? void 0 : _a.kernel) === null || _b === void 0 ? void 0 : _b.info.then(kernel_info => {
                ...
                if (lang.name === 'sos') {
                    ...
                    (0,_selectors__WEBPACK_IMPORTED_MODULE_9__.markSoSNotebookPanel)(panel.node, true);
                }
                else {
                    (0,_selectors__WEBPACK_IMPORTED_MODULE_9__.markSoSNotebookPanel)(panel.node, false);
                }
            }));
        });
...
/* harmony export */   markSoSNotebookPanel: () => (/* binding */ markSoSNotebookPanel),
...
function markSoSNotebookPanel(panel, is_sos) {
    if (is_sos) {
...
.jp-NotebookPanel.jp-SoSNotebook .jp-CelllanguageDropDown {
  display: block;
}
...
//# sourceMappingURL=lib_index_js.d761b85fa3bc99cef80a.js.map