...
"""
"""
Django Base settings for Labelo.
...
from labelo.core.utils.params import get_bool_env, get_env_list
from .custom_settings import CUSTOM_APPS
...
LOGGING = {
    ...
    'formatters': {
        'json': {
            '()': 'labelo.core.utils.formatter.CustomJsonFormatter',
...
from labelo.core.utils.io import get_data_dir
from labelo.core.utils.params import get_bool_env, get_env
...
DJANGO_DB = 'default'
DATABASE_NAME_DEFAULT = os.path.join(BASE_DATA_DIR, 'labelo.sqlite3')
...
DATABASES_ALL = {
    ...
    DJANGO_DB_MYSQL: {
        ...
        'NAME': get_env('MYSQL_NAME', 'labelo'),
...
SWAGGER_SETTINGS = {
    'SECURITY_DEFINITIONS': {
        'Token': {
            ...
            'You can find your user token on the User Account page in Labelo. Example: '
...
# Email backend
# FROM_EMAIL = get_env('FROM_EMAIL', 'Labelo <hello@labelo.ai>')
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "albertdemo888@gmail.com"
EMAIL_HOST_PASSWORD = "mvgn vola vpvd zeln"
...
# EDITOR = labelo-frontend repository
...
REACT_APP_ROOT = os.path.join(BASE_DIR, '../../web/dist/apps/labeloapp')
...
# Set the token expiry time to 24 hours (86400 seconds)
INVITATION_TOKEN_EXPIRY = 86400  # 24 hours in seconds
...
ACCOUNT_ACTIVATION = get_bool_env('ACCOUNT_ACTIVATION', False)
