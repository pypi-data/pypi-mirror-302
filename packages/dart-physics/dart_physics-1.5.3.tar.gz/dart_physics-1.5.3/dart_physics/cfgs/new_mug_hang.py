...
from utils.run_functions import * 
...
task_cfg = { 
    ...
    "default_poses": {
        "hanger": [0, 0.3, 0.05] + R.from_euler('xyz', [90, 0, 0], degrees = True).as_quat(scalar_first = True).tolist(), 
        "muggood": [0.1, 0.4, 0.15] + R.from_euler('xyz', [0, 0, 0], degrees = True).as_quat(scalar_first = True).tolist(), 
