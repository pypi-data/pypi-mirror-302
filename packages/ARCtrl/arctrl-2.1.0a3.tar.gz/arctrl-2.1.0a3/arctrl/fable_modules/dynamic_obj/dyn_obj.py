...
def with_property(property_name: str, property_value: Any, dyn_obj: DynamicObj) -> DynamicObj:
    set_property(property_name, property_value, dyn_obj)
    return dyn_obj
...
def with_optional_property(property_name: str, property_value: Any | None, dyn_obj: DynamicObj) -> DynamicObj:
    if property_value is None:
        return dyn_obj

    else: 
        return with_property(property_name, value_1(property_value), dyn_obj)
...
def with_optional_property_by(property_name: str, property_value: Any | None, mapping: Callable[[_TPROPERTYVALUE], _UPROPERTYVALUE], dyn_obj: DynamicObj) -> DynamicObj:
    if property_value is None:
        return dyn_obj

    else: 
        return with_property(property_name, mapping(value_1(property_value)), dyn_obj)
...
def without_property(property_name: str, dyn_obj: DynamicObj) -> DynamicObj:
    remove_property(property_name, dyn_obj)
    return dyn_obj
...
__all__ = ["of_dict", "of_seq", "of_list", "of_array", "combine", "set_property", "with_property", "set_optional_property", "with_optional_property", "set_optional_property_by", "with_optional_property_by", "try_get_property_value", "remove_property", "without_property", "format", "print"]
