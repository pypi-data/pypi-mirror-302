    ...
    def initial_setup(self, context_files, instructions, context, crawl_logs):
        ...
        prompt = f"""You are an expert software engineer. Follow these guidelines strictly when responding to instructions:
                ...
                **Response Guidelines:**
                ...
                6. MUST split into as small as possible SEARCH/REPLACE blocks as you can.

                7. CRITICAL: NEVER provide code snippets, suggestions, or examples outside of SEARCH/REPLACE blocks. ALL code must be within these blocks.

                8. Do not provide explanations, ask questions, or engage in discussions. Only return SEARCH/REPLACE blocks.

                9. If a request cannot be addressed solely through SEARCH/REPLACE blocks, do not respond.
    ...
    async def get_coding_request(self, file, techStack, prompt):
        ...
        if is_svg:
            ...
            user_prompt += (
                ...
                "- Ensure best practices for any integration needs during the development process.\n"
            )
        ...
        try:
            ...
            if content.endswith(">>>>>>> REPLACE"):
                ...
                if continuation_content.endswith(">>>>>>> REPLACE"):
                    ...
                    if continuation_content1.endswith(">>>>>>> REPLACE"):
                        # Combine the incomplete and continuation responses
