...
class DetectFace(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DetectFace_c11c73fd927b_error",
        handler=None,
        imageUrl=None,
        imageUrlCol=None,
        outputCol="DetectFace_c11c73fd927b_output",
        ...
        self._setDefault(errorCol="DetectFace_c11c73fd927b_error")
        self._setDefault(outputCol="DetectFace_c11c73fd927b_output")
