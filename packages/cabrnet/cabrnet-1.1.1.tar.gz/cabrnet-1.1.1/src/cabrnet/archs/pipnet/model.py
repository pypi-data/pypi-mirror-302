...
class PIPNet(CaBRNet):
    ...
    def train_epoch(
        ...
        r"""Trains a PIPNet model for one epoch, performing prototype projection and fine-tuning if necessary.
    ...
    def explain(
        ...
        **kwargs,
        ...
        for _ in range(num_closest):
            ...
            most_relevant_prototypes.append((proto_idx, score, True))  # PIPNet only considers positive similarities
