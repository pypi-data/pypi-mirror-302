...
setup(
  name = 'deep_learning_lab',         #* Your package will have this name
  packages = ['dl_lab'],   #* Name the package again
  ...
  description = 'This package can be used to get code for deep learning',    # Short description of your library
  author = 'anonymous',                   # Your name
  author_email = 'your.email@example.com',  # Your email
  url = 'https://example.com',              # Homepage of your library (e.g. github or your website)
  keywords = ["deep learning"],   # Keywords users can search on pypi.org
