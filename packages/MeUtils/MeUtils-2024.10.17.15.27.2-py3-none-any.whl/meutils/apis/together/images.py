...
async def generate(request: TogetherImageRequest, redirect_model: Optional[str] = None, api_key: Optional[str] = None):
...
e3c18de174dc0cf7bdabc6f68432085a613fdabd2b3c2ffb4f3ed216f9aab44e
    ...
    for api_key in api_keys:
        request = TogetherImageRequest(model="flux.1-xx", prompt="a dog", size="512x1024", n=4)
        print(request)
