...
class ModelClient:
    ...
    def publish(
        ...
        model_folder_path: Annotated[StrictStr, Field(description="Path to the folder containing model files")],
        model_framework_type: Annotated[StrictStr, Field(description="Framework type of the model (e.g., TensorFlow, PyTorch, ONNX)")],
        ...
        self.rest_client._stage_model_and_build_transformer(
            model_id, model_total_folder_size, model_framework_type, processor_image, host,
            headers=_header_params
        )
