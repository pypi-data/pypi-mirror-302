...
def get_uploadset_files(
    panoramax: Panoramax, client: httpx.Client, uploadSet: UploadSet
) -> UploadSet:
...
def info(panoramax: Panoramax, client: httpx.Client, uploadSet: UploadSet) -> UploadSet:
    if not uploadSet.id:
...
def display_upload_sets_statuses(
    panoramax: Panoramax, client: httpx.Client, uploadSets: List[UploadSet]
):
    table = Table()
