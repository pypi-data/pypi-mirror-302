...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GetCustomModel_628dba2ba217_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_628dba2ba217_output",
        ...
        self._setDefault(errorCol="GetCustomModel_628dba2ba217_error")
        self._setDefault(outputCol="GetCustomModel_628dba2ba217_output")
