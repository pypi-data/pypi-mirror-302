...
async def upload_task(file: bytes, token: Optional[str] = None):  ############################ 过期时间一个月真的吗
    access_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzNmE4NmM1Yzc2Y2Q0MTcyYTE5NGYxMjQwZTgyMmIwOSIsImV4cCI6MTcyODY5MzI4NiwibmJmIjoxNzI4NjA2ODg2LCJpYXQiOjE3Mjg2MDY4ODYsImp0aSI6ImU1ZGJhMTUyM2U5NzQwZDViODI4YzM3YTZlYjJmZmRlIiwidWlkIjoiNjQ0YTNkMGNiYTI1ODVlOTA0NjAzOWRiIiwidHlwZSI6ImFjY2VzcyJ9.JCTqTFkpInTke4CU9SkdUxlBDBu9Bq7Pn6Vuwb4ZfLI"
    # token = token or await get_next_token_for_polling(FEISHU_URL)
    # access_token = await get_access_token(token)
