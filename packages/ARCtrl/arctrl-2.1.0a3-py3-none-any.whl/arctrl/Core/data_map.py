...
def DataMap__GetExplicationColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow643(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_Explication(dc)

    return DataMapAux_getOntologyColumn(_arrow643, this.data_contexts_0040108)


def DataMap__SetExplicationColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow644(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Explication_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow644, cells, this.data_contexts_0040108)


def DataMap__GetUnitColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow645(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_Unit(dc)

    return DataMapAux_getOntologyColumn(_arrow645, this.data_contexts_0040108)


def DataMap__SetUnitColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow646(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Unit_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow646, cells, this.data_contexts_0040108)


def DataMap__GetObjectTypeColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow647(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_ObjectType(dc)

    return DataMapAux_getOntologyColumn(_arrow647, this.data_contexts_0040108)


def DataMap__SetDataTypeColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow648(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_ObjectType_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow648, cells, this.data_contexts_0040108)


def DataMap__GetLabelColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow649(dc: DataContext, this: Any=this) -> str | None:
        return dc.Name

    return DataMapAux_getStringColumn(_arrow649, this.data_contexts_0040108)


def DataMap__SetLabelColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow650(dc: DataContext, s: str | None=None, this: Any=this, cells: Any=cells) -> None:
        dc.Name = s

    DataMapAux_setStringColumn(_arrow650, cells, this.data_contexts_0040108)


def DataMap__GetDescriptionColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow651(dc: DataContext, this: Any=this) -> str | None:
        return DataContext__get_Description(dc)

    return DataMapAux_getStringColumn(_arrow651, this.data_contexts_0040108)


def DataMap__SetDescriptionColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow652(dc: DataContext, s: str | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Description_6DFDD678(dc, s)

    DataMapAux_setStringColumn(_arrow652, cells, this.data_contexts_0040108)
...
def DataMap_getDataContext_Z58338566(row: int, SkipValidation: Any | None=None) -> Callable[[DataMap], DataContext]:
    def _arrow653(dm: DataMap, row: Any=row, SkipValidation: Any=SkipValidation) -> DataContext:
