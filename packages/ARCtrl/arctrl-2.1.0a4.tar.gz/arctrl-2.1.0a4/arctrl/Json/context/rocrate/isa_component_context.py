...
IContext_reflection = _expr1314

def _arrow1324(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1315()), ("Component", ObjectExpr1316()), ("category", ObjectExpr1317()), ("categoryCode", ObjectExpr1318()), ("value", ObjectExpr1319()), ("valueCode", ObjectExpr1320()), ("unit", ObjectExpr1321()), ("unitCode", ObjectExpr1322())])
    ...
    return ObjectExpr1323()


context_jsonvalue: IEncodable = _arrow1324()
