...
class ContentFilterFinishReasonError(TelaError):
...
class EmptyFileError(TelaError):
    """Raised when the file is empty."""

    def __init__(self) -> None:
        super().__init__("File is empty. Please provide a valid file.")


class InvalidFileURL(TelaError):
    """Raised when the file URL is invalid."""

    def __init__(self) -> None:
        super().__init__("Invalid file URL. Please provide a valid file URL.")


class FileUploadError(TelaError):
    """Raised when the file upload fails."""

    def __init__(self) -> None:
        super().__init__("Failed to upload file. Please try again.")
