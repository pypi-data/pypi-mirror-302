...
class Calculation(_message.Message):
    __slots__ = ["description", "name", "root", "tags"]
    class TagsEntry(_message.Message):
        __slots__ = ["key", "value"]
        KEY_FIELD_NUMBER: ClassVar[int]
        VALUE_FIELD_NUMBER: ClassVar[int]
    ...
    tags: _containers.ScalarMap[str, str]
    def __init__(self, name: Optional[str] = ..., description: Optional[str] = ..., tags: Optional[Mapping[str, str]] = ..., root: Optional[Union[_calculation_node__client_pb2.CalculationNode, Mapping]] = ...) -> None: ...
...
class RealtimeFeatureView(_message.Message):
    ...
    def __init__(self, no_op: bool = ..., supported_environments: Optional[Iterable[Union[_realtime_compute__client_pb2.RemoteFunctionComputeConfig, Mapping]]] = ..., attributes: Optional[Iterable[Union[Attribute, Mapping]]] = ..., calculations: Optional[Iterable[Union[Calculation, Mapping]]] = ...) -> None: ...
