...
class DatasetPackageEditor(Viewer):
    ...
    def __init__(self, dataset, parameters, **params):
        ...
        self._layout = pn.Column(self.package, 
                                 ...
                                 pn.Row(self.bt_erase, self.bt_excel, self.bt_save, self.bt_delete, self.bt_remame, self.wnew_name),
    ...
    def on_stats(self, event):
        ...
        try:
            if not self.check_package():
                return
            cols = list(set(self.wtabulator.value.columns.to_list()) - set(self.param_column_stats.get_columns()))
