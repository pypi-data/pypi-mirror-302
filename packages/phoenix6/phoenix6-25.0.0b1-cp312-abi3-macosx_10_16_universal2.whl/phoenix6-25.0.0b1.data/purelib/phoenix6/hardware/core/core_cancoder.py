...
class CoreCANcoder(ParentDevice):
    ...
    def get_velocity(self, refresh: bool = True) -> StatusSignal[rotations_per_second]:
        ...
        """
        return self._common_lookup(SpnValue.CANCODER_VELOCITY.value, 0, None, "velocity", rotations_per_second, True, refresh)
    ...
    def get_position(self, refresh: bool = True) -> StatusSignal[rotation]:
        ...
        """
        return self._common_lookup(SpnValue.CANCODER_POSITION.value, 0, None, "position", rotation, True, refresh)
    ...
    def get_absolute_position(self, refresh: bool = True) -> StatusSignal[rotation]:
        ...
        :rtype: StatusSignal[rotation]
        """
        return self._common_lookup(SpnValue.CANCODER_ABS_POSITION.value, 0, None, "absolute_position", rotation, True, refresh)
    ...
    def get_unfiltered_velocity(self, refresh: bool = True) -> StatusSignal[rotations_per_second]:
        ...
        :rtype: StatusSignal[rotations_per_second]
        """
        return self._common_lookup(SpnValue.CANCODER_RAW_VEL.value, 0, None, "unfiltered_velocity", rotations_per_second, True, refresh)
    ...
    def get_position_since_boot(self, refresh: bool = True) -> StatusSignal[rotation]:
        ...
        :rtype: StatusSignal[rotation]
        """
        return self._common_lookup(SpnValue.CANCODER_RAW_POS.value, 0, None, "position_since_boot", rotation, True, refresh)
    ...
    def get_supply_voltage(self, refresh: bool = True) -> StatusSignal[volt]:
        ...
        """
        return self._common_lookup(SpnValue.CANCODER_SUPPLY_VOLTAGE.value, 0, None, "supply_voltage", volt, True, refresh)
    ...
    def get_magnet_health(self, refresh: bool = True) -> StatusSignal[MagnetHealthValue]:
        ...
        """
        return self._common_lookup(SpnValue.CANCODER_MAG_HEALTH.value, 0, None, "magnet_health", MagnetHealthValue, True, refresh)
    ...
    def get_fault_bad_magnet(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_CANCODER_BAD_MAGNET.value, 0, None, "fault_bad_magnet", bool, True, refresh)
    ...
    def get_sticky_fault_bad_magnet(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_CANCODER_BAD_MAGNET.value, 0, None, "sticky_fault_bad_magnet", bool, True, refresh)
