...
Welcome to `k8s-job-scheduler` contributor's guide.
...
If you experience bugs or general issues with `k8s-job-scheduler`, please have a look
...
You can help improve `k8s-job-scheduler` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`k8s-job-scheduler` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `k8s-job-scheduler`'s files. While this mechanism can
...
```
conda create -n k8s-job-scheduler python=3 six virtualenv pytest pytest-cov
conda activate k8s-job-scheduler
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/k8s-job-scheduler.git
   cd k8s-job-scheduler
   ```
...
5. Install [pre-commit]:
   ...
   `k8s-job-scheduler` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/k8s-job-scheduler
[issue tracker]: https://github.com/<USERNAME>/k8s-job-scheduler/issues
