# -*- coding: utf-8 -*-
"""volume discretization structure class
"""
import warnings
import copy
...
class StructDiscretized3D(StructBase):
    ...
    Defines the basic volume discretization, its polarizabilities and self-terms
    """
    ...
    def __init__(
        ...
        **kwargs
        ...
        Args:
            ...
            radiative_correction (bool, optional): Add radiative correction term for each meshcell. Defaults to False.
        ...
        """
        super().__init__(
            radiative_correction=radiative_correction, device=device, **kwargs
        )
    ...
    def convert_to_effective_polarizability_pair(
        ...
        **kwargs
        ...
        alpha = extract_effective_polarizability(
            struct=self,
    ...
    def plot3d(self, **kwargs):
        ...
        return visu3d.geo3d.structure(self, **kwargs)
...
def extract_effective_polarizability(
    struct,
    environment,
    wavelengths,
    ...
    Args:
        ...
        n_dipoles (_type_, optional): If given, use `n` dipole sources as illumination instead of plane waves. Defaults to None.
    ...
    # optional: multiple dipole illuminations
        ...
        rnd_pos = sample_spherical(n_dipoles, ndim=3) * r_sphere
        e_inc_list = [
            ElectricDipole(
                r_source=r_dp,
    ...
    for i_wl in tqdm(range(len(wavelengths)), progress_bar, title=""):
        ...
        for i_field, e_inc in enumerate(e_inc_list):
            e0 = e_inc.get_efield(r0.unsqueeze(0), wl, _sim.environment)
            e0_eval[i_field] = e0
            h0 = e_inc.get_hfield(r0.unsqueeze(0), wl, _sim.environment)
            h0_eval[i_field] = h0
...
if __name__ == "__main__":
    ...
    cs_f = sim_full.get_scs_spectra()
    cs_pm = sim_pEmH.get_scs_spectra()
    cs_66 = sim_6x6.get_scs_spectra()
    ...
    plt.show()
# %%
# print(sim_full.get_scs_spectra())
# print(sim_pEmH.get_scs_spectra())
# print(sim_6x6.get_scs_spectra())
