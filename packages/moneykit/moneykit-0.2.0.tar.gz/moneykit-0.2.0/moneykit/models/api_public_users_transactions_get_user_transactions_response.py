...
class ApiPublicUsersTransactionsGetUserTransactionsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["transactions", "accounts", "cursor"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ApiPublicUsersTransactionsGetUserTransactionsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ApiPublicUsersTransactionsGetUserTransactionsResponse from a dict"""
        if obj is None:
            return None
