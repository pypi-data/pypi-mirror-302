...
class PolicyObjectsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] category: Category of a policy object (one of: adaptivePolicy, network)
        :param pulumi.Input[str] cidr: CIDR Value of a policy object (e.g. 10.11.12.1/24")
        :param pulumi.Input[str] fqdn: Fully qualified domain name of policy object (e.g. "example.com")
        :param pulumi.Input[Sequence[pulumi.Input[str]]] group_ids: The IDs of policy object groups the policy object belongs to
        :param pulumi.Input[str] ip: IP Address of a policy object (e.g. "1.2.3.4")
        :param pulumi.Input[str] mask: Mask of a policy object (e.g. "255.255.0.0")
        :param pulumi.Input[str] name: Name of a policy object, unique within the organization (alphanumeric, space, dash, or underscore characters only)
        :param pulumi.Input[str] policy_object_id: policyObjectId path parameter. Policy object ID
        :param pulumi.Input[str] type: Type of a policy object (one of: adaptivePolicyIpv4Cidr, cidr, fqdn, ipAndMask)
        """
    ...
    def policy_object_id(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def policy_object_id(self, value: Optional[pulumi.Input[str]]):
...
class PolicyObjects(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_object_id: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None,
            updated_at: Optional[pulumi.Input[str]] = None) -> 'PolicyObjects':
        """
    ...
    @property
    @pulumi.getter(name="policyObjectId")
    def policy_object_id(self) -> pulumi.Output[str]:
        """
        policyObjectId path parameter. Policy object ID
        """
        return pulumi.get(self, "policy_object_id")
