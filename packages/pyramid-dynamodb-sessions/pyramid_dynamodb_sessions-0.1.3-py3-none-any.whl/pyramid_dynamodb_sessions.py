...
class DynamoDBSessionFactory:
    def __init__(
        ...
        The DynamoDB table must have a hash key ``sid`` of binary (B) type and
        a time-to-live on the ``exp`` attribute.

        :param table:  The DynamoDB table to use.  Can be a string or a boto3
            Table object.
        :type table:  ``str`` or ``Table``
        :param cookie_name:  The name of the cookie used to store the session
            ID.  Defaults to ``session_id``.
        :type cookie_name: str
        :param max_age:  The expiration time for the cookie in seconds.
        ...
        :type domain:  str
        :param secure:  If true, sets the ``secure`` flag for the cookie.
            Defaults to ``None``, which will set the flag if the request is
            made via HTTPS.
        :type secure:  bool
        :param httponly:  If true, hide the cookie from Javascript by setting
            the ``HttpOnly`` flag.  Defaults to true.
        :type httponly:  bool
