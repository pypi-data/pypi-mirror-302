...
def _main() -> None:
    ...
    misa_openai.http_client = http_client

    if args.organization:
        misa_openai.organization = args.organization

    if args.api_key:
        misa_openai.api_key = args.api_key

    if args.api_base:
        misa_openai.base_url = args.api_base

    # azure
    if args.api_type is not None:
        misa_openai.api_type = args.api_type

    if args.azure_endpoint is not None:
        misa_openai.azure_endpoint = args.azure_endpoint

    if args.api_version is not None:
        misa_openai.api_version = args.api_version

    if args.azure_ad_token is not None:
        misa_openai.azure_ad_token = args.azure_ad_token
