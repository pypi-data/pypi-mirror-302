...
def Annotation():
    ...
    def on_patch_size_changed(new_value, viewer, mask):
        # Callback pour mettre à jour la taille du cadre lorsque la taille du patch est modifiée.
        try:
            patch_size = int(new_value)
            afficher_cadre_patch(viewer, patch_size, mask)
        except ValueError:
    ...
    def annotation_widget(  # label_logo,
        ...
        annotation_widget.patch_size.changed.connect(
            lambda e: on_patch_size_changed(e, viewer, mask))
