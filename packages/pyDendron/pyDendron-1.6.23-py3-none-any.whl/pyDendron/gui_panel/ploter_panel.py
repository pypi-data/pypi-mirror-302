...
class PloterPanel(Viewer):
    ...
    def __init__(self, dataset, parameters, cfg_path, **params):
        ...
        self.dataset_package = DatasetPackage(dataset, parameters.column, parameters.package, 
                                                      parameters.detrend, parameters.chronology, name='', editable=True, orderable=True)
        ...
        self.bt_replot = pn.widgets.Button(name='Replot', icon='Refresh', button_type='primary', align=('start', 'center'), width=2*bt_size, description='Replot the package.' )
        self.bt_replot.on_click(self.on_replot)
    ...
    def load_cfg(self):
        ...
        try:
            ...
            logger.warning(f'ignore cfg ploter panel, version change.')
        finally:
            return ploter
