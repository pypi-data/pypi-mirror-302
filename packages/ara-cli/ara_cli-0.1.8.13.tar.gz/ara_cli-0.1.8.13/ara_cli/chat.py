...
Start chatting (type 'HELP'/'h' for available commands, 'QUIT'/'q' to exit chat mode):"""
    ...
    def load_text_file(self, file_name: str, prefix: str = "", suffix: str = "", block_delimiter: str = ""):
    ...
    def load_binary_file(self, file_name: str, mime_type: str, prefix: str = "", suffix: str = ""):
        import base64
        ...
        write_content = f"{prefix}![{file_name}](data:{mime_type};base64,{base64_image}){suffix}\n"
