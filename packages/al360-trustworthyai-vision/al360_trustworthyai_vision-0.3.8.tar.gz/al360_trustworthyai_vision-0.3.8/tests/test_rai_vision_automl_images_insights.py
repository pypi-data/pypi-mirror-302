...
from test_al360_tai_vision_insights import run_al360_tai_insights

from al360_trustworthyai_vision import ModelTask
...
class TestRAIVisionInsightsAutoMLImages(object):
    ...
    def test_al360_tai_insights_automl_image_classification_fridge(self):
