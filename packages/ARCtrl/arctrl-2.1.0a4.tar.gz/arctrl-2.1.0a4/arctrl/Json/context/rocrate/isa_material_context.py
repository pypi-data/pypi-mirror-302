...
IContext_reflection = _expr1395

def _arrow1403(__unit: None=None) -> IEncodable:
    class ObjectExpr1396(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1396()), ("bio", ObjectExpr1397()), ("Material", ObjectExpr1398()), ("type", ObjectExpr1399()), ("name", ObjectExpr1400()), ("characteristics", ObjectExpr1401())])
    ...
    return ObjectExpr1402()


context_jsonvalue: IEncodable = _arrow1403()
