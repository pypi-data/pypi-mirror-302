...
class GroupWithUsersResponse(pydantic_v1.BaseModel):
    name: str
    domain: str = pydantic_v1.Field()
    """
    The domain of the group
    """

    thumbnail_url: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The thumbnail URL of the group
    """

    analysis_email: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The email address for analysis to be sent to
    """

    data_api_access: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
