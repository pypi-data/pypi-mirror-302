...
class FactorValue(Record):
    ...
    def PrintCompact(self, __unit: None=None) -> str:
        ...
        def _arrow540(__unit: None=None) -> str:
            value_2: str = value
            return value_2
        ...
        return ("" if (value is None) else _arrow540()) if (category is None) else (_arrow541() if (value is None) else _arrow542())
...
FactorValue_reflection = _expr543
...
def FactorValue__SetCategory_ZDED3A0F(this: FactorValue, c: OntologyAnnotation) -> FactorValue:
    def _arrow544(__unit: None=None, this: Any=this, c: Any=c) -> Factor | None:
    ...
    return FactorValue(this.ID, _arrow544(), this.Value, this.Unit)
