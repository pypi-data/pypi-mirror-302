...
class OrderActionCreateSubscription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billToContactId", "invoiceGroupNumber", "invoiceSeparately", "invoiceTemplateId", "newSubscriptionOwnerAccount", "notes", "paymentTerm", "sequenceSetId", "soldToContactId", "shipToContactId", "subscribeToProducts", "subscribeToRatePlans", "subscriptionNumber", "subscriptionOwnerAccountNumber", "terms"]
