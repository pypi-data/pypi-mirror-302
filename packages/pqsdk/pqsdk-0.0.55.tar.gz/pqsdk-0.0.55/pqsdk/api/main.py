...
def get_near_trade_date(trade_date: str, max_retries=5, retry_delay=2):
    ...
    while retries < max_retries:
        ...
        if isinstance(res, str):
            ...
            log.warning(f"返回值不是字符串类型，重试 {retries + 1}/{max_retries}...")
            retries += 1
...
@assert_auth
def get_prompt_query(query: str, query_type: str = 'stock'):
    """
    ...
    :return: list, 股票代码列表
    """
    return PQDataClient.instance().get_prompt_query(**locals())
