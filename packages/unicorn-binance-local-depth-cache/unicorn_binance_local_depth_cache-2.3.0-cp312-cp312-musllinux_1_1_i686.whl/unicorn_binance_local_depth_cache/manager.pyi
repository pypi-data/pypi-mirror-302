...
class BinanceLocalDepthCacheManager(threading.Thread):
    ...
    def create_depth_cache(self, markets: str | None = None, refresh_interval: int = None) -> bool: ...
    ...
    def get_stream_id(self, market: str = None) -> str | None: ...
