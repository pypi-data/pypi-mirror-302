...
from .support import TemplateSupport, DBSupport


class QueryIterator(IteratorBase, DBSupport, TemplateSupport):
    """
    QueryIterator
    ...
    Overview
        ...
        This component creates a Pandas Iterator from a QuerySource query, allowing for the iteration over data returned from a query.
