...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr1681(), None)
            ...
            def _arrow1684(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow1686(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow1684, oa_1.Name), map(_arrow1686, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr1687(), None)
    ...
    def _arrow1691(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1694(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1696(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1698(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1700(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1702(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1704(value_19: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow1705(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow1706(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow1708(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1691()), ("@type", ObjectExpr1692()), ("additionalType", _arrow1694()), try_include("alternateName", _arrow1696, pv.AlternateName()), try_include("measurementMethod", _arrow1698, pv.MeasurementMethod()), try_include("description", _arrow1700, pv.Description()), try_include("category", _arrow1702, pattern_input[0]), try_include("categoryCode", _arrow1704, pattern_input[1]), try_include("value", _arrow1705, pattern_input_1[0]), try_include("valueCode", _arrow1706, pattern_input_1[1]), try_include("unit", _arrow1708, pattern_input_2[0]), try_include("unitCode", _arrow1711, pattern_input_2[1]), ("@context", context_jsonvalue)]))
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow1717(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow1716(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow1716(), unit)

    return object(_arrow1717)
