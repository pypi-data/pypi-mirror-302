...
def read_anc_personal_profile() -> Dict:
    # Check personal profile which should be added before user use.

    profile_path = '~/.anc_personal'
...
def get_enviroment():
    ...
    project = anc_profile.get('project', 'llm')
    # Hack
    cluster = 'Singapore' if os.path.exists('/mnt/weka') else 'US'
