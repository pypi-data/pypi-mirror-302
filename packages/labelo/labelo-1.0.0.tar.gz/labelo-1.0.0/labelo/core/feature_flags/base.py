...
from labelo.core.current_request import get_current_request
from labelo.core.utils.io import find_node
from labelo.core.utils.params import get_all_env_with_prefix, get_bool_env

logger = logging.getLogger(__name__)


def get_feature_file_path():
    package_name = 'labelo' if settings.VERSION_EDITION == 'Community' else 'labelo_enterprise'
