...
from forgeapp_sdk.classes.logger import Logger
from forgeapp_sdk.superjson.transformer import UNDEFINED
    ...
    class Input:
        ...
        def file(
            ...
            *,
            ...
            disabled: Optional[bool] = None,
        ) -> MultipleableIOPromise[Literal["UPLOAD_FILE"], ForgeFile, Never]:
            ...
            def get_value(val: InnerFileModel) -> ForgeFile:
                return ForgeFile(
