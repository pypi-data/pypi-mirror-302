...
cdef class AMQPHeader:
    def __cinit__(self, list data=None):
        if data is None:
...
cdef class MessageCtx:
    def __cinit__(
        ...
        object body,
        *,
        object header=AMQPHeader(),
        object delivery_annotations={},  # no-cython-lint
        object annotations={},  # no-cython-lint
        object properties=AMQPProperties(),
        object app_properties={},  # no-cython-lint
        object footer={},  # no-cython-lint
