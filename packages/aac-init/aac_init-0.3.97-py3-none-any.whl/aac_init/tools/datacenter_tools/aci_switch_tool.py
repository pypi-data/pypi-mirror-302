...
class ACI_Switch_Tool:
    ...
    def _telnet_connect(self):
        ...
        msg = f"Failed to connect to '{self.console_address}:{self.console_port}' with both methods after 3 attempts"
    ...
    def _telnet_set_loader(self, telnet_connection):
        ...
        try:
            ...
            if "aci" in current_os_running:
                ...
                # match file/folder
                file_pattern = re.compile(r'^[\w\-\.\s\u4e00-\u9fff\u3040-\u30ff\u00a1-\uffff]+$')
                grub0_files = [line for line in grub0_output.splitlines() if file_pattern.match(line)]
                grub1_files = [line for line in grub1_output.splitlines() if file_pattern.match(line)]
