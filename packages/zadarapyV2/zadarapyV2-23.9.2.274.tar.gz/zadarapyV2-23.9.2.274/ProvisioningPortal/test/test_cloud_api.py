...
class TestCloudApi(unittest.TestCase):
    ...
    def test_cloud_connection_test_status(self):
        """Test case for cloud_connection_test_status

        """
        pass

    def test_cloud_test_connection(self):
        """Test case for cloud_test_connection
