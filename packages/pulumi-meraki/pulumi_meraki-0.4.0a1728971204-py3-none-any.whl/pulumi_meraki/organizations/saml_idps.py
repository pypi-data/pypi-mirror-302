...
class SamlIdpsArgs:
    def __init__(__self__, *,
                 ...
                 slo_logout_url: Optional[pulumi.Input[str]] = None,
                 x509cert_sha1_fingerprint: Optional[pulumi.Input[str]] = None):
        """
        ...
        :param pulumi.Input[str] idp_id: ID associated with the SAML Identity Provider (IdP)
        :param pulumi.Input[str] slo_logout_url: Dashboard will redirect users to this URL when they sign out.
        :param pulumi.Input[str] x509cert_sha1_fingerprint: Fingerprint (SHA1) of the SAML certificate provided by your Identity Provider (IdP). This will be used for encryption / validation.
        """
    ...
    def slo_logout_url(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def slo_logout_url(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "slo_logout_url", value)

    @property
    @pulumi.getter(name="x509certSha1Fingerprint")
    def x509cert_sha1_fingerprint(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    def x509cert_sha1_fingerprint(self, value: Optional[pulumi.Input[str]]):
...
class _SamlIdpsState:
    def __init__(__self__, *,
                 consumer_url: Optional[pulumi.Input[str]] = None,
                 idp_id: Optional[pulumi.Input[str]] = None,
        ...
        :param pulumi.Input[str] consumer_url: URL that is consuming SAML Identity Provider (IdP)
        :param pulumi.Input[str] idp_id: ID associated with the SAML Identity Provider (IdP)
        :param pulumi.Input[str] organization_id: organizationId path parameter. Organization ID
        :param pulumi.Input[str] slo_logout_url: Dashboard will redirect users to this URL when they sign out.
        :param pulumi.Input[str] x509cert_sha1_fingerprint: Fingerprint (SHA1) of the SAML certificate provided by your Identity Provider (IdP). This will be used for encryption / validation.
    ...
    def consumer_url(self) -> Optional[pulumi.Input[str]]:
        """
    ...
    @consumer_url.setter
    def consumer_url(self, value: Optional[pulumi.Input[str]]):
...
class SamlIdps(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            organization_id: Optional[pulumi.Input[str]] = None,
            slo_logout_url: Optional[pulumi.Input[str]] = None,
            x509cert_sha1_fingerprint: Optional[pulumi.Input[str]] = None) -> 'SamlIdps':
        """
    ...
    @property
    @pulumi.getter(name="consumerUrl")
    def consumer_url(self) -> pulumi.Output[str]:
        """
        URL that is consuming SAML Identity Provider (IdP)
        """
        return pulumi.get(self, "consumer_url")
    ...
    @property
    @pulumi.getter(name="sloLogoutUrl")
    def slo_logout_url(self) -> pulumi.Output[str]:
        """
        Dashboard will redirect users to this URL when they sign out.
        """
        return pulumi.get(self, "slo_logout_url")
    ...
    @property
    @pulumi.getter(name="x509certSha1Fingerprint")
    def x509cert_sha1_fingerprint(self) -> pulumi.Output[str]:
        """
        Fingerprint (SHA1) of the SAML certificate provided by your Identity Provider (IdP). This will be used for encryption / validation.
        """
        return pulumi.get(self, "x509cert_sha1_fingerprint")
