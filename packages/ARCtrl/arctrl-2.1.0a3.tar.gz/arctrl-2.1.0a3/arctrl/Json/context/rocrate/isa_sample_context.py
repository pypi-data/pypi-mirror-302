...
IContext_reflection = _expr1510

def _arrow1517(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1511()), ("bio", ObjectExpr1512()), ("Sample", ObjectExpr1513()), ("name", ObjectExpr1514()), ("additionalProperties", ObjectExpr1515())])
...
context_jsonvalue: IEncodable = _arrow1517()
