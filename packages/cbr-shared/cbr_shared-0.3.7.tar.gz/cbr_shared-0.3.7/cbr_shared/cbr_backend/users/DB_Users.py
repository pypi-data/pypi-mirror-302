...
from cbr_shared.cbr_backend.users.DB_User   import DB_User, S3_DB_User__BUCKET_NAME__SUFFIX, S3_DB_User__BUCKET_NAME__PREFIX
...
class DB_Users(S3_DB_Base):
    ...
    def db_user(self, user_id : Random_Guid = None):
        return DB_User(user_id=user_id)
