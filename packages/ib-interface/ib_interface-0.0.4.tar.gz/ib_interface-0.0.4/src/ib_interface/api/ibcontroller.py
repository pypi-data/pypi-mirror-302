...
class IBC:
    ...
    async def startAsync(self):
        ...
        cmd = [f"{self.ibcPath}\\scripts\\StartIBC.bat" if self._isWindows else f"{self.ibcPath}/scripts/ibcstart.sh"]
        ...
        while self._runner:
            try:
                ...
                while self._runner:
                    ...
                    probe = self.ib.reqHistoricalDataAsync(self.probeContract, "", "30 S", "5 secs", "MIDPOINT", False)
                    bars = None
