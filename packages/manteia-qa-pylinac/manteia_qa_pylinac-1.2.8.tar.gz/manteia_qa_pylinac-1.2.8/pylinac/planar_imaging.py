...
class ImagePhantomBase:
    ...
    def phantom_bbox_size_px(self) -> float:
        ...
        return (
            ...
            * (self.image.dpmm**2)
            * (self.magnification_factor**2) if self.image.dpmm else self.phantom_bbox_size_mm2 * (self.magnification_factor**2)
        )
    ...
    def phantom_area(self) -> float:
        ...
        return area_px / self.image.dpmm**2 if self.image.dpmm else area_px
