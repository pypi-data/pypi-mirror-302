...
open_api_info = openapi.Info(
    ...
    contact=openapi.Contact(url='https://labelo.ai'),
...
CUSTOM_URLS = [
 re_path(r'^', include('project_dashboard.urls')),
 re_path(r'^', include('workspace.urls')),
 re_path(r'^', include('project_template.urls')),
]
