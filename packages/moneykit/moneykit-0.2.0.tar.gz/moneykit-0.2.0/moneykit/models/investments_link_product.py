...
class InvestmentsLinkProduct(BaseModel):
    """
    InvestmentsLinkProduct
    """  # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of InvestmentsLinkProduct from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of InvestmentsLinkProduct from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "settings": InvestmentsProductSettings.from_dict(obj.get("settings"))
