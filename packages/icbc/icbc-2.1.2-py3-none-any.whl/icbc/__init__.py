...
""" Idle Code Basic Collecion
    ...
    20200919 2.0.1完善多个bug
    20221211 2.0.2 完善md5、base64、常用加解密encode decode的方法，并对该功能增加单元测试用例
    20241003 2.0.3 匹配python3.12，zen_tool移除setuptools ContentChecker，完善多处bug
    20241014 2.1.1 去除require，方便内网无网络环境的部分功能使用，zen_tool增加taskkill_port,zen_net增加basic_server
    20241014 2.1.1 zen_tool的taskkill_port增加确认标识,zen_net增加func_file,实现局域网传输文件、文本，支持ios快捷指令传入
