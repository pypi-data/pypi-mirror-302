  ...
  create view "f1"."intermediate"."int_driver__season_race_results__dbt_tmp" as (
    with
round_stats as (
    select
        result.driver_id,
    ...
    inner join "f1"."staging"."stg_ergast__races" as _session on result.session_id = _session.session_id
    window
