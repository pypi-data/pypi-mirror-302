...
from positron_common.utils import get_python_version
from positron_common.exceptions import DeserializationException
import json

@dataclass
class FunctionHashes:
    func_hash: None | str = None
    args_hash: None | str = None
    kwargs_hash: None | str = None
    result_hash: None | str = None
    exception_hash: None | str = None
