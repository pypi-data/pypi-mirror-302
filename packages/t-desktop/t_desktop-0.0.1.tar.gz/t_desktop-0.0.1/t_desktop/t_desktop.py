...
class DesktopApp(ABC):
    ...
    def __init__(self, app_path: str):
        ...
        Args:
            app_path (str): The file path to the application executable or script that needs to be started.
        """
    ...
    @retry_if_pywin_error(exceptions=(OSError,), delay=3, retries=2)  # type: ignore[misc]
    def close_alerts(
    ...
    def get_app_session_if_running(self, app_path: str) -> str | None:
        ...
        Returns:
            None | str: None if the app is not running, otherwise the tasklist output.
        """
    ...
    def get_element(
        self, control_type: str, title: str = None, auto_id: str = None, dialog: WindowSpecification = None, **kwargs
    ):
    ...
    def set_input_text(
        self, text: str, auto_id: str = None, title: str = None, dialog: WindowSpecification | None = None
    ) -> None:
    ...
    def invoke_button(
        self, auto_id: str = None, title: str = None, dialog: WindowSpecification | None = None, **kargs
    ) -> None:
