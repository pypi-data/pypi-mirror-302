...
class FaissKnowledgeBase:
    ...
    def query(self, query: str, top_k: int = 6) -> List[Dict[str, Any]]:
        """
        Query the knowledge base for the most relevant chunks.
        ...
        Returns:
            List[Dict[str, Any]]: A list of dictionaries, each containing the id, score, and content of a relevant chunk.
        """
        if not self.memories:
            return []
        try:
