...
class BaseWebClient:
    ...
    def __init__(self, base_dir=None, configs_file=None, is_tab=False):
    ...
    def get_screenshot(self, path=None, name=None, as_bytes=None, as_base64=None,
        ...
        https://drissionpage.cn/browser_control/screen/#%EF%B8%8F%EF%B8%8F-%E9%A1%B5%E9%9D%A2%E6%88%AA%E5%9B%BE
        """
        self.page.get_screenshot(path=path, name=name, as_bytes=as_bytes, as_base64=as_base64,
